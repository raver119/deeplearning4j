...
Nd4jLong NDIndex::stride() { return _stride; }
...
sd::NDIndexInterval::NDIndexInterval(Nd4jLong start, Nd4jLong end,
                                     Nd4jLong stride)
    : sd::NDIndex() {
  this->_stride = stride;
...
std::vector<Nd4jLong> &sd::NDIndex::getIndices() { return _indices; }

sd::NDIndex *sd::NDIndex::all() { return new NDIndexAll(); }

sd::NDIndex *sd::NDIndex::point(Nd4jLong pt) { return new NDIndexPoint(pt); }

sd::NDIndex *sd::NDIndex::interval(Nd4jLong start, Nd4jLong end,
                                   Nd4jLong stride) {
