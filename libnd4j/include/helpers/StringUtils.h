...
class SD_EXPORT StringUtils {
 public:
   ...
   * @return
   */
  static FORCEINLINE std::string buildGraphErrorMessage(const char* message,
                                                        Nd4jLong graphId) {
   ...
   * @return
   */
  static uint64_t countSubarrays(const void* haystack, uint64_t haystackLength,
                                 const void* needle, uint64_t needleLength);
   ...
   * @return
   */
  static std::vector<std::string> split(const std::string& haystack,
   ...
   * @return boolean status
   */
  static bool u16StringToU32String(const std::u16string& u16,
                                   std::u32string& u32);
   ...
   * @return boolean status
   */
  static bool u32StringToU16String(const std::u32string& u32,
                                   std::u16string& u16);
