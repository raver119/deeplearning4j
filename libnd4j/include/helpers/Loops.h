...
class SD_EXPORT ReductionLoops {
 ...
 public:
  ...
  static FORCEINLINE void loopReduce(const X* x, const Nd4jLong* xShapeInfo,
                                     Z* z, const Nd4jLong* zShapeInfo,
                                     const Nd4jLong* tadShapeInfo,
                                     const Nd4jLong* tadOffsets, E* extraParams,
...
class ReductionFloatLoops : public ReductionLoops<X, Z, Z> {
 public:
  static void wrapper(int opNum, const X* x, const Nd4jLong* xShapeInfo, Z* z,
                      const Nd4jLong* zShapeInfo, const Nd4jLong* tadShapeInfo,
                      const Nd4jLong* tadOffsets, Z* extraParams, int64_t start,
                      int64_t stop);

  template <typename OpType>
  static void innerloopReduce(const X* x, const Nd4jLong* xShapeInfo, Z* z,
                              const Nd4jLong* zShapeInfo,
                              const Nd4jLong* tadShapeInfo,
                              const Nd4jLong* tadOffsets, Z* extraParams,
                              int64_t start, int64_t stop);
};
...
class SD_EXPORT ReductionBoolLoops : public ReductionLoops<X, Z, X> {
 public:
  static void wrapper(int opNum, const X* x, const Nd4jLong* xShapeInfo, Z* z,
                      const Nd4jLong* zShapeInfo, const Nd4jLong* tadShapeInfo,
                      const Nd4jLong* tadOffsets, X* extraParams, int64_t start,
                      int64_t stop);
  ...
  static void innerloopReduce(const X* x, const Nd4jLong* xShapeInfo, Z* z,
                              const Nd4jLong* zShapeInfo,
                              const Nd4jLong* tadShapeInfo,
                              const Nd4jLong* tadOffsets, X* extraParams,
                              int64_t start, int64_t stop);
};
...
class SD_EXPORT ReductionSameLoops : public ReductionLoops<X, X, X> {
 public:
  static void wrapper(int opNum, const X* x, const Nd4jLong* xShapeInfo, X* z,
                      const Nd4jLong* zShapeInfo, const Nd4jLong* tadShapeInfo,
                      const Nd4jLong* tadOffsets, X* extraParams, int64_t start,
                      int64_t stop);

  template <typename OpType>
  static void innerloopReduce(const X* x, const Nd4jLong* xShapeInfo, X* z,
                              const Nd4jLong* zShapeInfo,
                              const Nd4jLong* tadShapeInfo,
                              const Nd4jLong* tadOffsets, X* extraParams,
                              int64_t start, int64_t stop);
...
class SD_EXPORT IndexReductionLoops {
 private:
 public:
  static void wrapIndexReduce(int opNum, const void* x,
                              const Nd4jLong* xShapeInfo, void* z,
                              const Nd4jLong* zShapeInfo,
                              const Nd4jLong* tadShapeInfo,
                              const Nd4jLong* tadOffsets, void* extraParams);

  template <typename OpType>
  static void loopIndexReduce(const X* x, const Nd4jLong* xShapeInfo, Z* z,
                              const Nd4jLong* zShapeInfo,
                              const Nd4jLong* tadShapeInfo,
                              const Nd4jLong* tadOffsets, X* extraParams);
};
...
class SD_EXPORT TransformLoops {
 public:
  template <typename OpType>
  static FORCEINLINE void loopTransform(const X* x, const Nd4jLong* xShapeInfo,
                                        Z* z, const Nd4jLong* zShapeInfo,
                                        E* extraParams, uint64_t threadId,
                                        uint64_t numThreads);
};
...
class SD_EXPORT Reduction3Loops {
 public:
  template <typename OpType>
  static FORCEINLINE void loopReduce3(const X* x, const Nd4jLong* xShapeInfo,
                                      const X* y, const Nd4jLong* yShapeInfo,
                                      Z* z, const Nd4jLong* zShapeInfo,
                                      int* dims, int dimsLen, Z* extraParams,
                                      int64_t start, int64_t stop);

  template <typename OpType>
  static FORCEINLINE void loopReduce3All(
      const X* x, const Nd4jLong* xShapeInfo, const X* y,
      const Nd4jLong* yShapeInfo, Z* z, const Nd4jLong* zShapeInfo,
  ...
  static void wrapper(int opNum, const X* x, const Nd4jLong* xShapeInfo,
                      const X* y, const Nd4jLong* yShapeInfo, Z* z,
                      const Nd4jLong* zShapeInfo, int* dims, int dimsLen,
                      Z* extraParams, int64_t start, int64_t stop);

  static void wrapperAll(int opNum, const X* x, const Nd4jLong* xShapeInfo,
                         const X* y, const Nd4jLong* yShapeInfo, Z* z,
                         const Nd4jLong* zShapeInfo,
                         const Nd4jLong* xTadShapeInfo,
                         const Nd4jLong* xTadOffsets,
                         const Nd4jLong* yTadShapeInfo,
                         const Nd4jLong* yTadOffsets, Z* extraParams,
                         int64_t start, int64_t stop);

  template <typename OpType>
  static void innerloopReduce3(const X* x, const Nd4jLong* xShapeInfo,
                               const X* y, const Nd4jLong* yShapeInfo, Z* z,
                               const Nd4jLong* zShapeInfo, int* dims,
                               int dimsLen, Z* extraParams, int64_t start,
                               int64_t stop);

  template <typename OpType>
  static void innerloopReduce3All(const X* x, const Nd4jLong* xShapeInfo,
                                  const X* y, const Nd4jLong* yShapeInfo, Z* z,
                                  const Nd4jLong* zShapeInfo,
                                  const Nd4jLong* xTadShapeInfo,
                                  const Nd4jLong* xTadOffsets,
...
void Loops::loopXYZ(const X* x, const Nd4jLong* xShapeInfo,
    ...
    const LoopKind::Kind kindOfLoop = LoopKind::deduceKindOfLoopXYZ(xShapeInfo,
    ...
    switch (kindOfLoop) {
        ...
        case LoopKind::EWS1: {
            PRAGMA_OMP_PARALLEL_THREADS(threadsInfo._numThreads)
            {
                ...
                const auto threadOffset =
threadsInfo.getThreadOffset(threadNum); const auto lenPerThread =
static_cast<uint>(threadsInfo.getItersPerThread(threadNum));
        ...
        case LoopKind::EWSNONZERO: {
            ...
            PRAGMA_OMP_PARALLEL_THREADS(threadsInfo._numThreads)
            {
                ...
                const auto threadOffset =
threadsInfo.getThreadOffset(threadNum); const auto lenPerThread =
static_cast<uint>(threadsInfo.getItersPerThread(threadNum)); const auto xi = x +
threadOffset * xEws; const auto yi = y + threadOffset * yEws; auto zi = z +
threadOffset * zEws;
        ...
        case LoopKind::RANK1: {
            ...
            for (uint i0 = 0; i0 < len; ++i0)
                z[i0 * zStride[0]] = op(x[i0 * xStride[0]], y[i0 * yStride[0]],
extraParams);
        }
            break;
        ...
        case LoopKind::RANK2: {
            ...
            for (uint i0 = 0; i0 < xShape[0]; ++i0)
                for (uint i1 = 0; i1 < xShape[1]; ++i1)
                    z[i0 * zStride[0] + i1 * zStride[1]] = op(x[i0 * xStride[0]
+ i1 * xStride[1]], y[i0 * yStride[0] + i1 * yStride[1]], extraParams);
        }
            break;
            ...
            for (uint i0 = 0; i0 < xShape[0]; ++i0)
                for (uint i1 = 0; i1 < xShape[1]; ++i1)
                    for (uint i2 = 0; i2 < xShape[2]; ++i2)
                        z[i0*zStride[0]+i1*zStride[1]+i2*zStride[2]] =
op(x[i0*xStride[0]+i1*xStride[1]+i2*xStride[2]],
y[i0*yStride[0]+i1*yStride[1]+i2*yStride[2]], extraParams);
        }
            break;
                ...
                for (uint i1 = 0; i1 < xShape[1]; ++i1)
                    for (uint i2 = 0; i2 < xShape[2]; ++i2)
                        for (uint i3 = 0; i3 < xShape[3]; ++i3)
                            z[i0*zStride[0]+i1*zStride[1]+i2*zStride[2]+i3*zStride[3]]
= op(x[i0*xStride[0]+i1*xStride[1]+i2*xStride[2]+i3*xStride[3]],
y[i0*yStride[0]+i1*yStride[1]+i2*yStride[2]+i3*yStride[3]], extraParams);
        }
            break;
                    ...
                    for (uint i2 = 0; i2 < xShape[2]; ++i2)
                        for (uint i3 = 0; i3 < xShape[3]; ++i3)
                            for (uint i4 = 0; i4 < xShape[4]; ++i4)
                                z[i0*zStride[0]+i1*zStride[1]+i2*zStride[2]+i3*zStride[3]+i4*zStride[4]]
= op(x[i0*xStride[0]+i1*xStride[1]+i2*xStride[2]+i3*xStride[3]+i4*xStride[4]],
y[i0*yStride[0]+i1*yStride[1]+i2*yStride[2]+i3*yStride[3]+i4*yStride[4]],
extraParams);
        }
            break;
        ...
        default: {
            ...
            bool canCastX = DataTypeUtils::castShapeInfo(xShapeInfo,
xShapeInfoCast); bool canCastY = DataTypeUtils::castShapeInfo(yShapeInfo,
yShapeInfoCast); bool canCastZ = DataTypeUtils::castShapeInfo(zShapeInfo,
zShapeInfoCast);
            ...
            PRAGMA_OMP_PARALLEL_THREADS(threadsInfo._numThreads)
            {
                ...
                auto lenPerThread =
static_cast<uint>(threadsInfo.getItersPerThread(threadNum)); PRAGMA_OMP_SIMD for
(uint i = 0; i < lenPerThread; i++) { auto xOffset = shape::indexOffset(i +
threadOffset, xShapeInfo, xShapeInfoCast, canCastX); auto yOffset =
shape::indexOffset(i + threadOffset, yShapeInfo, yShapeInfoCast, canCastY); auto
zOffset = shape::indexOffset(i + threadOffset, zShapeInfo, zShapeInfoCast,
canCastZ); z[zOffset] = op(x[xOffset], y[yOffset], extraParams);
                }
            }
        }
    }
...
template <typename X, typename Z, typename E>
template <typename OpType>
void sd::ReductionLoops<X, Z, E>::loopReduce(
    const X* x, const Nd4jLong* xShapeInfo, Z* z, const Nd4jLong* zShapeInfo,
    const Nd4jLong* tadShapeInfo, const Nd4jLong* tadOffsets, E* extraParams,
    int64_t start, int64_t stop) {
  const LoopKind::Kind kindOfLoop =
      LoopKind::deduceKindOfLoopTadXZ(xShapeInfo, zShapeInfo, tadShapeInfo);
  ...
  switch (kindOfLoop) {
      ...
      //         const auto zOffset = shape::subArrayOffset(i, xShapeInfo,
      //         zShapeInfo, dimsToExclude, dimsLen); const uint tadInd = (i /
      //         tadEws) % tadLen; auto startVal = tadInd ? z[zOffset] :
      //         static_cast<Z>(OpType::startingValue(x)); z[zOffset] =
      //         OpType::update(startVal, OpType::op(x[i], extraParams),
      //         extraParams); if(tadInd == tadLen - 1)
      //             z[zOffset] = OpType::postProcess(z[zOffset], tadLen,
      //             extraParams);
      //         printf("%u - %lld\n", i, zOffset);
      //     }
      // }
    case LoopKind::SMALLARR2DX: {
      ...
      for (uint i = 0; i <= uZLenMinusOne; i++) z[i] = OpType::startingValue(x);

      uint zOffset = 0;
      for (uint i = 0; i < xLen; ++i) {
        z[zOffset] = OpType::update(z[zOffset], OpType::op(x[i], extraParams),
                                    extraParams);
    ...
    case LoopKind::EWSNONZERO: {
      for (auto i = start; i < stop; i++) {
        ...
        for (Nd4jLong j = 0; j < tadLen; j++)
          s = OpType::update(s, OpType::op(tad[j * tadEws], extraParams),
                             extraParams);
    ...
    case LoopKind::RANK1: {
      for (auto i = start; i < stop; i++) {
        ...
        for (Nd4jLong i0 = 0; i0 < tadLen; ++i0)
          s = OpType::update(s, OpType::op(tad[i0 * tadStride[0]], extraParams),
                             extraParams);
      ...
      for (auto i = start; i < stop; i++) {
        ...
        for (Nd4jLong i0 = 0; i0 < tadShape[0]; ++i0)
          for (Nd4jLong i1 = 0; i1 < tadShape[1]; ++i1)
            s = OpType::update(
                s,
                OpType::op(tad[i0 * tadStride[0] + i1 * tadStride[1]],
                           extraParams),
                extraParams);
    ...
    case LoopKind::X_EWSNONZERO: {
      ...
      const bool canCastZ =
          sd::DataTypeUtils::castShapeInfo<uint>(zShapeInfo, castZShapeInfo);
      ...
      for (auto i = start; i < stop; i++) {
        ...
        auto zOffset =
            shape::indexOffset(i, zShapeInfo, castZShapeInfo, canCastZ);
    ...
    case LoopKind::Z_EWSNONZERO: {
      ...
      const bool canCastTad = sd::DataTypeUtils::castShapeInfo<uint>(
          tadShapeInfo, castTadShapeInfo);
      ...
      for (auto i = start; i < stop; i++) {
        ...
        for (Nd4jLong j = 0; j < tadLen; j++) {
          auto tadOffset =
              shape::indexOffset(j, tadShapeInfo, castTadShapeInfo, canCastTad);
          s = OpType::update(s, OpType::op(tad[tadOffset], extraParams),
                             extraParams);
        }
    ...
    default: {
      ...
      for (auto i = start; i < stop; i++) {
        ...
        for (Nd4jLong j = 0; j < tadLen; j++)
          s = OpType::update(
              s, OpType::op(tad[innertadOffsets[j]], extraParams), extraParams);
...
template <typename X, typename Z, typename E>
template <typename OpType>
void sd::TransformLoops<X, Z, E>::loopTransform(
    const X* x, const Nd4jLong* xShapeInfo, Z* z, const Nd4jLong* zShapeInfo,
    E* extraParams, uint64_t threadId, uint64_t numThreads) {
  const LoopKind::Kind kindOfLoop =
      LoopKind::deduceKindOfLoopXZ(xShapeInfo, zShapeInfo);
  ...
  switch (kindOfLoop) {
    ...
    case LoopKind::Z_EWSNONZERO: {
      ...
      const bool canCastX =
          sd::DataTypeUtils::castShapeInfo<uint>(xShapeInfo, castXShapeInfo);
      ...
      if (zEws > 1) {
        for (auto i = start; i < stop; i++) {
          const auto xOffset =
              shape::indexOffset(i, xShapeInfo, castXShapeInfo, canCastX);
    ...
    case LoopKind::RANK2: {
      ...
      auto loop =
          samediff::ThreadsHelper::pickLoop2d(numThreads, uXShape0, uXShape1);
      auto span = samediff::Span2::build(loop, threadId, numThreads, 0,
                                         uXShape0, 1, 0, uXShape1, 1);
      ...
      for (auto i0 = span.startX(); i0 < span.stopX(); i0++) {
        ...
        for (auto i1 = span.startY(); i1 < span.stopY(); ++i1)
          z[z0 + i1 * zStride[1]] =
              OpType::op(x[x0 + i1 * xStride[1]], extraParams);
      }
    } break;
      ...
      for (auto i0 = span.startX(); i0 < span.stopX(); i0++)
        for (auto i1 = span.startY(); i1 < span.stopY(); i1++) {
          ...
          for (Nd4jLong i2 = 0; i2 < uXShape2; ++i2)
            z[z0 + i2 * zStride[2]] =
                OpType::op(x[x0 + i2 * xStride[2]], extraParams);
        }
    } break;
    ...
    case LoopKind::RANK4: {
      ...
      auto loop = samediff::ThreadsHelper::pickLoop3d(numThreads, uXShape0,
                                                      uXShape1, uXShape2);
      auto span =
          samediff::Span3::build(loop, threadId, numThreads, 0, uXShape0, 1, 0,
                                 uXShape1, 1, 0, uXShape2, 1);
        ...
        for (auto i1 = span.startY(); i1 < span.stopY(); i1++)
          for (auto i2 = span.startZ(); i2 < span.stopZ(); i2++) {
            ...
            for (Nd4jLong i3 = 0; i3 < uXShape3; ++i3)
              z[z0 + i3 * zStride[3]] =
                  OpType::op(x[x0 + i3 * xStride[3]], extraParams);
          }
    } break;
          ...
          for (auto i2 = span.startZ(); i2 < span.stopZ(); i2++) {
            ...
            for (Nd4jLong i3 = 0; i3 < uXShape3; ++i3) {
              ...
              for (Nd4jLong i4 = 0; i4 < uXShape4; ++i4)
                z[z1 + i4 * zStride[4]] =
                    OpType::op(x[x1 + i4 * xStride[4]], extraParams);
            }
          }
    ...
    default: {
      ...
      for (auto i = span.startX(); i < span.stopX(); i++) {
        auto xOffset =
            shape::indexOffset(i, xShapeInfo, xShapeInfoCast, canCastX);
        auto zOffset =
            shape::indexOffset(i, zShapeInfo, zShapeInfoCast, canCastZ);
...
template <typename X, typename Z>
template <typename OpType>
void sd::Reduction3Loops<X, Z>::loopReduce3(
    const X* x, const Nd4jLong* xShapeInfo, const X* y,
    const Nd4jLong* yShapeInfo, Z* z, const Nd4jLong* zShapeInfo, int* dims,
    int dimsLen, Z* extraParameters, int64_t start, int64_t stop) {
  ...
  const Nd4jLong *xTadShapeInfo = nullptr, *yTadShapeInfo = nullptr,
                 *xTadOffsets = nullptr, *yTadOffsets = nullptr;
  ...
  const LoopKind::Kind kindOfLoop = LoopKind::deduceKindOfLoopTadXYZ(
      xTadShapeInfo, yTadShapeInfo, zShapeInfo);
  ...
  switch (kindOfLoop) {
    ...
    case LoopKind::EWS1: {
      ...
      for (auto i = start; i < stop; i++) {
        ...
        for (Nd4jLong j = 0; j < tadLen; ++j)
          s = OpType::update(s, OpType::op(xTad[j], yTad[j], extraParams),
                             extraParams);
    ...
    case LoopKind::EWSNONZERO: {
      ...
      for (auto i = start; i < stop; i++) {
        ...
        for (Nd4jLong j = 0; j < tadLen; ++j)
          s = OpType::update(
              s, OpType::op(xTad[j * xTadEws], yTad[j * yTadEws], extraParams),
              extraParams);
    ...
    case LoopKind::RANK1: {
      ...
      for (auto i = start; i < stop; i++) {
        ...
        for (Nd4jLong i0 = 0; i0 < tadLen; ++i0) {
          ...
          s = OpType::update(
              s, OpType::op(xTad[xTadOffset], yTad[yTadOffset], extraParams),
              extraParams);
        }
          ...
          for (Nd4jLong i1 = 0; i1 < tadShape[1]; ++i1) {
            for (Nd4jLong i2 = 0; i2 < tadShape[2]; ++i2) {
              const auto xTadOffset =
                  i0 * xTadStride[0] + i1 * xTadStride[1] + i2 * xTadStride[2];
              const auto yTadOffset =
                  i0 * yTadStride[0] + i1 * yTadStride[1] + i2 * yTadStride[2];
              s = OpType::update(
                  s,
                  OpType::op(xTad[xTadOffset], yTad[yTadOffset], extraParams),
                  extraParams);
            }
          }
        }
          ...
          for (Nd4jLong i1 = 0; i1 < tadShape[1]; ++i1) {
            for (Nd4jLong i2 = 0; i2 < tadShape[2]; ++i2) {
              for (Nd4jLong i3 = 0; i3 < tadShape[3]; ++i3) {
                const auto xTadOffset = i0 * xTadStride[0] +
                                        i1 * xTadStride[1] +
                                        i2 * xTadStride[2] + i3 * xTadStride[3];
                const auto yTadOffset = i0 * yTadStride[0] +
                                        i1 * yTadStride[1] +
                                        i2 * yTadStride[2] + i3 * yTadStride[3];
                s = OpType::update(
                    s,
                    OpType::op(xTad[xTadOffset], yTad[yTadOffset], extraParams),
                    extraParams);
          ...
          for (Nd4jLong i1 = 0; i1 < tadShape[1]; ++i1) {
            for (Nd4jLong i2 = 0; i2 < tadShape[2]; ++i2) {
              for (Nd4jLong i3 = 0; i3 < tadShape[3]; ++i3) {
                for (Nd4jLong i4 = 0; i4 < tadShape[4]; ++i4) {
                  const auto xTadOffset =
                      i0 * xTadStride[0] + i1 * xTadStride[1] +
                      i2 * xTadStride[2] + i3 * xTadStride[3] +
                      i4 * xTadStride[4];
                  const auto yTadOffset =
                      i0 * yTadStride[0] + i1 * yTadStride[1] +
                      i2 * yTadStride[2] + i3 * yTadStride[3] +
                      i4 * yTadStride[4];
                  s = OpType::update(s,
                                     OpType::op(xTad[xTadOffset],
                                                yTad[yTadOffset], extraParams),
                                     extraParams);
                }
              }
            }
    ...
    default: {
      ...
      const bool canCastXTad = sd::DataTypeUtils::castShapeInfo<uint>(
          xTadShapeInfo, castXTadShapeInfo);
      ...
      if (shape::haveSameShapeAndStrides(xTadShapeInfo, yTadShapeInfo)) {
        ...
        for (auto i = start; i < stop; i++) {
          ...
          for (Nd4jLong j = 0; j < tadLen; ++j) {
            const auto tadOffset = shape::indexOffset(
                j, xTadShapeInfo, castXTadShapeInfo, canCastXTad);
            s = OpType::update(
                s, OpType::op(xTad[tadOffset], yTad[tadOffset], extraParams),
                extraParams);
          }
        ...
        const bool canCastYTad = sd::DataTypeUtils::castShapeInfo<uint>(
        ...
        for (auto i = start; i < stop; i++) {
          ...
          for (Nd4jLong j = 0; j < tadLen; ++j) {
            const auto xTadOffset = shape::indexOffset(
                j, xTadShapeInfo, castXTadShapeInfo, canCastXTad);
            const auto yTadOffset = shape::indexOffset(
                j, yTadShapeInfo, castYTadShapeInfo, canCastYTad);
            s = OpType::update(
                s, OpType::op(xTad[xTadOffset], yTad[yTadOffset], extraParams),
                extraParams);
          }
...
template <typename X, typename Z>
template <typename OpType>
void sd::Reduction3Loops<X, Z>::loopReduce3All(
    const X* x, const Nd4jLong* xShapeInfo, const X* y,
    const Nd4jLong* yShapeInfo, Z* z, const Nd4jLong* zShapeInfo,
    const Nd4jLong* xTadShapeInfo, const Nd4jLong* xTadOffsets,
    const Nd4jLong* yTadShapeInfo, const Nd4jLong* yTadOffsets,
      ...
      for (Nd4jLong ix = 0; ix < numXTads; ix++) {
        for (Nd4jLong iy = 0; iy < numYTads; iy++) {
          ...
          for (Nd4jLong j = 0; j < tadLen; ++j)
            s = OpType::update(
                s,
                OpType::op(xTad[j * xTadEws], yTad[j * yTadEws], extraParams),
                extraParams);
        ...
        for (Nd4jLong iy = 0; iy < numYTads; iy++) {
          ...
          for (Nd4jLong i0 = 0; i0 < tadShape[0]; ++i0) {
            for (Nd4jLong i1 = 0; i1 < tadShape[1]; ++i1) {
              for (Nd4jLong i2 = 0; i2 < tadShape[2]; ++i2) {
                const auto xTadOffset = i0 * xTadStride[0] +
                                        i1 * xTadStride[1] + i2 * xTadStride[2];
                const auto yTadOffset = i0 * yTadStride[0] +
                                        i1 * yTadStride[1] + i2 * yTadStride[2];
                s = OpType::update(
                    s,
                    OpType::op(xTad[xTadOffset], yTad[yTadOffset], extraParams),
                    extraParams);
              ...
              for (Nd4jLong i2 = 0; i2 < tadShape[2]; ++i2) {
                for (Nd4jLong i3 = 0; i3 < tadShape[3]; ++i3) {
                  for (Nd4jLong i4 = 0; i4 < tadShape[4]; ++i4) {
                    ...
                    s = OpType::update(
                        s,
                        OpType::op(xTad[xTadOffset], yTad[yTadOffset],
                                   extraParams),
                        extraParams);
                  }
                }
