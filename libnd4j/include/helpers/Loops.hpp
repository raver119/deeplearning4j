...
// const Nd4jLong* tadOffsets, float* z, const Nd4jLong* zShapeInfo, float*
// extraParams, std::function<float(const float*)> startVal,
// std::function<float(float,float,float*)> update,
// std::function<float(float,float*)> op,
// std::function<float(float,Nd4jLong,float*)> postPr);
