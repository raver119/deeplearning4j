...
// evaluate output shape for reduce operation when input shape is empty
    const Nd4jLong* ShapeUtils::evalReduceShapeInfoEmpty(const char order, const std::vector<int>& vdimsToExclude, const Nd4jLong *shapeInfo, const sd::DataType dataType, const bool keepDims, sd::memory::Workspace* workspace) {
    ...
    const Nd4jLong* ShapeUtils::evalReduceShapeInfo(const char order, const std::vector<int>& dimsToExclude, const NDArray& arr, const bool keepDims, const bool supportOldShapes, sd::memory::Workspace* workspace) {
        return evalReduceShapeInfo(order, dimsToExclude, arr, arr.dataType(), keepDims, supportOldShapes, workspace);
    }

    const Nd4jLong* ShapeUtils::evalReduceShapeInfo(const char order, const std::vector<int>& dimsToExclude, const Nd4jLong* shapeInfo, const bool keepDims, const bool supportOldShapes, sd::memory::Workspace* workspace) {
...
//////////////////////////////////////////////////////////////////////////
    const Nd4jLong* ShapeUtils::evalReduceShapeInfo(const char order, const std::vector<int>& dimsToExclude, const NDArray& arr, const sd::DataType dataType, const bool keepDims, const bool supportOldShapes, sd::memory::Workspace* workspace) {
...
// evaluate shape resulting from reduce operation
    const Nd4jLong* ShapeUtils::evalReduceShapeInfo(const char order, const std::vector<int>& vdimsToExclude, const Nd4jLong *shapeInfo, const sd::DataType dataType, const bool keepDims, const bool supportOldShapes, sd::memory::Workspace* workspace) {
    auto dimsToExclude = vdimsToExclude;
