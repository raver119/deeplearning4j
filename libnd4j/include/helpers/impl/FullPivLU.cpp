...
template class SD_EXPORT FullPivLU<float>;
template class SD_EXPORT FullPivLU<float16>;
template class SD_EXPORT FullPivLU<bfloat16>;
template class SD_EXPORT FullPivLU<double>;
