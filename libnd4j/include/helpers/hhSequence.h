...
class HHsequence {
 public:
  ...
  /*
   *  type of sequence, type = 'u' (acting on columns, left) or type = 'v'
   * (acting on rows, right)
   */
  char _type;
  ...
  /**
   *  this method mathematically multiplies input matrix on Householder sequence
   * from the left H0*H1*...Hn * matrix
   *
