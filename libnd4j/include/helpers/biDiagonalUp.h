...
class BiDiagonalUp {
 public:
  ...
  /**
   *  this method evaluates product of Householder sequence matrices
   * (transformations) acting on columns
   *
   *  type - type of sequence, type = 'u' (acting on columns) or type = 'v'
   * (acting on rows)
   */
  template <typename T>
