...
class Parameters {
 ...
 public:
  ...
  Parameters* addIntParam(std::initializer_list<std::string> strings,
                          std::initializer_list<int> params);

  Parameters* addBoolParam(std::string string, bool param);
  Parameters* addBoolParam(std::initializer_list<std::string> strings,
                           std::initializer_list<bool> params);

  Parameters* addArrayParam(std::string string,
                            std::initializer_list<int> param);
  Parameters* addArrayParam(
