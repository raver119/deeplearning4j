...
class SD_EXPORT ScalarBenchmark : public OpBenchmark {
 public:
  ...
  ScalarBenchmark(scalar::Ops op) : OpBenchmark() { _opNum = (int)op; }
  ...
  ScalarBenchmark(scalar::Ops op, const std::string &testName, const NDArray &x,
  ...
  void executeOnce() override {
    ...
    if (_z.shapeInfo() == nullptr)
      NativeOpExecutioner::execScalar(
          ...
          _x.specialBuffer(), _x.specialShapeInfo(), _x.buffer(),
          _x.shapeInfo(), _x.specialBuffer(), _x.specialShapeInfo(),
          _y.buffer(), _y.shapeInfo(), _y.specialBuffer(),
          _y.specialShapeInfo(), nullptr);
    else
      NativeOpExecutioner::execScalar(
          LaunchContext::defaultContext(), _opNum, _x.buffer(), _x.shapeInfo(),
          _x.specialBuffer(), _x.specialShapeInfo(), _z.buffer(),
          _z.shapeInfo(), _z.specialBuffer(), _z.specialShapeInfo(),
          _y.buffer(), _y.shapeInfo(), _y.specialBuffer(),
          _y.specialShapeInfo(), nullptr);
  ...
  OpBenchmark *clone() override {
    return new ScalarBenchmark(
        (scalar::Ops)_opNum, _testName,
        _x.shapeInfo() == nullptr ? _x : NDArray(_x.dup()),
        _y.shapeInfo() == nullptr ? _y : NDArray(_y.dup()),
        _z.shapeInfo() == nullptr ? _z : NDArray(_z.dup()));
  }
};
}  // namespace sd
