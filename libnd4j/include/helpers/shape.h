 ...
 */
struct SD_EXPORT ShapeInformation {
  _CUDA_HD ShapeInformation(Nd4jLong *shape_ = nullptr,
                            Nd4jLong *stride_ = nullptr, char order_ = 0,
                            int rank_ = 0, int offset_ = 0,
                            int elementWiseStride_ = 0)
      : shape(shape_),
        stride(stride_),
        order(order_),
        rank(rank_),
 ...
 * for bounds checking
 */
struct SD_EXPORT CurrentIndexing {
...
SD_EXPORT _CUDA_HD bool shapeEquals(const int shape1Rank,
                                    const Nd4jLong *shape1,
                                    const int shape2Rank,
                                    const Nd4jLong *shape2);

SD_EXPORT _CUDA_HD const Nd4jLong *detachShape(const Nd4jLong *originalShape);

SD_EXPORT _CUDA_HD Nd4jLong *copyShape(Nd4jLong const *originalShape);

SD_EXPORT _CUDA_HD bool shapeEquals(const Nd4jLong *shapeInfo1,
                                    const Nd4jLong *shapeInfo2);

SD_EXPORT _CUDA_HD bool shapeEquals(const Nd4jLong *shapeInfo1,
                                    const Nd4jLong *shapeInfo2,
                                    const Nd4jLong *shapeInfo3);

SD_EXPORT _CUDA_HD bool strideEquals(int const shape1Rank,
                                     Nd4jLong const *shape1,
                                     int const shape2Rank,
                                     Nd4jLong const *shape2);

SD_EXPORT _CUDA_HD bool strideEquals(Nd4jLong const *shapeInfo1,
                                     Nd4jLong const *shapeInfo2);

SD_EXPORT _CUDA_HD bool strideEquals(Nd4jLong const *stride1, int const rank1,
                                     Nd4jLong const *stride2, int const rank2);

SD_EXPORT _CUDA_HD bool equalsSoft(const Nd4jLong *shapeA,
                                   const Nd4jLong *shapeB);

SD_EXPORT _CUDA_HD bool equalsTypesAndShapesSoft(const Nd4jLong *shapeA,
                                                 const Nd4jLong *shapeB);

SD_EXPORT _CUDA_HD bool equalsStrict(const Nd4jLong *shapeA,
                                     const Nd4jLong *shapeB);

// returns true if ranks, shapes and strides are the same
SD_EXPORT _CUDA_HD bool haveSameShapeAndStrides(const Nd4jLong *shapeInfo1,
                                                const Nd4jLong *shapeInfo2);
SD_EXPORT _CUDA_HD bool haveSameShapeAndStrides(const Nd4jLong *shapeInfo1,
                                                const Nd4jLong *shapeInfo2,
                                                const Nd4jLong *shapeInfo3);

SD_EXPORT _CUDA_HD int sizeAt(const Nd4jLong *shapeInfo, const int dim);
SD_EXPORT _CUDA_HD Nd4jLong strideAt(const Nd4jLong *shapeInfo, const int dim);

template <typename T>
SD_EXPORT _CUDA_HD void fill(T *buffer, T value, Nd4jLong length);

SD_EXPORT _CUDA_HD void traceNew(int id);

SD_EXPORT _CUDA_HD int tadIndexForLinear(int linearIndex, int tadLength);

SD_EXPORT _CUDA_HD Nd4jLong tadLength(const Nd4jLong *shapeInfo, int *dimension,
                                      int dimensionLength);

SD_EXPORT _CUDA_HD bool canReshape(const int oldRank, Nd4jLong *oldShape,
                                   const int newRank, Nd4jLong *newShape,
                                   bool isFOrder);

SD_EXPORT _CUDA_HD bool reshapeC(const Nd4jLong *oldShapeInfo,
                                 const char newOrder, const int newRank,
                                 const Nd4jLong *newShape,
 ...
 */
SD_EXPORT _CUDA_HD Nd4jLong *shapeBuffer(int rank, sd::DataType dtype,
 ...
 * for the given rank and shape.
 */
SD_EXPORT _CUDA_HD Nd4jLong *shapeBufferFortran(int rank, sd::DataType dtype,
                                                Nd4jLong const *shape);
...
__device__ SD_EXPORT Nd4jLong *cuMalloc(Nd4jLong *buffer, long size);
#endif
 ...
 */
SD_EXPORT _CUDA_HD Nd4jLong *calcStridesFortran(Nd4jLong const *shape,
                                                int rank);

SD_EXPORT _CUDA_HD Nd4jLong *calcStridesFortran(Nd4jLong const *shape, int rank,
                                                Nd4jLong *ret);
...
SD_EXPORT _CUDA_HD Nd4jLong *calcStrides(Nd4jLong const *shape, int rank);

SD_EXPORT _CUDA_HD Nd4jLong *calcStrides(Nd4jLong const *shape, int rank,
                                         Nd4jLong *ret);

SD_EXPORT _CUDA_HD void updateStrides(Nd4jLong *shape, const char order);
SD_EXPORT _CUDA_HD void updateStrides(const int rank, const Nd4jLong *shapeOnly,
                                      Nd4jLong *stridesOnly, const char order);

// check whether input dimensions are permuted, not permuted dimensions order
// have to be 0,....,rank-1
template <typename T>
SD_EXPORT _CUDA_HD bool isDimPermuted(const T *dimensions, const int dimSize);
 ...
 */
SD_EXPORT _CUDA_HD ShapeInformation *shapeCopy(ShapeInformation *toCopy);

SD_EXPORT _CUDA_HD bool strideDescendingCAscendingF(
    const Nd4jLong *shapeBuffer);

SD_EXPORT _CUDA_HD bool isContiguous(const Nd4jLong *shapeInfo);
 ...
 */
SD_EXPORT _CUDA_HD bool areStridesDefault(const Nd4jLong *shapeInfo);
 ...
 */
SD_EXPORT _CUDA_HD int computeElementWiseStride(int rank, Nd4jLong const *shape,
                                                Nd4jLong const *stride,
                                                int isFOrder);
...
SD_EXPORT _CUDA_HD int computeElementWiseStride(int rank, Nd4jLong const *shape,
                                                Nd4jLong const *stride,
                                                int isFOrder,
                                                Nd4jLong const *dimension,
                                                int dimensionLength);

SD_EXPORT _CUDA_HD Nd4jLong *shapeInfoOnlyShapeAndStride(
    Nd4jLong const *shapeInfo, Nd4jLong *dimension, int dimensionLength,
    bool reverseCopyStride);

SD_EXPORT _CUDA_HD Nd4jLong *shapeInfoOnlyShapeAndStride(
    const Nd4jLong *shapeInfo, Nd4jLong *dimension, int dimensionLength,
    bool reverseCopyStride, Nd4jLong *buffer);
/**
 *
 * @param length
 * @param shape
 ...
 * @return
 */
SD_EXPORT _CUDA_HD Nd4jLong *doPermuteSwap(int length, Nd4jLong *shape,
                                           int *rearrange);
 ...
 * @param rearrange
 */
SD_EXPORT _CUDA_HD void doPermuteSwap(int length, Nd4jLong **shape,
                                      int *rearrange);

SD_EXPORT _CUDA_HD Nd4jLong *permuteShapeBuffer(Nd4jLong const *shapeBuffer,
                                                int *rearrange);

SD_EXPORT _CUDA_HD void permuteShapeBufferInPlace(Nd4jLong *shapeBuffer,
                                                  int *rearrange,
                                                  Nd4jLong *out);

SD_EXPORT _CUDA_HD void doPermuteShapeInfo(Nd4jLong *shapeBuffer,
                                           const int *rearrange,
                                           Nd4jLong len = -1);
...
SD_EXPORT _CUDA_HD Nd4jLong *createPermuteIndexes(int originalRank,
                                                  int *dimension,
                                                  int dimensionLength);

SD_EXPORT _CUDA_HD Nd4jLong *computeResultShape(
    const Nd4jLong *originalShapeBuffer, int *dimension, int dimensionLength);
 ...
 * @param shapeBuffer
 */
SD_EXPORT _CUDA_HD void transposeInplace(Nd4jLong *shapeBuffer);
 ...
 * @return
 */
SD_EXPORT _CUDA_HD char getOrder(int length, Nd4jLong *shape, Nd4jLong *stride,
                                 int elementStride);
 ...
 */
template <typename T>
SD_EXPORT _CUDA_HD int checkArrangeArray(T *arr, int arrLength,
                                         int shapeLength);
 ...
 */
SD_EXPORT _CUDA_HD void permute(ShapeInformation **info, int *rearrange,
                                int rank);
 ...
 */
SD_EXPORT _CUDA_HD int isVector(Nd4jLong const *shape, int rank);

/**
 * When 1 dimension is the whole length of the
 * array
 */
SD_EXPORT _CUDA_HD int oneDimEqualToLength(Nd4jLong *shape, int rank);

SD_EXPORT _CUDA_HD int oneDimEqualToLength(Nd4jLong *shapeInfo);

SD_EXPORT _CUDA_HD int isVector(const Nd4jLong *shapeInfo);

SD_EXPORT _CUDA_HD bool isLikeVector(Nd4jLong const *shapeInfo,
                                     int &posOfNonUnityDim);

SD_EXPORT _CUDA_HD bool isCommonVector(const Nd4jLong *shapeInfo,
                                       int &posOfNonUnityDim);

SD_EXPORT _CUDA_HD bool isRowVector(const Nd4jLong *shapeInfo);

SD_EXPORT _CUDA_HD bool isColumnVector(Nd4jLong const *shapeInfo);

/**
 * shape - input inShape is shape only, not shapeInfo
 * returns number of non-unity dimensions in inShape
 */
SD_EXPORT _CUDA_HD int numOfNonUnitDims(const int rank,
                                        const Nd4jLong *inShape);
 ...
 * buffer
 */
SD_EXPORT _CUDA_HD Nd4jLong *shapeOf(Nd4jLong *shapeInfo);
SD_EXPORT _CUDA_HD Nd4jLong *shapeOf(const Nd4jLong *shapeInfo);
...
template <typename T>
SD_EXPORT _CUDA_HD T *copyOf(Nd4jLong length, T const *toCopy);

template <typename T>
SD_EXPORT _CUDA_HD T *copyOf(Nd4jLong length, T const *toCopy, T *ret);
...
template <typename T>
SD_EXPORT _CUDA_HD void copyTo(Nd4jLong length, T const *from, T *to);
/**
 * Return a copy of a buffer.
 * This buffer allocates memory
 * that must be freed elsewhere.
 */
SD_EXPORT _CUDA_HD void copyTo(int length, Nd4jLong const *from, Nd4jLong *to,
                               Nd4jLong *indexes);
 ...
 */
// SD_EXPORT _CUDA_HD Nd4jLong *permutedStrides(Nd4jLong *toPermute, int
// shapeRank, Nd4jLong *rearrange);
...
SD_EXPORT _CUDA_HD int slices(Nd4jLong *shapeBuffer);

SD_EXPORT _CUDA_HD Nd4jLong *sliceOfShapeBuffer(Nd4jLong sliceIdx,
 ...
 * @return rank * 2 + 4
 */
SD_EXPORT _CUDA_HD int shapeInfoLength(int rank);

SD_EXPORT _CUDA_HD int shapeInfoLength(Nd4jLong *shapeInfo);

SD_EXPORT _CUDA_HD int shapeInfoLength(const Nd4jLong *shapeInfo);

SD_EXPORT _CUDA_HD size_t shapeInfoByteLength(int rank);

SD_EXPORT _CUDA_HD size_t shapeInfoByteLength(const Nd4jLong *shapeInfo);
 ...
 */
SD_EXPORT _CUDA_HD int rank(const Nd4jLong *shapeInfo);
SD_EXPORT _CUDA_HD int rank(const int *shapeInfo);
SD_EXPORT _CUDA_HD int rank(const unsigned int *shapeInfo);

/**
 *  returns pointer on elementWiseStride
 */
SD_EXPORT _CUDA_HD Nd4jLong *ews(Nd4jLong *shapeInfo);
 ...
 */
SD_EXPORT _CUDA_HD ShapeInformation *infoFromBuffer(Nd4jLong *buffer);

/**
 * Returns the stride portion of an information
 * buffer
 */
SD_EXPORT _CUDA_HD Nd4jLong *stride(Nd4jLong *buffer);

SD_EXPORT _CUDA_HD Nd4jLong *stride(const Nd4jLong *buffer);

/**
 * Compute the length of the given shape
 */
SD_EXPORT _CUDA_HD bool isEmpty(const Nd4jLong *shapeInfo);

SD_EXPORT _CUDA_HD Nd4jLong length(const Nd4jLong *shapeInfo);

SD_EXPORT _CUDA_HD Nd4jLong length(std::initializer_list<int> &shape);

SD_EXPORT _CUDA_HD Nd4jLong length(std::initializer_list<Nd4jLong> &shape);

/***
 * Returns the offset portion of an information buffer
 */
SD_EXPORT _CUDA_HD Nd4jLong offset(Nd4jLong *buffer);

SD_EXPORT _CUDA_HD Nd4jLong &extra(Nd4jLong *buffer);

/**
 * Returns the ordering
 * for this shape information buffer
 */
SD_EXPORT _CUDA_HD char order(const Nd4jLong *buffer);

/**
 * Returns the type
 */
SD_EXPORT _CUDA_HD Nd4jLong type(const Nd4jLong *shapeInfo);
 ...
 */
SD_EXPORT _CUDA_HD Nd4jLong reductionIndexElementWiseStride(
    Nd4jLong *buffer, int *dimension, int dimensionLength);
 ...
 */
SD_EXPORT _CUDA_HD int isScalar(const Nd4jLong *info);
 ...
 * shape or not
 */
SD_EXPORT _CUDA_HD int isScalar(volatile ShapeInformation *info);
...
SD_EXPORT _CUDA_HD void removeIndex(T1 const *data, T2 const *indexes,
                                    Nd4jLong dataLength, Nd4jLong indexesLength,
                                    T1 *out);
...
template <typename T1, typename T2>
SD_EXPORT _CUDA_HD T1 *removeIndex(T1 const *data, T2 const *indexes,
                                   Nd4jLong dataLength, Nd4jLong indexesLength);
 ...
 */
SD_EXPORT _CUDA_HD Nd4jLong *everyIndexBut(Nd4jLong const *indexes,
                                           int indexesLength, int begin,
                                           int end);
...
//    __device__
//#endif
//    SD_EXPORT int tadOffset(shape::ShapeInformation *xInfo, int offset);
...
SD_EXPORT _CUDA_HD Nd4jLong *createScalarShapeInfo();

SD_EXPORT _CUDA_HD Nd4jLong *createScalarShapeInfo(Nd4jLong *ret);
 ...
 */
template <typename T>
SD_EXPORT _CUDA_HD T *range(int from, int to, int increment);
 ...
 */
template <typename T>
SD_EXPORT _CUDA_HD T *range(int from, int to);

/**
 * Keep the given indexes
 * in the data
 */
SD_EXPORT _CUDA_HD Nd4jLong *keep(volatile Nd4jLong *data, int const *index,
                                  int indexLength, int dataLength);
...
template <typename T>
SD_EXPORT _CUDA_HD T *reverseCopy(T const *data, Nd4jLong length);

template <typename T>
SD_EXPORT _CUDA_HD void reverseCopyTo(T const *from, T *to, Nd4jLong length);

template <typename T>
SD_EXPORT _CUDA_HD void reverseCopyTo(T const *from, T *to, Nd4jLong *indexes,
                                      Nd4jLong length);

template <typename T1, typename T2>
SD_EXPORT _CUDA_H void convertT(T1 *from, T2 *to, Nd4jLong length);
/**
 *
 * @param arr1
 * @param arr1Length
 ...
 */
template <typename T>
SD_EXPORT _CUDA_HD T *concat(T const *arr1, Nd4jLong const arr1Length,
                             T const *arr2, Nd4jLong const arr2Length);
 ...
 */
template <typename T>
SD_EXPORT _CUDA_HD T *concat(int const numArrays, int const numTotalElements,
                             Nd4jLong const **arr, Nd4jLong const *lengths);
 ...
 */
SD_EXPORT _CUDA_HD Nd4jLong lengthPerSlice(int rank, Nd4jLong const *shape,
                                           int const *dimension,
                                           int dimensionLength);
 ...
 * @return
 */
SD_EXPORT _CUDA_HD Nd4jLong sliceOffsetForTensor(
    int rank, int index, Nd4jLong const *shape, Nd4jLong const *tensorShape,
    int tensorShapeLength, int const *dimension, int dimensionLength);
 ...
 * @return
 */
SD_EXPORT _CUDA_HD Nd4jLong sliceOffsetForTensor(int index, int tensorLength,
                                                 int lengthPerSlice2);
/**
 ...
 * @param dimension the dimensions to use for computing the tensor along
 * dimensions
 */
//    SD_EXPORT _CUDA_HD int offset(int index,
//                         int rank,
 ...
 * a given dimension
 */
SD_EXPORT _CUDA_HD Nd4jLong tensorsAlongDimension(int rank, volatile int length,
 ...
 * a given dimension
 */
SD_EXPORT _CUDA_HD Nd4jLong tensorsAlongDimension(Nd4jLong *shapeInfo,
                                                  int *dimension,
                                                  int dimensionLength);
 ...
 * @return
 */
SD_EXPORT _CUDA_HD int tadForBlockIndex(int blockSize, int blockIdx, int i);

/**
 * Computes the number of tads per block
 *
 */
SD_EXPORT _CUDA_HD int tadsPerBlock(int blockSize, int tads);

//    SD_EXPORT _CUDA_HD Nd4jLong *tadShapeInfo(int index, Nd4jLong *xShapeInfo,
//    Nd4jLong *dimension,
//                                int dimensionLength);
 ...
 */
SD_EXPORT _CUDA_HD Nd4jLong *toShapeBuffer(ShapeInformation *info);
 ...
 * per tad
 */
SD_EXPORT _CUDA_HD int tadIndex(int i, int elementWiseStride,
 ...
 * @param tadsForReduced the number of tads for the shrunk down problem (eg:
 * 2,3)
 * @param tadsForOriginal the number of tads for the smaller problem (eg: 3)
 */
SD_EXPORT _CUDA_HD int reductionIndexForTad(int tadIndexForOriginal,
                                            int tadsForReduced,
                                            int tadsForOriginal);
 ...
 * reduction tad.
 */
SD_EXPORT _CUDA_HD int tadsPerReduceIndex(int tadsForReduce,
                                          int tadsForOriginal);
 ...
 */
SD_EXPORT _CUDA_HD int reductionIndexForLinear(int i, int elementWiseStride,
                                               int numElementsPerTad,
 ...
 * up to the given length
 */
SD_EXPORT _CUDA_HD Nd4jLong prodLong(const Nd4jLong *data, int length);
...
//    SD_EXPORT _CUDA_HD int rearMostLeftOverItem(Nd4jLong *data,int
//    length,Nd4jLong *dimension,int dimensionLength);
...
SD_EXPORT _CUDA_HD Nd4jLong getOffset(const Nd4jLong *shapeInfo,
                                      const Nd4jLong *coords,
                                      Nd4jLong baseOffset = 0);
SD_EXPORT _CUDA_HD Nd4jLong getOffset(const Nd4jLong *shapeInfo,
                                      const int *coords,
                                      Nd4jLong baseOffset = 0);
SD_EXPORT _CUDA_HD Nd4jLong getOffset(const Nd4jLong *shapeInfo,
...
SD_EXPORT _CUDA_HD Nd4jLong *createShapeInfo(Nd4jLong *shape, Nd4jLong *stride,
                                             int rank);

SD_EXPORT _CUDA_HD Nd4jLong *createShapeInfo(Nd4jLong *shape, Nd4jLong *stride,
                                             int rank, Nd4jLong *buffer);

/**
 * Convert a linear index to the corresponding coordinates
 * for example if shape is {2, 4}, then index 5 corresponds to coordinates [1,
 * 1]
 */
SD_EXPORT _CUDA_HD void index2coords(Nd4jLong index, const Nd4jLong *shapeInfo,
                                     Nd4jLong *coords);
SD_EXPORT _CUDA_HD void index2coords(Nd4jLong index, const Nd4jLong *shapeInfo,
                                     int *coords);
SD_EXPORT _CUDA_HD void index2coords(Nd4jLong index, const Nd4jLong *shapeInfo,
                                     uint *coords);
SD_EXPORT _CUDA_HD void index2coords(Nd4jLong index, const int rank,
                                     const Nd4jLong *shape, Nd4jLong *coords);
SD_EXPORT _CUDA_HD void index2coords(Nd4jLong index, const int rank,
                                     const Nd4jLong *shape, int *coords);

SD_EXPORT _CUDA_HD void index2coordsCPU(const Nd4jLong &startIndex,
                                        const Nd4jLong &index,
                                        const Nd4jLong *shapeInfo,
                                        Nd4jLong *coords);
SD_EXPORT _CUDA_HD void index2coordsCPU(const Nd4jLong &startIndex,
                                        const Nd4jLong &index,
                                        const Nd4jLong *shapeInfo, int *coords);

/**
 * take into account only dimensions stored in tadDims, tadDims must be sorted
 * in increasing order!
 */
SD_EXPORT _CUDA_HD void index2coords(Nd4jLong index, const Nd4jLong *shapeInfo,
                                     int *coords, const int dimsSize,
                                     const int *tadDims);

/**
 * Convert coordinates to the corresponding linear index (sequence number in
 * other words) for example if shape is {2, 4} and coordinates [1, 1] then index
 * 5 is returned
 */
SD_EXPORT _CUDA_HD Nd4jLong coords2index(const Nd4jLong *shapeInfo,
                                         const Nd4jLong *coords);
SD_EXPORT _CUDA_HD Nd4jLong coords2index(const Nd4jLong *shapeInfo,
                                         const int *coords);
SD_EXPORT _CUDA_HD Nd4jLong coords2index(const Nd4jLong *shapeInfo,
                                         const uint *coords);
SD_EXPORT _CUDA_HD Nd4jLong coords2index(const int rank, const Nd4jLong *shape,
                                         const int *coords);
/**
 * take into account only dimensions stored in tadDims, tadDims must be sorted
 * in increasing order!
 */
SD_EXPORT _CUDA_HD Nd4jLong coords2index(const Nd4jLong *shapeInfo,
                                         const int *coords, const int dimsSize,
                                         const int *tadDims);

/**
 * increment n-dimensional array by one iteration by changing coord
 * appropriately for example we have array with shape {2, 3}:
 * - if input coord = {0,1}, then output coord = {0,2}
 * - if input coord = {0,2}, then output coord = {1,0}
 * so the aim is to produce following subsequence of coord: {0,0}, {0,1}, {0,2},
 * {1,0}, {1,1}, {1,2}
 */

/* calculates an array buffer offset for given "index" using following formula:
 * offset = coord_0*stride_0 + coord_1*stride_1 + ... +
 * coord_{rank-1}*stride_{rank-1}
 */
SD_EXPORT _CUDA_HD uint getIndexOffset(uint index, const uint *shapeInfo);
SD_EXPORT _CUDA_HD Nd4jLong getIndexOffset(Nd4jLong index,
                                           const Nd4jLong *shapeInfo);
SD_EXPORT _CUDA_HD Nd4jLong indexOffset(Nd4jLong index,
                                        const Nd4jLong *lShapeInfo,
                                        const uint *uShapeInfo,
                                        const bool useUnsigned);

SD_EXPORT _CUDA_HD void printShapeInfo(Nd4jLong *shapeInfo);

SD_EXPORT _CUDA_HD void printShapeInfoLinear(const Nd4jLong *shapeInfo);

SD_EXPORT _CUDA_HD void printShapeInfoLinear(const char *msg,
                                             const Nd4jLong *shapeInfo);

SD_EXPORT _CUDA_HD void printShapeInfoLinear(const char *msg, int rank,
                                             const Nd4jLong *shape,
                                             const Nd4jLong *strides);

SD_EXPORT _CUDA_HD void printIntArray(const Nd4jLong *arr, const int length);
SD_EXPORT _CUDA_HD void printIntArray(const int *arr, const int length);

SD_EXPORT _CUDA_HD void printArray(float *arr, int length);

template <typename T>
SD_EXPORT _CUDA_HD void printArray(T *arr, int length, const char *message);

SD_EXPORT _CUDA_HD Nd4jLong *shapeBufferOfNpy(int rank, unsigned int *shape,
                                              bool fortranOrder);

SD_EXPORT _CUDA_HD Nd4jLong *shapeBufferOfNpy(cnpy::NpyArray arr);

//    SD_EXPORT _CUDA_HD Nd4jLong *shapeBufferOfNpyBuffer(char *buffer);

// this function checks the consistence of dimensions with array rank (negative
// dimensions, too large dimensions, too big number of dimensions) also sort
// input array of dimensions, this operation is also necessary for creating TAD
// object
SD_EXPORT _CUDA_H void checkDimensions(const int rank,
                                       std::vector<int> &dimensions);

// function calculates linear index of array min, min is sub-array of max, index
// to be returned is min-array's index and corresponds to maxIdx of max array
// dimsToExclude - should be sorted in increasing order
SD_EXPORT _CUDA_HD Nd4jLong subArrayIndex(const Nd4jLong maxIdx,
                                          const Nd4jLong *maxShapeInfo,
                                          const Nd4jLong *minShapeInfo,
                                          const int *dimsToExclude = nullptr,
                                          const int dimsLen = -1);

// function calculates absolute offset of min array, min is sub-array of max,
// offset to be returned corresponds to maxIdx of max array dimsToExclude -
// should be sorted in increasing order
SD_EXPORT _CUDA_HD Nd4jLong subArrayOffset(const Nd4jLong maxIdx,
                                           const Nd4jLong *maxShapeInfo,
                                           const Nd4jLong *minShapeInfo,
                                           const int *dimsToExclude = nullptr,
                                           const int dimsLen = -1);
...
// function calculates the coordinates of min array (and saves them into
// minIdxs) given coordinates of max array (already stored in maxIdxs)
// dimsToExclude - should be sorted in increasing order
// dimsLen - length of dimsToExclude, if not set (= -1), then it is calculated
// as maxRank - minRank
SD_EXPORT _CUDA_HD void maxIndToMinInd(int *maxIdxs, int *minIdxs,
                                       const Nd4jLong *maxShapeInfo,
                                       const Nd4jLong *minShapeInfo,
                                       const int *dimsToExclude = nullptr,
                                       const int dimsLen = -1);

// calculate indexes of max-array, these output indexes correspond to one minIdx
// index of min-array which is sub-array of max-array dimsToExclude - should be
// sorted in increasing order
SD_EXPORT _CUDA_HD int outerArrayIndexes(int *maxIdxs, const Nd4jLong minIdx,
                                         const Nd4jLong *maxShapeInfo,
                                         const Nd4jLong *minShapeInfo,
                                         const int *dimsToExclude = nullptr);

// calculate offsets of max-array, these offsets correspond to one minIdx index
// of min-array which is sub-array of max-array maxOffsets - will contain
// calculated offsets of max-array, buffer for maxOffsets should be allocated
// beforehand dimsToExclude - should be sorted in increasing order memBuff -
// auxiliary memory buffer (size = 2 * max_rank) for coordinates and increments
// storing, should be allocated beforehand
SD_EXPORT _CUDA_HD int outerArrayOffsets(Nd4jLong *maxOffsets,
                                         const Nd4jLong minIdx,
                                         const Nd4jLong *maxShapeInfo,
                                         const Nd4jLong *minShapeInfo,
                                         int *memBuff,
                                         const int *dimsToExclude = nullptr);

// calculates offsets for entities (elements or sub-arrays), shape in context of
// sub-array means dimensions excluded from outer array rank is equal to size of
// shape
SD_EXPORT void calcOffsets(const int rank, const Nd4jLong *shape,
                           const Nd4jLong *strides, Nd4jLong *offsets,
                           const char order = 'c');
SD_EXPORT void calcOffsets(const Nd4jLong *shapeInfo, Nd4jLong *offsets,
                           const char order = 'c');
// SD_EXPORT void calcOffsets(const Nd4jLong *xShapeInfo, Nd4jLong*& xOffsets,
// const Nd4jLong *yShapeInfo, Nd4jLong*& yOffsets, const char order = 'c');
// SD_EXPORT void calcOffsets(const Nd4jLong *xShapeInfo, Nd4jLong*& xOffsets,
// const Nd4jLong *yShapeInfo, Nd4jLong*& yOffsets, const Nd4jLong* zShapeInfo,
// Nd4jLong*& zOffsets, const char order = 'c');
SD_EXPORT _CUDA_HD void shapeOldScalar(sd::DataType dtype,
...
// if array is common vector then ews = stride of non-unity dimension and order
// is preserved if strides are normal/contiguous then ews = 1 and corresponding
// order is set, otherwise ews = 0 and order is preserved
SD_EXPORT _CUDA_HD void checkStridesEwsAndOrder(
    Nd4jLong *shapeInfo, const char proposedOrder, const int numOfNonUnitDims,
    const Nd4jLong *shapeNoUnities, const Nd4jLong *stridesNoUnities);
SD_EXPORT _CUDA_HD void checkStridesEwsAndOrder(Nd4jLong *shapeInfo);

/**
 * processes whole set of sub-arrays
 * evaluates shapeInfo of sub-arrays (all sub-arrays have the same shapeInfo)
 * and their buffer offsets (each sub-array has its own unique offset from
 * original this-buffer) arguments: wholeShapeInfo - original shapeInfo of whole
 * array numOfSubArrs - number of sub-arrays, size of subArrOffsets is equal to
 * numOfSubArrs dimsSize - size of dimsToExclude, if dimsSize = array rank or
 * dimsSize = 0 it means sub-array is whole array, copy of wholeShapeInfo and
 * one zero offset will be returned dimsToExclude - MUST BE SORTED, dimensions
 * to evaluate sub-array along, i.e. when shape is [2,3,4,5] and
 * dimsToExclude={0,2}, then there will be 8 sub-arrays with shape [3,5]
 * subArrShapeInfo    - output argument, contains shapeInfo (same for all
 * sub-arrays) subArrOffsets      - output argument, contains successive
 * sub-arrays offsets from original this-buffer keepUnitiesInShape - if false
 * then eliminate unities from sub-array shapeInfo, for example {1,a,1,b} ->
 * {a,b}
 */
SD_EXPORT _CUDA_HD void calcSubArrsShapeInfoAndOffsets(
    const Nd4jLong *wholeShapeInfo, const Nd4jLong numOfSubArrs,
    const int dimsSize, const int *dimsToExclude, Nd4jLong *subArrShapeInfo,
    Nd4jLong *subArrOffsets, bool keepUnitiesInShape = false);

/**
 * processes only one sub-array, evaluates shapeInfo of sub-array and its buffer
 * offset from original array arguments: idx - input argument, intervals of
 * indexes which define the sub-array to point on, when isStrided = false then
 * idx has form {dim0Start,dim0End,  dim1Start,dim1End, ....} and length (2 *
 * maxRank) when isStrided = true  then idx has form
 * {dim0Start,dim0End,dim0Stride,  dim1Start,dim1End,dim1Stride, ....} and
 * length (3 * maxRank) when (dimStart == dimEnd) then whole range will be used
 * for current dimension maxShapeInfo - input argument, shapeInfo of original
 * array minShapeInfo - output argument, shapeInfo of sub-array to be deduced
 * minOffset - output argument, offset of sub-array buffer offsets from original
 * buffer keepUnitiesInShape - input argument, if false then eliminate unities
 * from sub-array shapeInfo, for example {1,a,1,b} -> {a,b} isStrided - input
 * argument, if true then idx has length (3 * this->rankOf()) and contains
 * additional stride numbers which correspond to stride between dimStart and
 * dimEnd, numOfUntiesInMinShape - input argument, number of occurrences in idx
 * when (dimEnd - dimStart) = 1
 */
SD_EXPORT void calcSubArrShapeInfoAndOffset(
    const Nd4jLong *idx, const Nd4jLong *maxShapeInfo, Nd4jLong *minShapeInfo,
    Nd4jLong &minOffset, const bool keepUnitiesInShape = false,
    const bool isStrided = false, const int numOfUntiesInMinShape = 0);

/**
 * for example inShapeInfo is {3, 2,1,4, 4,4,1, 16384,1,99}
 * then output shapeNoUnities will contain {2,4, 4,1} - that is only shape and
 * strides, no rank/type/ews/order stridesNoUnities will point on strides in
 * shapeNoUnities that is on {4,1} returns number of non-unity dimensions in
 * inShapeInfo if there is no unities in inShapeInfo, then no copy procedure
 * will be performed and shapeNoUnities/stridesNoUnities will point on
 * corresponding places in inShapeInfo
 */
SD_EXPORT _CUDA_HD int excludeUnitiesFromShapeInfo(const Nd4jLong *inShapeInfo,
                                                   Nd4jLong *&shapeNoUnities,
                                                   Nd4jLong *&stridesNoUnities);

/**
 * for example inShapeInfo is {3, 2,1,3,1,4,  12,12,4,4,1, 16384,1,99},
 * dimsToExclude = {1,3}, dimsSize = 2 then outShapeInfo will contain {3, 2,3,4,
 * 12,4,1, 16384,1,99}
 */
INLINEDEF _CUDA_HD void excludeUnitiesFromShapeInfo(const Nd4jLong *inShapeInfo,
                                                    const int dimsSize,
 ...
 * for example when inShapeInfo is {4, 2,5,4,3,  60,1,5,20, 16384,0,99} then
 * output is 5 (that is smallest stride in inShapeInfo except those equal to 1)
 */
// INLINEDEF _CUDA_HD Nd4jLong strideOverContigAxis(const int axis, const
// Nd4jLong* inShapeInfo);
 ...
 */
INLINEDEF _CUDA_HD Nd4jLong tadLength(const Nd4jLong *shapeInfo, int *dimension,
                                      int dimensionLength) {
 ...
 */
INLINEDEF _CUDA_HD int tadElementWiseStride(Nd4jLong *shapeInfo, int *dimension,
                                            int dimensionLength) {
  return reductionIndexElementWiseStride(shapeInfo, dimension, dimensionLength);
}

INLINEDEF _CUDA_HD bool shapeEquals(const int shape1Rank,
                                    const Nd4jLong *shape1,
                                    const int shape2Rank,
                                    const Nd4jLong *shape2) {
...
INLINEDEF _CUDA_HD bool shapeEquals(const Nd4jLong *shapeInfo1,
                                    const Nd4jLong *shapeInfo2) {
  return shape::shapeEquals(shape::rank(shapeInfo1),
                            shape::shapeOf(const_cast<Nd4jLong *>(shapeInfo1)),
                            shape::rank(shapeInfo2),
                            shape::shapeOf(const_cast<Nd4jLong *>(shapeInfo2)));
}

INLINEDEF _CUDA_HD bool shapeEquals(const Nd4jLong *shapeInfo1,
                                    const Nd4jLong *shapeInfo2,
                                    const Nd4jLong *shapeInfo3) {
  return shape::shapeEquals(shapeInfo1, shapeInfo2) &&
         shape::shapeEquals(shapeInfo1, shapeInfo3);
}

INLINEDEF _CUDA_HD bool strideEquals(int const shape1Rank,
                                     Nd4jLong const *shape1,
                                     int const shape2Rank,
                                     Nd4jLong const *shape2) {
  if (shape1Rank != shape2Rank) return false;
...
INLINEDEF _CUDA_HD bool strideEquals(Nd4jLong const *shapeInfo1,
                                     Nd4jLong const *shapeInfo2) {
  return shape::strideEquals(shape::rank(shapeInfo1), shape::stride(shapeInfo1),
                             shape::rank(shapeInfo2),
                             shape::stride(shapeInfo2));
}

INLINEDEF _CUDA_HD bool strideEquals(Nd4jLong const *stride1, int const rank1,
                                     Nd4jLong const *stride2, int const rank2) {
...
INLINEDEF _CUDA_HD Nd4jLong *computeResultShape(
    Nd4jLong const *originalShapeBuffer, int *dimension, int dimensionLength) {
  Nd4jLong *retShape;
  int retShapeLength;
  if (dimensionLength == 1 && dimension[0] == 2147483647) {
    ...
    retShape = shape::removeIndex<Nd4jLong, int>(
        shape::shapeOf(originalShapeBuffer), dimension,
  ...
  auto ret = shape::shapeBuffer(retShapeLength,
                                sd::ArrayOptions::dataType(originalShapeBuffer),
                                retShape);
  delete[] retShape;
...
INLINEDEF _CUDA_HD Nd4jLong *shapeInfoOnlyShapeAndStride(
    const Nd4jLong *shapeInfo, Nd4jLong *dimension, int dimensionLength,
    bool reverseCopyStride, Nd4jLong *buffer) {
...
INLINEDEF _CUDA_HD Nd4jLong *shapeInfoOnlyShapeAndStride(
  ...
  return shapeInfoOnlyShapeAndStride(shapeInfo, dimension, dimensionLength,
                                     reverseCopyStride, ret);
}

INLINEDEF _CUDA_HD Nd4jLong *createShapeInfo(Nd4jLong *shape, Nd4jLong *stride,
                                             int rank) {
  traceNew(5);
 ...
 * @return the strides for a matrix of n dimensions
 */
INLINEDEF _CUDA_HD Nd4jLong *calcStridesFortran(Nd4jLong const *shape,
                                                int rank) {
  ...
  if (rank > 0) {
    if (order == 'c') {
      ...
      for (int j = 1; j < rank; ++j) {
        shapeInfo[doubleRank - j] =
            shapeInfo[doubleRank - j + 1] * shapeInfo[rank + 1 - j];
      }
    } else {
...
//////////////////////////////////////////////////////////////////////
INLINEDEF _CUDA_HD void updateStrides(const int rank, const Nd4jLong *shapeOnly,
                                      Nd4jLong *stridesOnly, const char order) {
  if (rank > 0) {
    if (order == 'c') {
...
// have to be 0,....,rank-1
template <typename T>
INLINEDEF _CUDA_HD bool isDimPermuted(const T *dimensions,
                                      const Nd4jLong dimSize) {
...
INLINEDEF _CUDA_HD int computeElementWiseStride(int rank, Nd4jLong const *shape,
                                                Nd4jLong const *stride,
                                                int isFOrder) {
  if (rank == 0) return 1;
  ...
  if (shape::isVector(shape, rank)) {
    ...
    /* oldStart to oldStop and newStart to newStop give the axis ranges
 ...
 * for the given rank and shape.
 */
INLINEDEF _CUDA_HD Nd4jLong *shapeBuffer(int rank, sd::DataType dtype,
                                         Nd4jLong const *shape) {
  ...
  shapeInfo->rank = rank;
  int elementWiseStride =
      shape::computeElementWiseStride(rank, shape, stride, 0);
  shapeInfo->order = 'c';
 ...
 * for the given rank and shape.
 */
INLINEDEF _CUDA_HD Nd4jLong *shapeBufferFortran(int rank, sd::DataType dtype,
                                                Nd4jLong const *shape) {
...
//////////////////////////////////////////////////////////////////////
INLINEDEF _CUDA_HD Nd4jLong coords2index(const Nd4jLong *shapeInfo,
                                         const Nd4jLong *indices) {
...
//////////////////////////////////////////////////////////////////////
INLINEDEF _CUDA_HD Nd4jLong coords2index(const int rank, const Nd4jLong *shape,
                                         const int *indices) {
  Nd4jLong index, shift = 1;
  ;
...
// //////////////////////////////////////////////////////////////////////
//     INLINEDEF _CUDA_HD Nd4jLong getIndexOffset(Nd4jLong index, const Nd4jLong
//     *shapeInfo, Nd4jLong arrLen) {
...
//////////////////////////////////////////////////////////////////////
INLINEDEF _CUDA_HD Nd4jLong getIndexOffset(Nd4jLong index,
                                           const Nd4jLong *shapeInfo) {
...
//////////////////////////////////////////////////////////////////////
INLINEDEF _CUDA_HD Nd4jLong indexOffset(Nd4jLong index,
                                        const Nd4jLong *lShapeInfo,
                                        const uint *uShapeInfo,
                                        const bool useUnsigned) {
  if (useUnsigned) return getIndexOffset(static_cast<uint>(index), uShapeInfo);
 ...
 * @return
 */
INLINEDEF _CUDA_HD Nd4jLong *doPermuteSwap(int length, Nd4jLong *shape,
                                           int *rearrange) {
  traceNew(16);
 ...
 * @return
 */
INLINEDEF _CUDA_HD void doPermuteSwap(int length, Nd4jLong **shape,
                                      int *rearrange) {
  if (length == 1) {
    return;
  } else {
...
INLINEDEF _CUDA_HD void permuteShapeBufferInPlace(Nd4jLong *shapeBuffer,
                                                  int *rearrange,
                                                  Nd4jLong *out) {
  if (shapeBuffer != out)
    memcpy(out, shapeBuffer,
           sizeof(Nd4jLong) * shape::shapeInfoLength(shapeBuffer));

  shape::doPermuteShapeInfo(out, rearrange);
}

INLINEDEF _CUDA_HD Nd4jLong *permuteShapeBuffer(Nd4jLong const *shapeBuffer,
                                                int *rearrange) {
...
INLINEDEF _CUDA_HD void doPermuteShapeInfo(Nd4jLong *shapeInfo,
                                           const int *rearrange, Nd4jLong len) {
  if (len == -1)  // calculate array length if it is not given
    len = shape::length(shapeInfo);

  // check whether shape is like {1} or {1,1} or {1,1,1,1,...} - in this case we
  // don't need permute
  if (len == 1) return;

  const int rank = shape::rank(shapeInfo);

  // check whether rearrange is like {0,1,2,3,...}  - in this case we don't need
  // permute as well
  ...
  for (int i = 0; i < rank; ++i)
    if (rearrange[i] >= rank || rearrange[i] < 0) {
      printf(
          "shape::doPermuteShapeInfo function failed: rearrange indexes are "
          "incorrect !\n");
      return;
    }
  ...
  memcpy(temp, shapeInfo,
         sizeof(Nd4jLong) * (shape::shapeInfoLength(rank) - 3));
  for (int i = 0; i < rank; ++i) {
...
INLINEDEF _CUDA_HD Nd4jLong *createPermuteIndexes(int originalRank,
                                                  int *dimension,
                                                  int dimensionLength) {
 ...
 * @return
 */
INLINEDEF _CUDA_HD char getOrder(int length, Nd4jLong *shape, Nd4jLong *stride,
                                 int elementStride) {
  Nd4jLong sd = 1;
  int dim = -1;
  int i = -1;
...
template <typename T>
INLINEDEF _CUDA_HD int checkArrangeArray(T *arr, int arrLength,
                                         int shapeLength) {
...
INLINEDEF _CUDA_HD bool isLikeVector(Nd4jLong const *shapeInfo,
                                     int &posOfNonUnityDim) {
  int numOfNonUnity = 0;
  for (int i = 1; i <= shapeInfo[0]; ++i) {
    if (shapeInfo[i] != 1) {
...
INLINEDEF _CUDA_HD bool isCommonVector(const Nd4jLong *shapeInfo,
                                       int &posOfNonUnityDim) {
...
INLINEDEF _CUDA_HD int isVector(const Nd4jLong *shapeInfo) {
  return isVector(shape::shapeOf(const_cast<Nd4jLong *>(shapeInfo)),
...
INLINEDEF _CUDA_HD bool isRowVector(const Nd4jLong *shapeInfo) {
  ...
  bool shapeFirstOne =
      shape::shapeOf(const_cast<Nd4jLong *>(shapeInfo))[0] == 1;
...
//////////////////////////////////////////////////////////////////////
INLINEDEF _CUDA_HD int numOfNonUnitDims(const int rank,
                                        const Nd4jLong *inShape) {
  int num = 0;
 ...
 * that must be freed elsewhere.
 */
INLINEDEF _CUDA_HD void copyTo(int length, Nd4jLong const *from, Nd4jLong *to,
                               Nd4jLong *indexes) {
  for (int i = 0; i < length; i++) {
    to[i] = from[indexes[i]];
  }
 ...
 */
/*
   INLINEDEF _CUDA_HD Nd4jLong *permutedStrides(Nd4jLong *toPermute, int
   shapeRank, int *rearrange) { Nd4jLong *strideCopy = copyOf(shapeRank,
   toPermute); checkArrangeArray(rearrange, shapeRank, shapeRank); Nd4jLong
   *newStride = doPermuteSwap(shapeRank, strideCopy, rearrange); delete[]
   strideCopy; return newStride;
   }
   */
 ...
 * @return the shape array - the first entry
 */
INLINEDEF _CUDA_HD Nd4jLong *slice(Nd4jLong *shape) { return shape + 1; }

INLINEDEF _CUDA_HD int slices(Nd4jLong *shapeBuffer) {
  return static_cast<int>(shape::shapeOf(shapeBuffer)[0]);
}

INLINEDEF _CUDA_HD Nd4jLong *sliceOfShapeBuffer(Nd4jLong sliceIdx,
                                                Nd4jLong *shapeBuffer) {
  ...
  // a slice is always just taking the existing shape and cutting the first
  // index off of the shape and stride
  ...
  if (shape::isVector(shapeBuffer)) {
    ...
    if (currShape[0] == 1) {
      if (sliceIdx == 0) {
        memcpy(newShapeBuffer, shapeBuffer,
               shape::shapeInfoByteLength(shape::rank(shapeBuffer)));
...
INLINEDEF _CUDA_HD int rank(const int *buffer) { return buffer[0]; }
...
INLINEDEF _CUDA_HD bool isEmpty(const Nd4jLong *shapeInfo) {
  return ((shape::extra(const_cast<Nd4jLong *>(shapeInfo)) & ARRAY_EMPTY) ==
          ARRAY_EMPTY);
}
...
INLINEDEF _CUDA_HD Nd4jLong length(const Nd4jLong *shapeInfo) {
  ...
  //         return shapeInfo[1] * shapeInfo[rank + 1];      // first dim *
  //         first stride
  //     return shapeInfo[rank] * shapeInfo[2 * rank];       // last  dim * last
  //     stride
  // }

  return shape::prodLong(shape::shapeOf(const_cast<Nd4jLong *>(shapeInfo)),
                         rank);
}
 ...
 */
INLINEDEF _CUDA_HD Nd4jLong reductionIndexElementWiseStride(
    Nd4jLong *buffer, int *dimension, int dimensionLength) {
  if (dimensionLength > 1) {
    if (shape::order(buffer) == 'f') {
      ...
      if (shape::shapeOf(buffer)[dimension[dimensionLength - 1]] != 1) {
        auto tadElementWiseStride =
            shape::stride(buffer)[dimension[dimensionLength - 1]];
        return tadElementWiseStride;
      }
...
INLINEDEF _CUDA_HD int isScalar(const Nd4jLong *info) {
  ...
  if (rank > 2) return 0;
  if (rank == 0) return 1;
  if (rank == 1) return shape::shapeOf(const_cast<Nd4jLong *>(info))[0] == 1;
  if (rank == 2)
    return shape::shapeOf(const_cast<Nd4jLong *>(info))[0] == 1 &&
           shape::shapeOf(const_cast<Nd4jLong *>(info))[1] == 1;
 ...
 */
template <typename T1, typename T2>
INLINEDEF _CUDA_HD void removeIndex(T1 const *data, T2 const *indexes,
                                    Nd4jLong dataLength, Nd4jLong indexesLength,
                                    T1 *ret) {
  int count = 0;
 ...
 */
template <typename T1, typename T2>
INLINEDEF _CUDA_HD T1 *removeIndex(T1 const *data, T2 const *indexes,
                                   Nd4jLong dataLength,
                                   Nd4jLong indexesLength) {
  auto lengthOfArr = dataLength - indexesLength;
  if (lengthOfArr < 0) {
    printf(
        "Remove index call created a <= 0 length array. This was likely not "
        "intended.");
  }
...
INLINEDEF _CUDA_HD Nd4jLong *everyIndexBut(const Nd4jLong *indexes,
                                           int indexesLength, int begin,
                                           int end) {
 ...
 * @return
 */
INLINEDEF _CUDA_HD bool equalsStrict(const Nd4jLong *shapeA,
                                     const Nd4jLong *shapeB) {
...
//////////////////////////////////////////////////////////////////////
INLINEDEF _CUDA_HD bool haveSameShapeAndStrides(const Nd4jLong *shapeInfo1,
                                                const Nd4jLong *shapeInfo2) {
...
/**
 * This method does SOFT comparison for two shape buffers, we compare only rank
 * & shapes
 *
 * @param shape
 * @return
 */
INLINEDEF _CUDA_HD bool equalsSoft(const Nd4jLong *shapeA,
                                   const Nd4jLong *shapeB) {
  if (shapeA[0] != shapeB[0]) return false;
...
INLINEDEF _CUDA_HD bool equalsTypesAndShapesSoft(const Nd4jLong *shapeA,
                                                 const Nd4jLong *shapeB) {
  return equalsSoft(shapeA, shapeB) && shapeA[shapeInfoLength(shapeA) - 3] ==
                                           shapeB[shapeInfoLength(shapeB) - 3];
}
 ...
 * @return
 */
INLINEDEF _CUDA_HD Nd4jLong *keep(volatile Nd4jLong *data, int const *index,
                                  int indexLength, int dataLength) {
  traceNew(23);
...
template <typename T>
INLINEDEF _CUDA_HD void reverseCopyTo(T const *from, T *to, Nd4jLong *indexes,
                                      Nd4jLong length) {
  if (length < 1) return;
 ...
 */
template <typename T>
INLINEDEF _CUDA_HD T *concat(T const *arr1, Nd4jLong const arr1Length,
                             T const *arr2, Nd4jLong const arr2Length) {
  traceNew(25);
 ...
 */
template <typename T>
INLINEDEF _CUDA_HD T *concat(Nd4jLong const numArrays,
                             Nd4jLong const numTotalElements, T const **arr,
                             Nd4jLong const *lengths) {
 ...
 * along the given dimension
 */
INLINEDEF _CUDA_HD Nd4jLong lengthPerSlice(int rank, Nd4jLong const *shape,
                                           int const *dimension,
                                           int dimensionLength) {
  if (shape::isVector(shape, rank)) {
  ...
  traceNew(27);
  auto ret2 =
      shape::removeIndex<Nd4jLong>(shape, dimension, rank, dimensionLength);
 ...
 * @return
 */
INLINEDEF _CUDA_HD Nd4jLong sliceOffsetForTensor(
    int rank, int index, Nd4jLong const *shape, Nd4jLong const *tensorShape,
    int tensorShapeLength, int const *dimension, int dimensionLength) {
  auto tensorLength = prodLong(tensorShape, tensorShapeLength);
  auto lengthPerSlice2 =
      lengthPerSlice(rank, shape, dimension, dimensionLength);
...
INLINEDEF _CUDA_HD Nd4jLong sliceOffsetForTensor(int index, int tensorLength,
                                                 int lengthPerSlice2) {
  Nd4jLong offset = index * tensorLength / lengthPerSlice2;
  return offset;
}
 ...
 * a given dimension
 */
INLINEDEF _CUDA_HD Nd4jLong tensorsAlongDimension(volatile int rank,
                                                  volatile int length,
                                                  volatile Nd4jLong *shape,
                                                  int *dimension,
                                                  int dimensionLength) {
 ...
 * a given dimension
 */
INLINEDEF _CUDA_HD Nd4jLong tensorsAlongDimension(Nd4jLong *shapeInfo,
                                                  int *dimension,
                                                  int dimensionLength) {
  Nd4jLong *keepShape = shape::shapeOf(shapeInfo);
  Nd4jLong *tensorShape =
      shape::keep(keepShape, dimension, dimensionLength, rank(shapeInfo));
  Nd4jLong ret =
      shape::length(shapeInfo) / shape::prodLong(tensorShape, dimensionLength);
  delete[] tensorShape;
  return ret;
}
...
//////////////////////////////////////////////////////////////////////////
INLINEDEF _CUDA_HD Nd4jLong getOffset(const Nd4jLong *shapeInfo,
                                      const Nd4jLong *indices,
                                      Nd4jLong baseOffset) {
...
//////////////////////////////////////////////////////////////////////////
INLINEDEF _CUDA_HD Nd4jLong getOffset(const Nd4jLong *shapeInfo,
                                      const int *coords, Nd4jLong baseOffset) {
  Nd4jLong offset = baseOffset;
...
//////////////////////////////////////////////////////////////////////////
INLINEDEF _CUDA_HD Nd4jLong getOffset(const Nd4jLong *shapeInfo,
                                      const uint *coords, Nd4jLong baseOffset) {
  Nd4jLong offset = baseOffset;
...
INLINEDEF _CUDA_HD void printShapeInfoLinear(const char *msg, int rank,
                                             const Nd4jLong *shape,
                                             const Nd4jLong *strides) {
  printf("%s : [", msg);
  for (int i = 0; i < rank; i++) {
...
INLINEDEF _CUDA_HD void printShapeInfoLinear(const char *msg,
                                             const Nd4jLong *shapeInfo) {
  int rank = shape::rank(shapeInfo);
  int lim = shape::shapeInfoLength(rank);
  printf("%s : [", msg);
...
template <typename T>
INLINEDEF _CUDA_HD void printArray(void *varr, int length,
                                   const char *message) {
 ...
 * per tad
 */
INLINEDEF _CUDA_HD int tadIndex(int i, int elementWiseStride,
                                int numElementsPerTad) {
 ...
 * @param tadsForOriginal the number of tads for the smaller problem (eg: 3)
 */
INLINEDEF _CUDA_HD int reductionIndexForTad(int tadIndexForOriginal,
                                            int tadsForReduced,
                                            int tadsForOriginal) {
 ...
 * reduction tad.
 */
INLINEDEF _CUDA_HD int tadsPerReduceIndex(int tadsForReduce,
                                          int tadsForOriginal) {
 ...
 * @param originalTadNum the tad number for the reduced version of the problem
 */
INLINEDEF _CUDA_HD int reductionIndexForLinear(int i, int elementWiseStride,
                                               int numElementsPerTad,
                                               int tadNum, int originalTadNum) {
...
INLINEDEF _CUDA_HD int rearMostLeftOverItem(Nd4jLong *data, Nd4jLong *dimension,
                                            int dimensionLength) {
...
#ifdef __CUDACC__
__device__ INLINEDEF void sweepShapeInfoBuffer(Nd4jLong *shapeInfoBuffer,
...
INLINEDEF _CUDA_HD Nd4jLong *shapeBufferOfNpy(cnpy::NpyArray arr) {
  return shape::shapeBufferOfNpy(
      arr.shape.size(), (unsigned int *)arr.shape.data(), arr.fortranOrder);
}
...
INLINEDEF _CUDA_HD Nd4jLong *shapeBufferOfNpy(int rank, unsigned int *shape,
                                              bool fortranOrder) {
  if (fortranOrder) {
    Nd4jLong *shapeBufferRet =
        shape::shapeBufferFortran(rank, sd::FLOAT32, (Nd4jLong *)shape);
...
INLINEDEF _CUDA_HD bool strideDescendingCAscendingF(
    const Nd4jLong *shapeBuffer) {
  int rank = shape::rank(shapeBuffer);
...
// INLINEDEF _CUDA_H bool reshapeC(const int oldRank, Nd4jLong* oldShape, const
// int newRank, Nd4jLong* newShapeOf, bool isFOrder, Nd4jLong* target) {
//         int oldnd;
//         Nd4jLong* olddims = shape::copyOf(oldRank, shape::shapeOf(oldShape));
//         Nd4jLong* oldstrides = shape::copyOf(oldRank,
//         shape::stride(oldShape)); int np, op, last_stride; int oi, oj, ok,
//         ni, nj, nk; Nd4jLong* newStrides = new Nd4jLong[newRank]; oldnd = 0;

//         /*
//          * Remove axes with dimension 1 from the old array. They have no
//          effect
//          * but would need special cases since their strides do not matter.
//          */
...
//                 } else {
//                     /* C order */
//                     if (oldstrides[ok] != olddims[ok + 1] * oldstrides[ok +
//                     1]) {
//                         /* not contiguous enough */
//                         delete[] olddims;
//                         delete[] oldstrides;
...
//         sd::ArrayOptions::setDataType(target,
//         sd::ArrayOptions::dataType(oldShape));
...
//////////////////////////////////////////////////////////////////////
// INLINEDEF _CUDA_H bool reshapeC(const int oldRank, const Nd4jLong*
// oldShapeInfo, const int newRank, const Nd4jLong* newShape, Nd4jLong*
// newShapeInfo) {

//         // PLEASE NOTE !: reshaping not-permuted (ews=1) array in f order
//         (except insertion/elimination of unities) will definitely cause
//         allocation of new buffer for array elements
//         // also this function takes into account identical shapes
//         automatically, namely in that case oldShapeInfo is completely copied
//         to newShapeInfo
...
//         const Nd4jLong* oldShape   =
//         shape::shapeOf(const_cast<Nd4jLong*>(oldShapeInfo)); const Nd4jLong*
//         oldStrides = shape::stride(const_cast<Nd4jLong*>(oldShapeInfo));
//         Nd4jLong oldStart(0), oldStop(1), newStart(0), newStop(1), newDim,
//         oldDim;
...
//                 if(oldShape[i] == 1)                // skip unity-dimension
//                 and its stride
//                     continue;
//                 while((i + step) < oldRank && oldShape[i + step] == 1)
//                     ++step;                         // skip following
//                     unity-dimensions and its strides if such are present
//                 if((i + step) < oldRank && oldStrides[i] != oldShape[i +
//                 step] * oldStrides[i + step])
...
//         // rest of strides should be unities (if there is remainder in
//         strides space, that is newStart < newRank) for (int i = newStart; i <
//         newRank; ++i)
//             newStrides[i] = 1;

//         newShapeInfo[2 * newRank + 3] = shape::order(oldShapeInfo); // order
//         newShapeInfo[2 * newRank + 2] =
//         shape::elementWiseStride(oldShapeInfo);     // ews newShapeInfo[2 *
//         newRank + 1] = shape::type(oldShapeInfo);                  // type

//         return true;
//     }

//////////////////////////////////////////////////////////////////////
INLINEDEF _CUDA_HD bool reshapeC(const Nd4jLong *oldShapeInfo,
                                 const char newOrder, const int newRank,
                                 const Nd4jLong *newShape,
                                 Nd4jLong *newShapeInfo) {
...
INLINEDEF _CUDA_HD bool reshapeC(const Nd4jLong *oldShapeInfo,
  ...
  if (shape::length(oldShapeInfo) == 1) {
    for (uint i = 0; i < newRank; ++i) shape::stride(newShapeInfo)[i] = 1;
  ...
  const auto oldEws =
      shape::elementWiseStride(const_cast<Nd4jLong *>(oldShapeInfo));

  if (oldEws > 0 && oldOrder != newOrder) return false;

  // *** FIRST STAGE - exclude unity dimensions from oldShapeInfo and
  // newShapeInfo (if such are present of course), since they don't affect on
  // strides evaluation, however they complicate code

  // FIXME - indeed we don't need to allocate so large memory amount
  // (4*MAX_RANK), sufficient amount is (2*oldNumOfNonUnities +
  // 2*newNumOfNonUnities)
  Nd4jLong tempBuffer[4 * MAX_RANK];
  Nd4jLong *oldShape = tempBuffer, *newShape = tempBuffer + 2 * MAX_RANK,
           *oldStrides, *newStrides;

  // exclude unities from oldShapeInfo
  const int oldNumOfNonUnities =
      shape::excludeUnitiesFromShapeInfo(oldShapeInfo, oldShape, oldStrides);
  const int newNumOfNonUnities =
      shape::excludeUnitiesFromShapeInfo(newShapeInfo, newShape, newStrides);
  ...
  while (newStart < newNumOfNonUnities && oldStart < oldNumOfNonUnities) {
    ...
    for (uint i = oldStart; i < oldStop - 1;
         ++i)  // do not check value of last stride, it doesn't matter
  ...
  // fill new calculated strides into newShapeInfo, take into account possible
  // unities in shape
  for (int j = 0, i = 0; i < newRank; ++i)
    shape::stride(newShapeInfo)[i] =
        (shape::shapeOf(newShapeInfo)[i] == 1) ? 1 : newStrides[j++];

  // set ews
  if (oldEws == 0)
    shape::checkStridesEwsAndOrder(newShapeInfo, newOrder, newNumOfNonUnities,
                                   newShape, newStrides);  // set ews and order
  else {
...
INLINEDEF _CUDA_H bool canReshape(const int oldRank, Nd4jLong *oldShape,
                                  const int newRank, Nd4jLong *newShapeOf,
                                  bool isFOrder) {
  Nd4jLong oldnd;
  Nd4jLong *oldDims = shape::copyOf(oldRank, shape::shapeOf(oldShape));
  ...
  /* oldStart to oldStop and newStart to newStop give the axis ranges currently
   * worked with */
  oldStart = 0;
  oldStop = 1;
  newStart = 0;
...
// this function checks the consistence of dimensions with array rank (negative
// dimensions, too large dimensions, too big number of dimensions) also it sorts
// input array of dimensions, this operation is also necessary for creating TAD
// object
INLINEDEF _CUDA_H void checkDimensions(const int rank,
                                       std::vector<int> &dimensions) {
  int dimSize = dimensions.size();
  if (dimSize == 0)
    throw std::runtime_error(
        "shape::checkDimensions method: array of dimensions is empty!");
  // check presence of negative dimensions and if they are present transform
  // them to positive ones -dim -> rank - |dim|
  for (auto &dim : dimensions)
    if (dim < 0) dim += rank;
  // sort input array of dimensions, this operation is also necessary for
  // creating TAD object in external methods
  if (dimSize > 1) {
  ...
  if (dimSize > rank)
    throw std::runtime_error(
        "shape::checkDimensions method: number of input dimensions is too big "
        "( > rank of array)!");
  // check if min dimension is still negative and whether max dimension is
  // bigger then rank-1
  if (dimensions[0] < 0 || dimensions.back() > (rank - 1))
    throw std::runtime_error(
        "shape::checkDimensions method: the negative dimension is still "
        "present in input array after transform or the too big dimension is "
        "present ( > rank of array) !");
}

// max array is outer for min array, min array is sub-array of max array
// function calculates the coordinates of min array (and saves them into
// minIdxs) given coordinates of max array (already stored in maxIdxs)
INLINEDEF _CUDA_HD void maxIndToMinInd(int *maxIdxs, int *minIdxs,
                                       const Nd4jLong *maxShapeInfo,
                                       const Nd4jLong *minShapeInfo,
                                       const int *dimsToExclude, int dimsLen) {
  const auto maxRank = shape::rank(maxShapeInfo);
  const auto minRank = shape::rank(minShapeInfo);

  // if(minRank >= maxRank)
  //     throw std::runtime_error("shape::maxIndToMinInd method: rank of min
  //     array should be smaller then rank of max array!");

  if (dimsLen == -1)
    dimsLen = maxRank - minRank;  // if size is not given (= -1) then it is
                                  // equal to ranks difference

  if (maxRank == minRank) {
    if (dimsToExclude ==
        nullptr) {  // --> means dimsToExclude == {0,1,2,...,dimsLen-1}
...
//////////////////////////////////////////////////////////////////////
INLINEDEF _CUDA_HD Nd4jLong subArrayIndex(const Nd4jLong maxIdx,
                                          const Nd4jLong *maxShapeInfo,
                                          const Nd4jLong *minShapeInfo,
                                          const int *dimsToExclude,
                                          const int dimsLen) {
...
//////////////////////////////////////////////////////////////////////
INLINEDEF _CUDA_HD Nd4jLong subArrayOffset(const Nd4jLong maxIdx,
                                           const Nd4jLong *maxShapeInfo,
                                           const Nd4jLong *minShapeInfo,
                                           const int *dimsToExclude,
                                           const int dimsLen) {
...
//////////////////////////////////////////////////////////////////////
INLINEDEF _CUDA_HD int outerArrayOffsets(
    Nd4jLong *maxOffsets, const Nd4jLong minIdx, const Nd4jLong *maxShapeInfo,
    const Nd4jLong *minShapeInfo, int *memBuff, const int *dimsToExclude) {
  const auto rankMin = shape::rank(minShapeInfo);
  const auto rankMax = shape::rank(maxShapeInfo);

  // if(rankMin >= rankMax)
  //     throw std::runtime_error("shape::subArrayIndex method: rank of min
  //     array should be smaller then rank of max array!");

  const auto diff =
      rankMax - rankMin;  // the size of dimsToExclude is equal to diff
  ...
  // transform storage indices to contain per-dim max indices, purpose - memory
  // saving fill increment array as well
  if (dimsToExclude == nullptr) {  // means dimsToExclude == {0,1,2,...,diff-1}
    for (minI = rankMin - 1, maxI = rankMax - 1; maxI >= diff; --maxI, --minI) {
      increment[maxI] = (maxShapeInfo[maxI + 1] == minShapeInfo[minI + 1])
                            ? 0
                            : minShapeInfo[minI + 1];
    ...
    for (N = diff - 1, minI = rankMin - 1, maxI = rankMax - 1; maxI >= 0;
         --maxI) {
  ...
  while (maxI >= 0) {
    if (increment[maxI] != 0) {
      ...
      if (indices[maxI] >= maxShapeInfo[maxI + 1]) {
        indices[maxI] %=
            increment[maxI];  // restore initial value of indices[maxI]
        step = -1;
      } else {
        maxOffsets[N++] = shape::getOffset(maxShapeInfo, indices);
        step = rankMax - 1 - maxI;
...
//////////////////////////////////////////////////////////////////////
INLINEDEF _CUDA_HD int outerArrayIndexes(int *maxIdxs, const Nd4jLong minIdx,
                                         const Nd4jLong *maxShapeInfo,
                                         const Nd4jLong *minShapeInfo,
                                         const int *dimsToExclude) {
  const auto rankMin = shape::rank(minShapeInfo);
  ...
  //     throw std::runtime_error("shape::subArrayIndex method: rank of max
  //     array should be <= MAX_RANK/2 !");
...
INLINEDEF _CUDA_HD void shapeOldScalar(sd::DataType dataType,
                                       Nd4jLong *const buffer,
                                       const char order) {
  buffer[0] = 2;
  buffer[1] = 1;
...
INLINEDEF _CUDA_H void convertT(T1 *from, T2 *to, Nd4jLong length) {
  for (Nd4jLong e = 0; e < length; e++) to[e] = (T2)from[e];
};

//////////////////////////////////////////////////////////////////////
INLINEDEF void calcOffsets(const Nd4jLong *shapeInfo, Nd4jLong *offsets,
                           const char order) {
  ...
  shape::calcOffsets(
      shape::rank(shapeInfo), shape::shapeOf(const_cast<Nd4jLong *>(shapeInfo)),
      shape::stride(const_cast<Nd4jLong *>(shapeInfo)), offsets, order);
}

//////////////////////////////////////////////////////////////////////
INLINEDEF void calcOffsets(const int rank, const Nd4jLong *shape,
                           const Nd4jLong *strides, Nd4jLong *offsets,
                           const char order) {
  // if(false) {                     // tests showed that this code did
  // calculation notably slower even for big N
  ...
  PRAGMA_OMP_SIMD
  for (int k = 0; k < rank; ++k) offsetPerDim[k] = (shape[k] - 1) * strides[k];
  ...
  if (order == 'c') {
    ...
    while (j >= 0) {
      if (shape[j] == 1) {
        --j;
        continue;
      }  // ignore dimensions equal to unity
...
INLINEDEF void _CUDA_HD checkStridesEwsAndOrder(Nd4jLong *shapeInfo) {
  // FIXME - indeed we don't need to allocate so large memory amount
  // (2*MAX_RANK), sufficient amount is (2*oldNumOfNonUnities +
  // 2*newNumOfNonUnities)
  Nd4jLong tempBuffer[2 * MAX_RANK];
  Nd4jLong *shape = tempBuffer, *strides;

  // exclude unities from shapeInfo
  const int numOfNonUnities =
      shape::excludeUnitiesFromShapeInfo(shapeInfo, shape, strides);

  shape::checkStridesEwsAndOrder(shapeInfo, shape::order(shapeInfo),
                                 numOfNonUnities, shape, strides);
}

//////////////////////////////////////////////////////////////////////
INLINEDEF void _CUDA_HD checkStridesEwsAndOrder(
    Nd4jLong *shapeInfo, const char proposedOrder, const int numOfNonUnities,
    const Nd4jLong *shapeNoUnities, const Nd4jLong *stridesNoUnities) {
  const int rank = shape::rank(shapeInfo);
  ...
  for (uint i = 0; i < numOfNonUnities - 1; ++i) {
    if (stridesNoUnities[i] !=
        shapeNoUnities[i + 1] * stridesNoUnities[i + 1]) {
      contiguous = false;
      break;
    }
  }
...
//////////////////////////////////////////////////////////////////////
INLINEDEF _CUDA_HD void calcSubArrsShapeInfoAndOffsets(
    const Nd4jLong *wholeShapeInfo, const Nd4jLong numOfSubArrs,
    const int dimsSize, const int *dimsToExclude, Nd4jLong *subArrShapeInfo,
    Nd4jLong *subArrOffsets, bool keepUnitiesInShape) {
  const int rank = shape::rank(wholeShapeInfo);

  if (dimsSize == rank ||
      dimsSize == 0) {  // means there is one sub-array and it coincides with
                        // whole array, return copy of wholeShapeInfo and one
                        // zero offset in this case
    memcpy(subArrShapeInfo, wholeShapeInfo,
           shape::shapeInfoLength(rank) * sizeof(Nd4jLong));
    *subArrOffsets = 0;
    return;
  }
...
INLINEDEF void calcSubArrShapeInfoAndOffset(
    const Nd4jLong *idx, const Nd4jLong *maxShapeInfo, Nd4jLong *minShapeInfo,
    Nd4jLong &minOffset, const bool keepUnitiesInShape, const bool isStrided,
  ...
  minShapeInfo[0] =
      keepUnitiesInShape ? maxRank : maxRank - numOfUntiesInMinShape;
  ...
  for (uint step = 0, j = 0, i = 0; i < maxRank; ++i, step += n) {
    if (idx[step] == idx[step + 1]) {  // means whole dimension
      ...
      first = idx[step] >= 0 ? idx[step]
                             : idx[step] + shape::sizeAt(maxShapeInfo, i) + 1;
      last = idx[step + 1] >= 0
                 ? idx[step + 1]
                 : idx[step + 1] + shape::sizeAt(maxShapeInfo, i) + 1;

      if (last < first)
        throw(
            "shape::calcSubArrShapeInfoAndOffset: negative range in input "
            "indexes is found!");

      if (isStrided) {
        stride = idx[step + 2];
        last /*resulting sub-array axis*/ =
            (last - first + stride - 1) /
            stride;  // ceil (last - first) / stride;
      } else {
        stride = 1;
      ...
      shape::stride(minShapeInfo)[j++] =
          last == 1 ? shape::stride(maxShapeInfo)[i]
                    : shape::stride(maxShapeInfo)[i] * stride;
    }
  }

  minShapeInfo[2 * shape::rank(minShapeInfo) + 3] =
      shape::order(maxShapeInfo);                              // order
...
//////////////////////////////////////////////////////////////////////
INLINEDEF void _CUDA_HD index2coords(Nd4jLong index, const Nd4jLong *shapeInfo,
                                     Nd4jLong *coords) {
  for (uint i = shapeInfo[0]; i > 1; --i) {
...
//////////////////////////////////////////////////////////////////////
INLINEDEF void _CUDA_HD index2coords(Nd4jLong index, const int rank,
                                     const Nd4jLong *shape, Nd4jLong *coords) {
...
//////////////////////////////////////////////////////////////////////
INLINEDEF _CUDA_HD void index2coords(Nd4jLong index, const Nd4jLong *shapeInfo,
                                     int *coords, const int dimsSize,
                                     const int *tadDims) {
...
//////////////////////////////////////////////////////////////////////
INLINEDEF _CUDA_HD void index2coordsCPU(const Nd4jLong &startIndex,
                                        const Nd4jLong &index,
                                        const Nd4jLong *shapeInfo,
                                        Nd4jLong *coords) {
  if (startIndex == index) {
...
//////////////////////////////////////////////////////////////////////
// INLINEDEF _CUDA_HD void calcOffsets(const Nd4jLong *xShapeInfo, Nd4jLong*&
// xOffsets, const Nd4jLong *yShapeInfo, Nd4jLong*& yOffsets, const Nd4jLong*
// zShapeInfo, Nd4jLong*& zOffsets, const char order) {
...
//     if (xEws == 1 && yEws == 1 && zEws == 1 && xOrder == yOrder && xOrder ==
//     zOrder && (xOrder == 'c' || shapesSame)) {
//         xOffsets = yOffsets = zOffsets = nullptr;
//     }
//     else if(xEws == 1 && yEws == 1 && xOrder == yOrder && (xOrder == 'c' ||
//     shape::shapeEquals(xShapeInfo, yShapeInfo))) {
//         xOffsets = yOffsets = nullptr;
//         zOffsets = new Nd4jLong[len];
//         shape::calcOffsets(zShapeInfo, zOffsets, xOrder);
//     }
//     else if(xEws == 1 && zEws == 1 && xOrder == zOrder && (xOrder == 'c' ||
//     shape::shapeEquals(xShapeInfo, zShapeInfo))) {
//         xOffsets = zOffsets = nullptr;
//         yOffsets = new Nd4jLong[len];
//         shape::calcOffsets(yShapeInfo, yOffsets, xOrder);
//     }
//     else if(yEws == 1 && zEws == 1 && yOrder == zOrder && (yOrder == 'c' ||
//     shape::shapeEquals(yShapeInfo, zShapeInfo))) {
...
//////////////////////////////////////////////////////////////////////
// INLINEDEF _CUDA_HD void calcOffsets(const Nd4jLong *xShapeInfo, Nd4jLong*&
// xOffsets, const Nd4jLong *yShapeInfo, Nd4jLong*& yOffsets, const char order)
// {
...
//     if (xEws == 1 && yEws == 1 && xOrder == yOrder && (xOrder == 'c' ||
//     shapesSame)) {
//         xOffsets = yOffsets = nullptr;
//     }
//     else if(xEws == 1) {
...
//////////////////////////////////////////////////////////////////////
INLINEDEF _CUDA_HD int excludeUnitiesFromShapeInfo(
    const Nd4jLong *inShapeInfo, Nd4jLong *&shapeNoUnities,
    Nd4jLong *&stridesNoUnities) {
  const int rank = shape::rank(inShapeInfo);
  const int numOfNonUnities =
      shape::numOfNonUnitDims(rank, shape::shapeOf(inShapeInfo));
