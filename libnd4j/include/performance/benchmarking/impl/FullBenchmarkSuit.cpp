...
static std::string maxPool3DBenchmark() {
  ...
  auto generator = PARAMETRIC_D() {
    ...
    if (format == 1) {
      // NDHWC
      ctx->setInputArray(
          0, NDArrayFactory::create<float>('c', {mb, dhw, dhw, dhw, chIn}));
      ctx->setOutputArray(
          0, NDArrayFactory::create<float>('c', {mb, dhw, dhw, dhw, chIn}));
    } else {
      // NCDHW
      ctx->setInputArray(
          0, NDArrayFactory::create<float>('c', {mb, chIn, dhw, dhw, dhw}));
      ctx->setOutputArray(
          0, NDArrayFactory::create<float>('c', {mb, chIn, dhw, dhw, dhw}));
    }
...
static std::string conv3dBenchmark() {
  ...
  auto generator = PARAMETRIC_D() {
    ...
    // Weights and bias:
    ctx->setInputArray(
        1, NDArrayFactory::create<float>('c', {3, 3, 3, chIn, chOut}));
...
static std::string lstmBenchmark() {
  ...
  BoolParameters format(
      "format");  // 0=TNS=[seqLen,mb,size]; 1=NST=[mb,size,seqLen]
#ifdef _RELEASE
  ...
  auto generator = PARAMETRIC_D() {
    ...
    Nd4jLong l = 0;
    ctx->setInputArray(
        0, NDArrayFactory::create<Nd4jLong>(l));  // Max TS length (unused)

    if (f == 0) {
      // TNS format
      ctx->setInputArray(
          1, NDArrayFactory::create<float>('c', {seqLength, m, n}));  // x
      ctx->setOutputArray(
          0, NDArrayFactory::create<float>('c', {seqLength, m, n}));  // i
      ctx->setOutputArray(
          1, NDArrayFactory::create<float>('c', {seqLength, m, n}));  // c
      ctx->setOutputArray(
          2, NDArrayFactory::create<float>('c', {seqLength, m, n}));  // f
      ctx->setOutputArray(
          3, NDArrayFactory::create<float>('c', {seqLength, m, n}));  // o
      ctx->setOutputArray(
          4, NDArrayFactory::create<float>('c', {seqLength, m, n}));  // z
      ctx->setOutputArray(
          5, NDArrayFactory::create<float>('c', {seqLength, m, n}));  // h
      ctx->setOutputArray(
          6, NDArrayFactory::create<float>('c', {seqLength, m, n}));  // y
    } else {
      // NST format
      ctx->setInputArray(
          1, NDArrayFactory::create<float>('f', {m, n, seqLength}));  // x
      ctx->setOutputArray(
          0, NDArrayFactory::create<float>('f', {m, n, seqLength}));  // i
      ctx->setOutputArray(
          1, NDArrayFactory::create<float>('f', {m, n, seqLength}));  // c
      ctx->setOutputArray(
          2, NDArrayFactory::create<float>('f', {m, n, seqLength}));  // f
      ctx->setOutputArray(
          3, NDArrayFactory::create<float>('f', {m, n, seqLength}));  // o
      ctx->setOutputArray(
          4, NDArrayFactory::create<float>('f', {m, n, seqLength}));  // z
      ctx->setOutputArray(
          5, NDArrayFactory::create<float>('f', {m, n, seqLength}));  // h
      ctx->setOutputArray(
          6, NDArrayFactory::create<float>('f', {m, n, seqLength}));  // y
    }

    auto cLast = NDArrayFactory::create<float>('c', {m, n});
    auto yLast = NDArrayFactory::create<float>('c', {m, n});
    auto W = NDArrayFactory::create<float>('c', {2 * n, 4 * n});
    auto Wci = NDArrayFactory::create<float>('c', {n});
    auto Wcf = NDArrayFactory::create<float>('c', {n});
...
static std::string batchnormBenchmark() {
  ...
  output += helper.runOperationSuit(&benchmark, generator, batch,
                                    "Batch Normalization");
...
static std::string pool2dBenchmark() {
  ...
  auto generator = PARAMETRIC_D() {
    ...
    if (n == 0) {
      auto input =
          NDArrayFactory::create<float>('c', {32, p.getIntParam("c"), hw, hw});
      auto output =
          NDArrayFactory::create<float>('c', {32, p.getIntParam("c"), hw, hw});
      ctx->setInputArray(0, input);
      ctx->setOutputArray(0, output);
      ...
      auto input =
          NDArrayFactory::create<float>('c', {32, hw, hw, p.getIntParam("c")});
      auto output =
          NDArrayFactory::create<float>('c', {32, hw, hw, p.getIntParam("c")});
      ctx->setInputArray(0, input);
      ctx->setOutputArray(0, output);
  ...
  output += helper.runOperationSuit(&benchmark1, generator, batch,
                                    "Average Pooling 2d Operation");

  sd::ops::maxpool2d maxpool2d;
  DeclarableBenchmark benchmark2(maxpool2d, "maxpool");
  output += helper.runOperationSuit(&benchmark2, generator, batch,
...
static std::string conv2dBenchmark() {
  ...
  auto generator = PARAMETRIC_D() {
    ...
    auto b = NDArrayFactory::create<float>('c', {p.getIntParam("c")});
    auto w = NDArrayFactory::create<float>(
        'c', {khw, khw, p.getIntParam("c"),
...
static std::string rngBenchmark() {
  ...
  IntPowerParameters length("length", 2, 4, scalarBenchmarkPowLimit,
                            3);  // 2^8 to 2^30 in steps of 3
  ...
  auto gen01 = PARAMETRIC_D() {
    auto ctx = new Context(1);
    ctx->setInputArray(
        0, NDArrayFactory::create<Nd4jLong>(
               'c', {2}, {1, p.getIntParam("length")}));  // Shape as NDArray
    ctx->setOutputArray(
        0, NDArrayFactory::create<float>('c', {1, p.getIntParam("length")}));
    auto d = new double[2];
    d[0] = 0.0;
    d[1] = 1.0;
  ...
  output += helper.runOperationSuit(&dbTU, gen01, batch,
...
static std::string gemmIrregularBenchmark() {
  ...
  // Basically the same as above, but with irregular shapes (not multiples of 8,
  // etc)
  ...
  for (int tA = 0; tA <= tAMax; tA++) {
    for (int tB = 0; tB <= tBMax; tB++) {
      ...
      auto generator = PARAMETRIC_XYZ() {
        ...
        auto A = NDArrayFactory::create<float>('c', shapeA);
        auto B = NDArrayFactory::create<float>('c', shapeB);
        auto C = NDArrayFactory::create<float>('f', {a, c});
...
static std::string batchGemmBenchmark() {
  ...
  auto generator = PARAMETRIC_D() {
    ...
    if (rank == 3) {
      ctx->setInputArray(0,
                         NDArrayFactory::create<float>('c', {32, 1024, 1024}));
      ctx->setInputArray(1,
                         NDArrayFactory::create<float>('c', {32, 1024, 1024}));
      ctx->setOutputArray(0,
                          NDArrayFactory::create<float>('c', {32, 1024, 1024}));
    } else {
      ctx->setInputArray(
          0, NDArrayFactory::create<float>('c', {4, 8, 1024, 1024}));
      ctx->setInputArray(
          1, NDArrayFactory::create<float>('c', {4, 8, 1024, 1024}));
      ctx->setOutputArray(
          0, NDArrayFactory::create<float>('c', {4, 8, 1024, 1024}));
    }
  ...
  for (int o = 0; o <= 1; o++) {
    ...
    for (int tA = 0; tA <= 1; tA++) {
      for (int tB = 0; tB <= 1; tB++) {
        IntPowerParameters pa("sz", 2, 7, gemmRegularUpperPow,
                              2);  // 2^7=128, 2^9=512, 2^11=2048

        ParametersBatch b({&pa});

        auto generator = PARAMETRIC_XYZ() {
          auto s = p.getIntParam("sz");
          auto A = NDArrayFactory::create<float>('c', {s, s});
          auto B = NDArrayFactory::create<float>('c', {s, s});
          auto C = NDArrayFactory::create<float>(resultOrder, {s, s});
        ...
        MatrixBenchmark mb(1.0, 0.0, tA == 0 ? false : true,
                           tB == 0 ? false : true, n);
...
static std::string scatterOpBenchmark() {
  ...
  IntPowerParameters length("length", 2, 10, gatherOpPowLimit,
                            4);  // 2^10 to 2^26 in steps of 4
  ParametersBatch batch({&length});
  ...
  auto generator = PARAMETRIC_D() {
    ...
    auto in = NDArrayFactory::create<float>('c', {length});
    auto indices = NDArrayFactory::create<int>('c', {length});
    auto updates = NDArrayFactory::create<float>('c', {length});
  ...
  IntPowerParameters rows("rows", 2, 8, gatherOpPowLimit2,
                          4);  // 2^10 to 2^16 in steps of 2: 2^10, ..., 2^20
  ...
  auto generator2 = PARAMETRIC_D() {
    ...
    auto in = NDArrayFactory::create<float>('c', {rows, cols});
    auto indices = NDArrayFactory::create<int>('c', {rows});
    auto updates = NDArrayFactory::create<float>('c', {rows, cols});
  ...
  auto generator3 = PARAMETRIC_D() {
    ...
    auto in = NDArrayFactory::create<float>('c', {sz0, sz1, 512 / sz1});
    auto indices = NDArrayFactory::create<int>('c', {sz0});
    auto updates = NDArrayFactory::create<float>('c', {sz0, sz1, 512 / sz1});
...
static std::string gatherOpBenchmark() {
  ...
  auto generator = PARAMETRIC_D() {
    ...
    ctx->setInputArray(0, in);
    ctx->setInputArray(1, indices);
    ctx->setOutputArray(0, NDArrayFactory::create<float>('c', {length}));
    return ctx;
  };
  ...
  IntPowerParameters rows("rows", 2, 8, gatherOpPowLimit2,
                          4);  // 2^10 to 2^20 in steps of 2: 2^10, ..., 2^20
  PredefinedParameters cols("cols", {32});
  ParametersBatch batch2({&rows, &cols});
  ...
  auto generator2 = PARAMETRIC_D() {
    ...
    ctx->setInputArray(0, in);
    ctx->setInputArray(1, indices);
    ctx->setOutputArray(0, NDArrayFactory::create<float>('c', {rows, cols}));
    return ctx;
  };
  ...
  // Gather 3D tests - 3d input, 1d indices -> 3d output
  IntPowerParameters sz0("sz0", 2, 8, gatherOpPowLimit3,
                         4);  // 2^8 to 2^16 in steps of 4
  PredefinedParameters sz1("sz1", {32});
  ParametersBatch batch3({&sz0, &sz1});
  ...
  auto generator3 = PARAMETRIC_D() {
    ...
    ctx->setInputArray(1, indices);
    ctx->setOutputArray(
        0, NDArrayFactory::create<float>('c', {sz0, sz1, 512 / sz1}));
    return ctx;
  };
...
static std::string mismatchedOrdersAssignBenchmark() {
  ...
  IntPowerParameters rows(
      "rows", 2, 2, mismatchedAssignPowLimit,
      4);  // 2^2 to 2^26 in steps of 2 - 2^1=2, ..., 2^26=67108864
  ...
  auto generator2 = PARAMETRIC_XZ() {
    ...
    if (nchw) {
      auto orig = NDArrayFactory::create<float>('c', {16, 32, 64, 64});
      orig.permutei({0, 2, 3, 1});
      x.push_back(orig);
      z.push_back(NDArrayFactory::create<float>('c', {16, 64, 64, 32}));
    } else {
      auto orig = NDArrayFactory::create<float>('c', {16, 64, 64, 32});
      orig.permutei({0, 3, 1, 2});
      x.push_back(orig);
      z.push_back(NDArrayFactory::create<float>('c', {16, 32, 64, 64}));
    }
  };

  TransformBenchmark tb2(transform::AnyOps::Assign, "assign_nchw");
  output += helper.runOperationSuit(&tb2, generator2, batch2,
                                    "nchw->nhwc and nhwc->nchw Assign");
  return output;
}
...
static std::string broadcastOpsMatrixBenchmark() {
  ...
  for (int rank = 3; rank <= broadcastMatrixRankLimit; rank++) {
    ...
    auto generator = PARAMETRIC_D() {
      ...
      auto ctx = new Context(1);
      ctx->setInputArray(0, NDArrayFactory::create<float>('c', shape));
      ctx->setInputArray(1, NDArrayFactory::create<float>('c', toBcShape));
      ctx->setOutputArray(0, NDArrayFactory::create<float>('c', shape));
      return ctx;
    };
...
static std::string broadcast2dBenchmark() {
  ...
  auto generator = PARAMETRIC_D() {
    ...
    auto arr = NDArrayFactory::create<float>(
        'c', {p.getIntParam("rows"), p.getIntParam("cols")});

    auto ctx = new Context(1);
    ctx->setInputArray(0, arr);
    if (a == 0) {
      ctx->setInputArray(
          1, NDArrayFactory::create<float>('c', {p.getIntParam("rows"), 1}));
    } else {
      ctx->setInputArray(
          1, NDArrayFactory::create<float>('c', {1, p.getIntParam("cols")}));
    }
...
static std::string broadcastBenchmark() {
  ...
  for (int axis = 0; axis <= 1; axis++) {
    PredefinedParameters rows("rows", {65536});
    IntPowerParameters cols(
        "cols", 2, 2, limit10,
        4);  // 2^1 to 2^10 in steps of 2 - 2^1=2, ..., 2^10=1024
    BoolParameters inplace("inplace");
    ...
    auto generator = PARAMETRIC_XYZ() {
      ...
      if (axis == 0) {
        y.push_back(
            NDArrayFactory::create<float>('c', {p.getIntParam("rows")}));
      } else {
        y.push_back(
            NDArrayFactory::create<float>('c', {p.getIntParam("cols")}));
      }
      if (p.getIntParam("inplace") == 1) {
        z.push_back(arr);
      } else {
        z.push_back(NDArrayFactory::create<float>(
            'c', {p.getIntParam("rows"), p.getIntParam("cols")}));
      }
    };
    ...
    output += helper.runOperationSuit(&bAdd, generator, batch,
                                      "Broadcast Add - Rank 2");
  }
  ...
  for (int rank = 3; rank <= 5; rank++) {
    for (int axis = 1; axis < rank; axis++) {
      ...
      auto generator = PARAMETRIC_XYZ() {
        auto arr = NDArrayFactory::create<float>('c', shape);
        x.push_back(arr);
        y.push_back(NDArrayFactory::create<float>('c', {vectorLength}));
        z.push_back(arr);
      };

      std::string name("bArr-r");
      name += std::to_string(rank);
      name += "a";
      name += std::to_string(axis);
      BroadcastBenchmark bAdd(broadcast::Add, name, {axis});
      std::string n2("Broadcast Add - Rank");
      n2 += std::to_string(rank);
      n2 += " - axis=";
      n2 += std::to_string(axis);
...
static std::string fastStridedReductionNonEws() {
  ...
  auto generator1 = PARAMETRIC_XYZ() {
    ...
    if (stride == 1) {
      ...
      IndicesList indices(
          {NDIndex::interval(0, 131072), NDIndex::interval(0, 1)});
    ...
    x.push_back(strided);
    y.push_back(NDArray());
    z.push_back(NDArrayFactory::create<float>(0.0f));
  };

  ReductionBenchmark rbSum(reduce::SameOps::Sum, "stridedSum");
  output += helper.runOperationSuit(
      &rbSum,
      (const std::function<void(Parameters &, ResultSet &, ResultSet &,
                                ResultSet &)>)(generator1),
      batch, "Strided Sum - No EWS Test 1");

  // No EWS defined for this case
  auto generator2 = PARAMETRIC_XYZ() {
    auto stride = p.getIntParam("stride");
    auto arr = NDArrayFactory::create<float>(
        'c', {(stride == 1 ? 1 : 2) * 1024, 1024, stride});

    NDArray strided;
    if (stride == 1) {
      strided = arr;
    } else {
      IndicesList indices({NDIndex::interval(0, 2 * 1024, 2), NDIndex::all(),
                           NDIndex::interval(0, 1)});
  ...
  output += helper.runOperationSuit(
      &rbSum2,
      (const std::function<void(Parameters &, ResultSet &, ResultSet &,
                                ResultSet &)>)(generator2),
      batch, "Strided Sum - No EWS Test 2");
...
static std::string fastStridedReductionIrregular() {
  ...
  IntPowerParameters length("length", 2, 12, stridedReductionPowLimit,
                            4);  // 2^12 to 2^20 in steps of 4
  PredefinedParameters stride(
      "stride",
  ...
  auto generator = PARAMETRIC_XYZ() {
    auto stride = p.getIntParam("stride");
    auto arr =
        NDArrayFactory::create<float>('c', {p.getIntParam("length"), stride});
  ...
  output += helper.runOperationSuit(
      ...
      (const std::function<void(Parameters &, ResultSet &, ResultSet &,
                                ResultSet &)>)(generator),
      batch, "Strided Sum - Irregular Strides");
...
static std::string fastStridedReductionsRegular() {
  ...
  auto generator = PARAMETRIC_XYZ() {
    ...
    y.push_back(NDArray());
    //            z.push_back(NDArrayFactory::create<float>(0.0f));
    z.push_back(NDArrayFactory::create<float>('c', {1}));
  };
  ...
  output += helper.runOperationSuit(
      ...
      (const std::function<void(Parameters &, ResultSet &, ResultSet &,
                                ResultSet &)>)(generator),
      batch, "Strided Sum - Regular Strides (powers of 2)");
  ...
  output +=
      helper.runOperationSuit(&dbArgmax, generator3, batch, "Strided Argmax");
  return output;
}
...
static std::string fastReduceAlongDimBenchmark() {
  ...
  for (int i = 0; i < limit3; i++) {
    ...
    auto generator = PARAMETRIC_XYZ() {
      ...
      auto arr = NDArrayFactory::create<float>('c', {rows, cols});
      ...
      NDArray result;
      if (dim == 0) {
        result = NDArrayFactory::create<float>('c', {cols});
      } else {
        result = NDArrayFactory::create<float>('c', {rows});
      }
      z.push_back(result);
    };
...
static std::string fastReduceToScalarBenchmark() {
  ...
  IntPowerParameters length("length", 2, 10, reduceScalarPowLimit,
                            4);  // 2^10 to 2^26 in steps of 4

  ParametersBatch batch({&length});

  auto generator = PARAMETRIC_XYZ() {
    auto arr = NDArrayFactory::create<float>('c', {p.getIntParam("length")});
  ...
  output += helper.runOperationSuit(
      ...
      (const std::function<void(Parameters &, ResultSet &, ResultSet &,
                                ResultSet &)>)(generator),
      batch, "Sum - Full Array Reduction");
  ...
  auto generator3 = PARAMETRIC_D() {
    ...
    ctx->setInputArray(
        0, NDArrayFactory::create<float>('c', {p.getIntParam("length")}));
    ctx->setInputArray(1, NDArrayFactory::create<Nd4jLong>((Nd4jLong)0));
    ctx->setOutputArray(0, NDArrayFactory::create<Nd4jLong>(0));

    return ctx;
  };
  output += helper.runOperationSuit(&dbArgmax, generator3, batch,
                                    "Argmax Full Array Reduction");
...
static std::string fastNonEwsTransformBenchmark() {
  std::string output;
  BenchmarkHelper helper(wIterations, rIterations);
  IntPowerParameters rowcol("rowcol", 2, 2, nonEwsPowLimit,
                            4);  // 2^2 to 2^14 in steps of 4 -> non-inplace
                                 // case: 2x 2^10 x 2^10 = 128mb
  BoolParameters inplace("inplace");
  ...
  auto generator = PARAMETRIC_XZ() {
    ...
    auto arr = NDArrayFactory::create<float>('c', {r, r + 1});
    IndicesList indices({NDIndex::all(), NDIndex::interval(0, r - 1)});
    auto view = arr.subarray(indices);
    // nd4j_printf("VIEW ARRAY: rows=%lld, columns=%lld", view->sizeAt(0),
    // view->sizeAt(1));
    x.push_back(view);
    if (p.getIntParam("inplace") == 1) {
      z.push_back(view);
      ...
      z.push_back(
          NDArrayFactory::create<float>('c', {view.sizeAt(0), view.sizeAt(1)}));
    }
  };

  ScalarBenchmark sbLRelu(scalar::Ops::LeakyRELU, "LeakyRELU_View");
  sbLRelu.setY(NDArrayFactory::create<float>(0.0));
...
static std::string fastPairwiseBenchmark() {
  std::string output;
  BenchmarkHelper helper(wIterations, rIterations);
  IntPowerParameters length("length", 2, 10, pairwisePowLimit,
                            4);  // 2^10 to 2^26 in steps of 4 -> max is 512mb
  BoolParameters inplace("inplace");

  ParametersBatch batch({&length, &inplace});

  auto generator = PARAMETRIC_XYZ() {
    auto arr1 = NDArrayFactory::create<float>('c', {p.getIntParam("length")});
    auto arr2 = NDArrayFactory::create<float>('c', {p.getIntParam("length")});
    x.push_back(arr1);
    y.push_back(arr2);
    if (p.getIntParam("inplace") == 1) {
      z.push_back(arr1);
      ...
      z.push_back(
          NDArrayFactory::create<float>('c', {p.getIntParam("length")}));
    }
  };
...
static std::string heavyTransformsBenchmark() {
  std::string output;
  BenchmarkHelper helper(wIterations, rIterations);
  IntPowerParameters length("length", 2, 10, heavyPowLimit,
                            4);  // 2^10 to 2^22, steps of 4
  BoolParameters inplace("inplace");
  ...
  auto generator2 = PARAMETRIC_D() {
    auto ctx = new Context(1);
    auto in0 = NDArrayFactory::create<float>('c', {p.getIntParam("length")});
    in0.assign(0.25);
    auto in1 = NDArrayFactory::create<float>('c', {p.getIntParam("length")});
    in1.assign(0.5);
  ...
  IntPowerParameters lengthBetaInc("length", 2, 10, heavyPowLimit,
                                   4);  // 2^10 to 2^22 in steps of 4
  ...
  auto generator3 = PARAMETRIC_D() {
    ...
    auto in1 = NDArrayFactory::create<float>('c', {p.getIntParam("length")});
    in1.assign(0.5);
    auto in2 = NDArrayFactory::create<float>('c', {p.getIntParam("length")});
    in2.assign(0.75);
    ctx->setInputArray(0, in0);
    ctx->setInputArray(1, in1);
  ...
  output += helper.runOperationSuit(&binc, generator3, batch3,
                                    "Incomplete Beta Function (BetaInc)");
...
static std::string intermediateTransformsBenchmark() {
  ...
  BenchmarkHelper helper(wIterations, rIterations);
  IntPowerParameters length("length", 2, 10, intermediateTransformPowLimit,
                            4);  // 2^20 to 2^22 in steps of 4
  BoolParameters inplace("inplace");
  ...
  // output += helper.runOperationSuit(&tbSoftmax, generator2, batch2,
  // "Softmax");
...
static std::string fastTransformsBenchmark() {
  std::string output;
  BenchmarkHelper helper(wIterations, rIterations);
  IntPowerParameters length(
      "length", 2, 10, transformBenchmarkPowLimit,
      4);  // 2^10 to 2^30 in steps of 4 - 2^10, 2^14, ..., 2^26
  BoolParameters inplace("inplace");
...
static std::string fastScalarBenchmark() {
  ...
  IntPowerParameters length(
      "length", 2, 10, scalarBenchmarkPowLimit,
      4);  // 2^10 to 2^30 in steps of 4 - 2^10, 2^14, ..., 2^26
  BoolParameters inplace("inplace");
  ...
  sbAdd.setY(NDArrayFactory::create<float>(3.14159265359));
  sbDiv.setY(NDArrayFactory::create<float>(3.14159265359));
  sbPow.setY(NDArrayFactory::create<float>(3.14159265359));

  output += helper.runOperationSuit(
      &sbAdd, generator, batch, "Scalar Addition - x.add(3.14159265359) - F32");
  output += helper.runOperationSuit(
      &sbDiv, generator, batch, "Scalar Division - x.div(3.14159265359) - F32");
  output += helper.runOperationSuit(
      &sbPow, generator, batch, "Scalar Power - x.pow(3.14159265359) - F32");
...
static long duration(long start) { return nowMs() - start; }
