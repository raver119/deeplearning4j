...
math_def inline float copysignfk(float x, float y) {
  return intBitsToFloat((floatToRawIntBits(x) & ~(1 << 31)) ^
                        (floatToRawIntBits(y) & (1 << 31)));
}
...
/*
        template<>
        math_def inline float16 nd4j_dot<float16>(float16 *x, float16 *y, int
   length) { float16 dot = (float16) 0.0f;

            // TODO: since we can't use simd on unions, we might use something
   else here. for(int e = 0; e < length; e++) { dot += x[e] * y[e];
            }
...
math_def inline Z nd4j_asinh(T val) {
  ...
  return nd4j_log<Z, Z>(nd4j_sqrt<Z, Z>(nd4j_pow<T, T, Z>(val, (T)2) + (Z)1.f) +
                        (Z)val);
}
...
math_def inline bool nd4j_isinf<bfloat16>(bfloat16 value) {
  return value < (bfloat16)-BFLOAT16_MAX_VALUE ||
         value > (bfloat16)BFLOAT16_MAX_VALUE;
}
...
math_def inline bool nd4j_eq(T d1, T d2, double eps) {
  ...
  if (diff <= sd::math::nd4j_max<double>(
                  sd::math::nd4j_abs<double>(static_cast<double>(d1)),
                  sd::math::nd4j_abs<double>(static_cast<double>(d2))) *
                  eps)
    return true;
...
/**
 * This func is special case - it must return floating point value, and
 * optionally Y arg can be floating point argument
 * @tparam X
 * @tparam Y
 * @tparam Z
 * @param val
...
math_def inline Z nd4j_lgamma(X x) {
  ...
  //            {
  //                std::stringstream os;
  //                os << "Logarithm of Gamma has sence only for positive
  //                values, but " << x <<  " was given."; throw
  ...
  return Z((double(x) - 0.5) * nd4j_log<X, double>(x) - double(x) +
           halfLogTwoPi + series);
}
...
math_def inline Z nd4j_gamma(X a) {
  ...
  // So in this range, 1/Gamma(a) = a + gamma a^2 with error on the order of
  // a^3. The relative error over this interval is less than 6e-7.

  const double eulerGamma =
      0.577215664901532860606512090;  // Euler's gamma constant
...
template <>
inline __device__ int32_t nd4j_atomicMin<int32_t>(int32_t* address,
                                                  int32_t val) {
  return atomicMin(address, val);
}

template <>
inline __device__ uint32_t nd4j_atomicMin<uint32_t>(uint32_t* address,
                                                    uint32_t val) {
  return atomicMin(address, val);
}
template <>
  ...
  do {
    ...
    old =
        atomicCAS(address_as_ull, assumed,
                  __float_as_int(math::nd4j_min(val, __int_as_float(assumed))));
  } while (assumed != old);
  ...
  do {
    ...
    old = atomicCAS(address_as_ull, assumed,
                    __double_as_longlong(
                        math::nd4j_min(val, __longlong_as_double(assumed))));
  } while (assumed != old);
  return __longlong_as_double(old);
}
template <>
inline __device__ uint64_t nd4j_atomicMin<uint64_t>(uint64_t* address,
                                                    uint64_t val) {
  ...
  do {
    assumed = old;
    old = atomicCAS(address_as_ull, assumed,
                    math::nd4j_min((unsigned long long)val, assumed));
  } while (assumed != old);
  return old;
#endif
}
template <>
inline __device__ Nd4jLong nd4j_atomicMin<Nd4jLong>(Nd4jLong* address,
                                                    Nd4jLong val) {
#if __CUDA_ARCH__ >= 350
  return atomicMin((unsigned long long*)address, (unsigned long long)val);
#else
  ...
  do {
    assumed = old;
    old = atomicCAS(address_as_ull, assumed,
                    math::nd4j_min(val, (Nd4jLong)assumed));
  } while (assumed != old);
  return old;
#endif
}
template <>
inline __device__ int16_t nd4j_atomicMin<int16_t>(int16_t* address,
                                                  int16_t val) {
...
template <>
inline __device__ bfloat16 nd4j_atomicMin<bfloat16>(bfloat16* address,
                                                    bfloat16 val) {
  return bfloat16(nd4j_atomicMin<int16_t>(&address->_data, val._data));
}
template <>
inline __device__ float16 nd4j_atomicMin<float16>(float16* address,
                                                  float16 val) {
  return float16(nd4j_atomicMin<int16_t>(
      reinterpret_cast<int16_t*>(&address->data), (int16_t)val.data));
}
template <>
inline __device__ int32_t nd4j_atomicMax<int32_t>(int32_t* address,
                                                  int32_t val) {
  return atomicMax(address, val);
}

template <>
inline __device__ uint32_t nd4j_atomicMax<uint32_t>(uint32_t* address,
                                                    uint32_t val) {
  return atomicMax(address, val);
}
...
inline __device__ double nd4j_atomicMax<double>(double* address, double val) {
  ...
  do {
    ...
    old = atomicCAS(address_as_ull, assumed,
                    __double_as_longlong(
                        math::nd4j_max(val, __longlong_as_double(assumed))));
  } while (assumed != old);
  return __longlong_as_double(old);
}
template <>
inline __device__ float nd4j_atomicMax<float>(float* address, float val) {
  ...
  do {
    ...
    old =
        atomicCAS(address_as_ull, assumed,
                  __float_as_int(math::nd4j_max(val, __int_as_float(assumed))));
  } while (assumed != old);
  return __int_as_float(old);
}
template <>
inline __device__ uint8_t nd4j_atomicMin<uint8_t>(uint8_t* address,
                                                  uint8_t val) {
...
template <>
inline __device__ uint16_t nd4j_atomicMin<uint16_t>(uint16_t* address,
                                                    uint16_t val) {
  uint32_t temp = *address;
  *address = atomicMin(&temp, (uint32_t)val);
  return *address;
...
template <>
inline __device__ uint8_t nd4j_atomicMax<uint8_t>(uint8_t* address,
                                                  uint8_t val) {
  uint32_t temp = *address;
...
template <>
inline __device__ int16_t nd4j_atomicMax<int16_t>(int16_t* address,
                                                  int16_t val) {
  int32_t temp = *address;
...
template <>
inline __device__ float16 nd4j_atomicMax<float16>(float16* address,
                                                  float16 val) {
...
template <>
inline __device__ bfloat16 nd4j_atomicMax<bfloat16>(bfloat16* address,
                                                    bfloat16 val) {
  auto address_as_ull = (int*)address;
...
template <>
inline __device__ uint64_t nd4j_atomicMax<uint64_t>(uint64_t* address,
                                                    uint64_t val) {
#if __CUDA_ARCH__ >= 350
  ...
  do {
    assumed = old;
    old = atomicCAS(address_as_ull, assumed,
                    math::nd4j_max((unsigned long long)val, assumed));
  } while (assumed != old);
  return old;
#endif
}
...
template <>
inline __device__ Nd4jLong nd4j_atomicMax<Nd4jLong>(Nd4jLong* address,
                                                    Nd4jLong val) {
  unsigned long long int* address_as_ull = (unsigned long long int*)address;
  ...
  do {
    assumed = old;
    old = atomicCAS(address_as_ull, assumed,
                    (unsigned long long)nd4j_max(val, (Nd4jLong)assumed));
  } while (assumed != old);
  return old;
}
...
template <>
inline __device__ Nd4jLong nd4j_atomicAdd<Nd4jLong>(Nd4jLong* address,
                                                    Nd4jLong val) {
  unsigned long long int* address_as_ull = (unsigned long long int*)address;
...
template <>
inline __device__ uint32_t nd4j_atomicAdd<uint32_t>(uint32_t* address,
                                                    uint32_t val) {
  return atomicAdd(address, val);
}

template <>
inline __device__ uint64_t nd4j_atomicAdd<uint64_t>(uint64_t* address,
                                                    uint64_t val) {
  //	unsigned long long* address_as_ull = (unsigned long long int *) address;
  //
  ////	return atomicAdd(address, val);
...
template <>
inline __device__ float16 nd4j_atomicAdd<float16>(float16* address,
                                                  float16 val) {
...
template <>
inline __device__ bfloat16 nd4j_atomicAdd<bfloat16>(bfloat16* address,
                                                    bfloat16 val) {
  auto address_as_ull = (int*)address;
...
template <>
inline __device__ int16_t nd4j_atomicAdd<int16_t>(int16_t* address,
                                                  int16_t val) {
  return internal_16bit_atomicAdd<int16_t>(address, val);
}

template <>
inline __device__ uint16_t nd4j_atomicAdd<uint16_t>(uint16_t* address,
                                                    uint16_t val) {
...
template <>
inline __device__ uint8_t nd4j_atomicAdd<uint8_t>(uint8_t* address,
                                                  uint8_t val) {
  int res = *address;
  atomicAdd(&res, (int)val);
  *address = res;
...
//}
template <>
inline __device__ int32_t nd4j_atomicAdd<int32_t>(int32_t* address,
                                                  int32_t val) {
...
template <>
inline __device__ float16 nd4j_atomicSub<float16>(float16* address,
                                                  float16 val) {
  return nd4j_atomicAdd<float16>(address, -val);
}
template <>
inline __device__ bfloat16 nd4j_atomicSub<bfloat16>(bfloat16* address,
                                                    bfloat16 val) {
...
template <>
inline __device__ unsigned char nd4j_atomicMul<unsigned char>(
...
template <>
inline __device__ int16_t nd4j_atomicMul<int16_t>(int16_t* address,
                                                  int16_t val) {
  return internal_16bit_atomicMul<int16_t>(address, val);
}

template <>
inline __device__ uint16_t nd4j_atomicMul<uint16_t>(uint16_t* address,
                                                    uint16_t val) {
...
template <>
inline __device__ unsigned int nd4j_atomicMul<unsigned int>(
...
template <>
inline __device__ int64_t nd4j_atomicMul<int64_t>(int64_t* address,
                                                  int64_t val) {
...
template <>
inline __device__ uint64_t nd4j_atomicMul<uint64_t>(uint64_t* address,
                                                    uint64_t val) {
  unsigned long long int* res_address = (unsigned long long int*)address;
  unsigned long long int old = *res_address, assumed;
  do {
...
template <>
inline __device__ Nd4jLong nd4j_atomicMul<Nd4jLong>(Nd4jLong* address,
                                                    Nd4jLong val) {
...
template <>
inline __device__ bfloat16 nd4j_atomicMul<bfloat16>(bfloat16* address,
                                                    bfloat16 val) {
  return internal_16bit_atomicMul<bfloat16>(address, val);
}

template <>
inline __device__ float16 nd4j_atomicMul<float16>(float16* address,
                                                  float16 val) {
...
template <>
inline __device__ float16 nd4j_atomicDiv<float16>(float16* address,
                                                  float16 val) {
  return internal_16bit_atomicMul<float16>(address, (float16)1.f / val);
}

template <>
inline __device__ bfloat16 nd4j_atomicDiv<bfloat16>(bfloat16* address,
                                                    bfloat16 val) {
...
#pragma omp declare reduction(                                            \
    maxT                                                                  \
    : float, double, float16, bfloat16, int, Nd4jLong, Nd4jULong, int8_t, \
      uint8_t, bool, int16_t, uint16_t, uint32_t                          \
    : omp_out = sd::math::nd4j_max(omp_in, omp_out)) initializer(omp_priv = 0)

#pragma omp declare reduction(                                            \
    minT                                                                  \
    : float, double, float16, bfloat16, int, Nd4jLong, Nd4jULong, int8_t, \
      uint8_t, bool, int16_t, uint16_t, uint32_t                          \
    : omp_out = sd::math::nd4j_min(omp_in, omp_out)) initializer(omp_priv = 0)

#pragma omp declare reduction(                                            \
    amaxT                                                                 \
    : float, double, float16, bfloat16, int, Nd4jLong, Nd4jULong, int8_t, \
      uint8_t, bool, int16_t, uint16_t, uint32_t                          \
    : omp_out = sd::math::nd4j_max(sd::math::nd4j_abs(omp_in),            \
                                   sd::math::nd4j_abs(omp_out)))

#pragma omp declare reduction(                                            \
    aminT                                                                 \
    : float, double, float16, bfloat16, int, Nd4jLong, Nd4jULong, int8_t, \
      uint8_t, bool, int16_t, uint16_t, uint32_t                          \
    : omp_out = sd::math::nd4j_min(sd::math::nd4j_abs(omp_in),            \
                                   sd::math::nd4j_abs(omp_out)))
