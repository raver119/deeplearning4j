...
math_def FORCEINLINE float16 p_pow(float16 value, float16 power) {
  return static_cast<float16>(
      powf(static_cast<float>(value), static_cast<float>(power)));
}
...
math_def FORCEINLINE float16 p_fmod(float16 value, float16 power) {
  return static_cast<float16>(
      fmodf(static_cast<float>(value), static_cast<float>(power)));
}
...
math_def FORCEINLINE float16 p_atan2(float16 value, float16 power) {
  return static_cast<float16>(
      atan2f(static_cast<float>(value), static_cast<float>(power)));
}
...
math_def FORCEINLINE float16 p_remainder(float16 value, float16 power) {
  return static_cast<float16>(
      remainderf(static_cast<float>(value), static_cast<float>(power)));
}
...
math_def FORCEINLINE uint64_t _rotate_left(uint64_t value, uint64_t shift) {
  ...
  Nd4jLong val = _rotate_left<Nd4jLong>(*reinterpret_cast<Nd4jLong *>(&value),
                                        *reinterpret_cast<Nd4jLong *>(&shift));
...
#ifdef SD_ARM_BUILD
  // TODO: eventually remove this once gcc fixes the bug
  Nd4jLong val = _rotate_right<Nd4jLong>(*reinterpret_cast<Nd4jLong *>(&value),
                                         *reinterpret_cast<Nd4jLong *>(&shift));
  return *reinterpret_cast<uint64_t *>(&val);
#else
  return value >> shift | value << (64 - shift);
