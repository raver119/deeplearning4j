...
_CUDA_HD uint16::uint16() { data = cpu_float2uint16(0.0f); }
...
_CUDA_HD uint16::operator float() const { return cpu_uint162float(data); }

_CUDA_HD void uint16::assign(float rhs) { data = cpu_float2uint16(rhs); }
