...
inline const OpType (&EnumValuesOpType())[26] {
  static const OpType values[] = {
      OpType_TRANSFORM_FLOAT, OpType_TRANSFORM_SAME,
      OpType_TRANSFORM_BOOL,  OpType_TRANSFORM_STRICT,
      OpType_TRANSFORM_ANY,   OpType_REDUCE_FLOAT,
      OpType_REDUCE_SAME,     OpType_REDUCE_LONG,
      OpType_REDUCE_BOOL,     OpType_INDEX_REDUCE,
      OpType_SCALAR,          OpType_SCALAR_BOOL,
      OpType_BROADCAST,       OpType_BROADCAST_BOOL,
      OpType_PAIRWISE,        OpType_PAIRWISE_BOOL,
      OpType_REDUCE_3,        OpType_SUMMARYSTATS,
      OpType_SHAPE,           OpType_AGGREGATION,
      OpType_RANDOM,          OpType_CUSTOM,
      OpType_GRAPH,           OpType_VARIABLE,
      OpType_BOOLEAN,         OpType_LOGIC};
  return values;
}

inline const char *const *EnumNamesOpType() {
  static const char *const names[] = {"TRANSFORM_FLOAT",
                                      "TRANSFORM_SAME",
                                      "TRANSFORM_BOOL",
                                      "TRANSFORM_STRICT",
                                      "TRANSFORM_ANY",
...
inline const InputType (&EnumValuesInputType())[5] {
  static const InputType values[] = {
      InputType_UNDEFINED, InputType_NUMERIC, InputType_STRINGULAR,
      InputType_NUMERIC_SET, InputType_STRINGULAR_SET};
  return values;
}

inline const char *const *EnumNamesInputType() {
  static const char *const names[] = {"UNDEFINED",      "NUMERIC",
                                      "STRINGULAR",     "NUMERIC_SET",
                                      "STRINGULAR_SET", nullptr};
  return names;
}
...
inline const OpClass (&EnumValuesOpClass())[6] {
  static const OpClass values[] = {OpClass_TRANSFORM,     OpClass_REDUCTION,
                                   OpClass_MULTIPLICATOR, OpClass_GRAPH,
                                   OpClass_CONDITIONAL,   OpClass_LOOP};
  return values;
}

inline const char *const *EnumNamesOpClass() {
  static const char *const names[] = {
      "TRANSFORM",   "REDUCTION", "MULTIPLICATOR", "GRAPH",
      "CONDITIONAL", "LOOP",      nullptr};
  return names;
}
...
struct LongPair FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  enum { VT_FIRST = 4, VT_SECOND = 6 };
  int64_t first() const { return GetField<int64_t>(VT_FIRST, 0); }
  int64_t second() const { return GetField<int64_t>(VT_SECOND, 0); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int64_t>(verifier, VT_FIRST) &&
           VerifyField<int64_t>(verifier, VT_SECOND) && verifier.EndTable();
  }
};
...
struct LongPairBuilder {
  ...
  explicit LongPairBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
...
inline flatbuffers::Offset<LongPair> CreateLongPair(
    flatbuffers::FlatBufferBuilder &_fbb, int64_t first = 0,
    int64_t second = 0) {
...
struct LongTriple FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  enum { VT_FIRST = 4, VT_SECOND = 6, VT_THIRD = 8 };
  int64_t first() const { return GetField<int64_t>(VT_FIRST, 0); }
  int64_t second() const { return GetField<int64_t>(VT_SECOND, 0); }
  int64_t third() const { return GetField<int64_t>(VT_THIRD, 0); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int64_t>(verifier, VT_FIRST) &&
           VerifyField<int64_t>(verifier, VT_SECOND) &&
           VerifyField<int64_t>(verifier, VT_THIRD) && verifier.EndTable();
  }
};
...
inline flatbuffers::Offset<LongTriple> CreateLongTriple(
    flatbuffers::FlatBufferBuilder &_fbb, int64_t first = 0, int64_t second = 0,
    int64_t third = 0) {
...
struct IntPairBuilder {
  ...
  explicit IntPairBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
struct IntTriple FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  int32_t first() const { return GetField<int32_t>(VT_FIRST, 0); }
  int32_t second() const { return GetField<int32_t>(VT_SECOND, 0); }
  int32_t third() const { return GetField<int32_t>(VT_THIRD, 0); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_FIRST) &&
           VerifyField<int32_t>(verifier, VT_SECOND) &&
           VerifyField<int32_t>(verifier, VT_THIRD) && verifier.EndTable();
  }
};
...
struct IntTripleBuilder {
  ...
  explicit IntTripleBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<IntTriple> CreateIntTriple(
    flatbuffers::FlatBufferBuilder &_fbb, int32_t first = 0, int32_t second = 0,
    int32_t third = 0) {
