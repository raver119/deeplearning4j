...
struct FlatProperties FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<FlatArray>> *a() const {
    return GetPointer<
        const flatbuffers::Vector<flatbuffers::Offset<FlatArray>> *>(VT_A);
  }
  const flatbuffers::Vector<uint8_t> *b() const {
    return GetPointer<const flatbuffers::Vector<uint8_t> *>(VT_B);
  }
  const flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *s()
      const {
    return GetPointer<
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_NAME) &&
           verifier.VerifyString(name()) && VerifyOffset(verifier, VT_I) &&
           verifier.VerifyVector(i()) && VerifyOffset(verifier, VT_L) &&
           verifier.VerifyVector(l()) && VerifyOffset(verifier, VT_D) &&
           verifier.VerifyVector(d()) && VerifyOffset(verifier, VT_A) &&
           verifier.VerifyVector(a()) && verifier.VerifyVectorOfTables(a()) &&
           VerifyOffset(verifier, VT_B) && verifier.VerifyVector(b()) &&
           VerifyOffset(verifier, VT_S) && verifier.VerifyVector(s()) &&
...
inline flatbuffers::Offset<FlatProperties> CreateFlatProperties(
    ...
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<FlatArray>>> a =
        0,
...
inline const sd::graph::FlatProperties *GetSizePrefixedFlatProperties(
    const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<sd::graph::FlatProperties>(buf);
}

inline bool VerifyFlatPropertiesBuffer(flatbuffers::Verifier &verifier) {
