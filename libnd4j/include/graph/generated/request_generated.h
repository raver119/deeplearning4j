...
struct FlatInferenceRequest FLATBUFFERS_FINAL_CLASS
    : private flatbuffers::Table {
  enum { VT_ID = 4, VT_VARIABLES = 6, VT_CONFIGURATION = 8 };
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.VerifyTable(configuration()) && verifier.EndTable();
  }
};
...
inline flatbuffers::Offset<FlatInferenceRequest>
CreateFlatInferenceRequestDirect(
    flatbuffers::FlatBufferBuilder &_fbb, int64_t id = 0,
...
inline const sd::graph::FlatInferenceRequest *GetFlatInferenceRequest(
    const void *buf) {
  return flatbuffers::GetRoot<sd::graph::FlatInferenceRequest>(buf);
}

inline const sd::graph::FlatInferenceRequest *
GetSizePrefixedFlatInferenceRequest(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<sd::graph::FlatInferenceRequest>(buf);
}

inline bool VerifyFlatInferenceRequestBuffer(flatbuffers::Verifier &verifier) {
...
inline bool VerifySizePrefixedFlatInferenceRequestBuffer(
  ...
  return verifier.VerifySizePrefixedBuffer<sd::graph::FlatInferenceRequest>(
      nullptr);
}
