...
inline const UIEventType (&EnumValuesUIEventType())[9] {
  static const UIEventType values[] = {UIEventType_ADD_NAME,
                                       UIEventType_SCALAR,
                                       UIEventType_ARRAY,
...
inline const char *const *EnumNamesUIEventType() {
  static const char *const names[] = {"ADD_NAME",
                                      "SCALAR",
                                      "ARRAY",
                                      "ARRAY_LIST",
                                      "HISTOGRAM",
...
inline const UIEventSubtype (&EnumValuesUIEventSubtype())[10] {
  static const UIEventSubtype values[] = {
      UIEventSubtype_NONE,          UIEventSubtype_EVALUATION,
      ...
      UIEventSubtype_PREDICTION,    UIEventSubtype_USER_CUSTOM};
  return values;
}

inline const char *const *EnumNamesUIEventSubtype() {
  static const char *const names[] = {
      "NONE",          "EVALUATION",  "LOSS",      "LEARNING_RATE",
      "TUNING_METRIC", "PERFORMANCE", "PROFILING", "FEATURE_LABEL",
      "PREDICTION",    "USER_CUSTOM", nullptr};
  return names;
}
...
inline const UIHistogramType (&EnumValuesUIHistogramType())[3] {
  static const UIHistogramType values[] = {UIHistogramType_DISCRETE,
...
inline const char *const *EnumNamesUIHistogramType() {
  static const char *const names[] = {"DISCRETE", "EQUAL_SPACING", "CUSTOM",
                                      nullptr};
  return names;
}
...
struct UIEvent FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  int32_t nameIdx() const { return GetField<int32_t>(VT_NAMEIDX, 0); }
  int64_t timestamp() const { return GetField<int64_t>(VT_TIMESTAMP, 0); }
  int32_t iteration() const { return GetField<int32_t>(VT_ITERATION, 0); }
  int32_t epoch() const { return GetField<int32_t>(VT_EPOCH, 0); }
  int16_t variableId() const { return GetField<int16_t>(VT_VARIABLEID, 0); }
  const FrameIteration *frameIter() const {
    return GetPointer<const FrameIteration *>(VT_FRAMEITER);
  }
  uint16_t plugin() const { return GetField<uint16_t>(VT_PLUGIN, 0); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint16_t>(verifier, VT_PLUGIN) && verifier.EndTable();
  }
};
...
struct UIEventBuilder {
  ...
  void add_eventType(UIEventType eventType) {
    fbb_.AddElement<int8_t>(UIEvent::VT_EVENTTYPE,
                            static_cast<int8_t>(eventType), 0);
  }
  void add_eventSubType(UIEventSubtype eventSubType) {
    fbb_.AddElement<int8_t>(UIEvent::VT_EVENTSUBTYPE,
                            static_cast<int8_t>(eventSubType), 0);
  }
  ...
  explicit UIEventBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
...
inline flatbuffers::Offset<UIEvent> CreateUIEvent(
    ...
    int64_t timestamp = 0, int32_t iteration = 0, int32_t epoch = 0,
    int16_t variableId = 0, flatbuffers::Offset<FrameIteration> frameIter = 0,
    uint16_t plugin = 0) {
...
struct FrameIteration FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  enum { VT_FRAME = 4, VT_ITERATION = 6 };
  const flatbuffers::String *frame() const {
    return GetPointer<const flatbuffers::String *>(VT_FRAME);
  }
  uint16_t iteration() const { return GetField<uint16_t>(VT_ITERATION, 0); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_FRAME) &&
           verifier.VerifyString(frame()) &&
           VerifyField<uint16_t>(verifier, VT_ITERATION) && verifier.EndTable();
  }
};
...
inline flatbuffers::Offset<FrameIteration> CreateFrameIterationDirect(
    flatbuffers::FlatBufferBuilder &_fbb, const char *frame = nullptr,
    uint16_t iteration = 0) {
  return sd::graph::CreateFrameIteration(
      _fbb, frame ? _fbb.CreateString(frame) : 0, iteration);
}

struct UIAddName FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  enum { VT_NAMEIDX = 4, VT_NAME = 6 };
  int32_t nameIdx() const { return GetField<int32_t>(VT_NAMEIDX, 0); }
...
struct UIAddNameBuilder {
  ...
  explicit UIAddNameBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<UIAddName> CreateUIAddNameDirect(
  ...
  return sd::graph::CreateUIAddName(_fbb, nameIdx,
...
struct FlatArrayList FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<FlatArray>> *list() const {
    return GetPointer<
        const flatbuffers::Vector<flatbuffers::Offset<FlatArray>> *>(VT_LIST);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_LIST) &&
           verifier.VerifyVector(list()) &&
           verifier.VerifyVectorOfTables(list()) && verifier.EndTable();
  }
};
...
struct FlatArrayListBuilder {
  ...
  flatbuffers::uoffset_t start_;
  void add_list(
      flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<FlatArray>>>
          list) {
...
struct UIHistogram FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  uint32_t numbins() const { return GetField<uint32_t>(VT_NUMBINS, 0); }
  const FlatArray *binranges() const {
    return GetPointer<const FlatArray *>(VT_BINRANGES);
  }
  const FlatArray *y() const { return GetPointer<const FlatArray *>(VT_Y); }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.VerifyTable(binranges()) && VerifyOffset(verifier, VT_Y) &&
           verifier.VerifyTable(y()) && VerifyOffset(verifier, VT_BINLABELS) &&
           verifier.VerifyVector(binlabels()) &&
           verifier.VerifyVectorOfStrings(binlabels()) && verifier.EndTable();
  }
};
...
inline flatbuffers::Offset<UIHistogram> CreateUIHistogram(
    flatbuffers::FlatBufferBuilder &_fbb,
    UIHistogramType type = UIHistogramType_DISCRETE, uint32_t numbins = 0,
...
inline flatbuffers::Offset<UIHistogram> CreateUIHistogramDirect(
    ...
    flatbuffers::Offset<FlatArray> binranges = 0,
    flatbuffers::Offset<FlatArray> y = 0,
    const std::vector<flatbuffers::Offset<flatbuffers::String>> *binlabels =
        nullptr) {
  return sd::graph::CreateUIHistogram(
      _fbb, type, numbins, binranges, y,
      binlabels ? _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>>(
                      *binlabels)
                : 0);
}

struct UISummaryStatistics FLATBUFFERS_FINAL_CLASS
  ...
  uint32_t bitmask() const { return GetField<uint32_t>(VT_BITMASK, 0); }
  const FlatArray *min() const { return GetPointer<const FlatArray *>(VT_MIN); }
  const FlatArray *max() const { return GetPointer<const FlatArray *>(VT_MAX); }
  double mean() const { return GetField<double>(VT_MEAN, 0.0); }
  double stdev() const { return GetField<double>(VT_STDEV, 0.0); }
  int64_t countzero() const { return GetField<int64_t>(VT_COUNTZERO, 0); }
  ...
  int64_t countnan() const { return GetField<int64_t>(VT_COUNTNAN, 0); }
  int64_t countinf() const { return GetField<int64_t>(VT_COUNTINF, 0); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<int64_t>(verifier, VT_COUNTINF) && verifier.EndTable();
  }
};
...
struct UISummaryStatisticsBuilder {
  ...
  void add_countpositive(int64_t countpositive) {
    fbb_.AddElement<int64_t>(UISummaryStatistics::VT_COUNTPOSITIVE,
                             countpositive, 0);
  }
  void add_countnegative(int64_t countnegative) {
    fbb_.AddElement<int64_t>(UISummaryStatistics::VT_COUNTNEGATIVE,
                             countnegative, 0);
  }
...
inline flatbuffers::Offset<UISummaryStatistics> CreateUISummaryStatistics(
    flatbuffers::FlatBufferBuilder &_fbb, uint32_t bitmask = 0,
    flatbuffers::Offset<FlatArray> min = 0,
    flatbuffers::Offset<FlatArray> max = 0, double mean = 0.0,
    double stdev = 0.0, int64_t countzero = 0, int64_t countpositive = 0,
    int64_t countnegative = 0, int64_t countnan = 0, int64_t countinf = 0) {
...
struct UIHardwareState FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  enum { VT_GPUMEMORY = 4, VT_HOSTMEMORY = 6 };
  const flatbuffers::Vector<int64_t> *gpuMemory() const {
    return GetPointer<const flatbuffers::Vector<int64_t> *>(VT_GPUMEMORY);
  }
  int64_t hostMemory() const { return GetField<int64_t>(VT_HOSTMEMORY, 0); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_GPUMEMORY) &&
           verifier.VerifyVector(gpuMemory()) &&
           VerifyField<int64_t>(verifier, VT_HOSTMEMORY) && verifier.EndTable();
  }
};
...
struct UIHardwareStateBuilder {
  ...
  flatbuffers::uoffset_t start_;
  void add_gpuMemory(
      flatbuffers::Offset<flatbuffers::Vector<int64_t>> gpuMemory) {
...
inline flatbuffers::Offset<UIHardwareState> CreateUIHardwareStateDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<int64_t> *gpuMemory = nullptr, int64_t hostMemory = 0) {
  return sd::graph::CreateUIHardwareState(
      _fbb, gpuMemory ? _fbb.CreateVector<int64_t>(*gpuMemory) : 0, hostMemory);
}
