...
struct FlatNode FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  int64_t opNum() const { return GetField<int64_t>(VT_OPNUM, 0); }
  const flatbuffers::Vector<flatbuffers::Offset<FlatProperties>> *properties()
      const {
    return GetPointer<
        const flatbuffers::Vector<flatbuffers::Offset<FlatProperties>> *>(
        VT_PROPERTIES);
  }
  ...
  int32_t scope_id() const { return GetField<int32_t>(VT_SCOPE_ID, 0); }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.VerifyVector(extraTypes()) && verifier.EndTable();
  }
};
...
struct FlatNodeBuilder {
  ...
  void add_id(int32_t id) { fbb_.AddElement<int32_t>(FlatNode::VT_ID, id, 0); }
  void add_name(flatbuffers::Offset<flatbuffers::String> name) {
    fbb_.AddOffset(FlatNode::VT_NAME, name);
  }
  void add_opType(OpType opType) {
    fbb_.AddElement<int8_t>(FlatNode::VT_OPTYPE, static_cast<int8_t>(opType),
                            0);
  }
  void add_opNum(int64_t opNum) {
    fbb_.AddElement<int64_t>(FlatNode::VT_OPNUM, opNum, 0);
  }
  void add_properties(flatbuffers::Offset<
                      flatbuffers::Vector<flatbuffers::Offset<FlatProperties>>>
                          properties) {
  ...
  void add_extraParams(
      flatbuffers::Offset<flatbuffers::Vector<double>> extraParams) {
    fbb_.AddOffset(FlatNode::VT_EXTRAPARAMS, extraParams);
  }
  void add_extraInteger(
      flatbuffers::Offset<flatbuffers::Vector<int64_t>> extraInteger) {
    fbb_.AddOffset(FlatNode::VT_EXTRAINTEGER, extraInteger);
  }
  void add_extraBools(
      flatbuffers::Offset<flatbuffers::Vector<uint8_t>> extraBools) {
    fbb_.AddOffset(FlatNode::VT_EXTRABOOLS, extraBools);
  }
  void add_dimensions(
      flatbuffers::Offset<flatbuffers::Vector<int32_t>> dimensions) {
  ...
  void add_outputTypes(
      flatbuffers::Offset<flatbuffers::Vector<int8_t>> outputTypes) {
  ...
  void add_extraTypes(
      flatbuffers::Offset<flatbuffers::Vector<int8_t>> extraTypes) {
...
inline flatbuffers::Offset<FlatNode> CreateFlatNode(
    ...
    OpType opType = OpType_TRANSFORM_FLOAT, int64_t opNum = 0,
    flatbuffers::Offset<
        flatbuffers::Vector<flatbuffers::Offset<FlatProperties>>>
        properties = 0,
    ...
    int32_t device = 0, int32_t scope_id = 0,
...
inline flatbuffers::Offset<FlatNode> CreateFlatNodeDirect(
    flatbuffers::FlatBufferBuilder &_fbb, int32_t id = 0,
    const char *name = nullptr, OpType opType = OpType_TRANSFORM_FLOAT,
    int64_t opNum = 0,
    const std::vector<flatbuffers::Offset<FlatProperties>> *properties =
        nullptr,
    ...
    const std::vector<int32_t> *dimensions = nullptr, int32_t device = 0,
    int32_t scope_id = 0, const char *scope_name = nullptr,
    const std::vector<flatbuffers::Offset<flatbuffers::String>> *outputNames =
        nullptr,
    ...
    const std::vector<flatbuffers::Offset<flatbuffers::String>>
        *varControlDeps = nullptr,
    const std::vector<flatbuffers::Offset<flatbuffers::String>> *controlDepFor =
        nullptr,
    const std::vector<int8_t> *extraTypes = nullptr) {
  return sd::graph::CreateFlatNode(
      _fbb, id, name ? _fbb.CreateString(name) : 0, opType, opNum,
      properties
          ? _fbb.CreateVector<flatbuffers::Offset<FlatProperties>>(*properties)
          : 0,
      input ? _fbb.CreateVector<int32_t>(*input) : 0,
      inputPaired
          ? _fbb.CreateVector<flatbuffers::Offset<IntPair>>(*inputPaired)
          : 0,
      ...
      dimensions ? _fbb.CreateVector<int32_t>(*dimensions) : 0, device,
      scope_id, scope_name ? _fbb.CreateString(scope_name) : 0,
      outputNames ? _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>>(
                        *outputNames)
                  : 0,
      opName ? _fbb.CreateString(opName) : 0,
      outputTypes ? _fbb.CreateVector<int8_t>(*outputTypes) : 0, scalar,
...
inline bool VerifyFlatNodeBuffer(flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<sd::graph::FlatNode>(nullptr);
}

inline bool VerifySizePrefixedFlatNodeBuffer(flatbuffers::Verifier &verifier) {
