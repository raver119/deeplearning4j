...
inline const VarType (&EnumValuesVarType())[4] {
  static const VarType values[] = {VarType_VARIABLE, VarType_CONSTANT,
                                   VarType_ARRAY, VarType_PLACEHOLDER};
  return values;
}

inline const char *const *EnumNamesVarType() {
  static const char *const names[] = {"VARIABLE", "CONSTANT", "ARRAY",
                                      "PLACEHOLDER", nullptr};
  return names;
}
...
struct FlatVariableBuilder {
  ...
  void add_dtype(DType dtype) {
    fbb_.AddElement<int8_t>(FlatVariable::VT_DTYPE, static_cast<int8_t>(dtype),
                            0);
  }
  ...
  void add_variabletype(VarType variabletype) {
    fbb_.AddElement<int8_t>(FlatVariable::VT_VARIABLETYPE,
                            static_cast<int8_t>(variabletype), 0);
  }
...
inline flatbuffers::Offset<FlatVariable> CreateFlatVariable(
    ...
    flatbuffers::Offset<FlatArray> ndarray = 0, int32_t device = 0,
...
inline flatbuffers::Offset<FlatVariable> CreateFlatVariableDirect(
    flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<IntPair> id = 0,
    const char *name = nullptr, DType dtype = DType_INHERIT,
    ...
    const std::vector<flatbuffers::Offset<flatbuffers::String>>
        *controlDepForOp = nullptr,
    const std::vector<flatbuffers::Offset<flatbuffers::String>>
        *controlDepsForVar = nullptr) {
  return sd::graph::CreateFlatVariable(
      _fbb, id, name ? _fbb.CreateString(name) : 0, dtype,
      shape ? _fbb.CreateVector<int64_t>(*shape) : 0, ndarray, device,
      variabletype,
...
inline const sd::graph::FlatVariable *GetSizePrefixedFlatVariable(
    const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<sd::graph::FlatVariable>(buf);
}

inline bool VerifyFlatVariableBuffer(flatbuffers::Verifier &verifier) {
