...
inline const UIInfoType (&EnumValuesUIInfoType())[3] {
  static const UIInfoType values[] = {UIInfoType_GRAPH_STRUCTURE,
...
inline const char *const *EnumNamesUIInfoType() {
  static const char *const names[] = {"GRAPH_STRUCTURE", "SYTEM_INFO",
                                      "START_EVENTS", nullptr};
  return names;
}
...
struct UIStaticInfoRecord FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int8_t>(verifier, VT_INFOTYPE) && verifier.EndTable();
  }
};
...
struct UIStaticInfoRecordBuilder {
  ...
  void add_infoType(UIInfoType infoType) {
    fbb_.AddElement<int8_t>(UIStaticInfoRecord::VT_INFOTYPE,
                            static_cast<int8_t>(infoType), 0);
  }
...
inline flatbuffers::Offset<UISystemInfo> CreateUISystemInfo(
    flatbuffers::FlatBufferBuilder &_fbb, int32_t physicalCores = 0) {
...
struct UIGraphStructure FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *inputs()
      const {
    return GetPointer<
  ...
  const flatbuffers::Vector<flatbuffers::Offset<IntPair>> *inputsPair() const {
    return GetPointer<
        const flatbuffers::Vector<flatbuffers::Offset<IntPair>> *>(
        VT_INPUTSPAIR);
  }
  const flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *outputs()
      const {
    return GetPointer<
        const flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *>(
        VT_OUTPUTS);
  }
  const flatbuffers::Vector<flatbuffers::Offset<UIVariable>> *variables()
      const {
    return GetPointer<
        const flatbuffers::Vector<flatbuffers::Offset<UIVariable>> *>(
        VT_VARIABLES);
  }
  const flatbuffers::Vector<flatbuffers::Offset<UIOp>> *ops() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<UIOp>> *>(
        VT_OPS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_INPUTS) &&
           ...
           verifier.VerifyVectorOfTables(ops()) && verifier.EndTable();
  }
};
...
struct UIGraphStructureBuilder {
  ...
  void add_inputsPair(
      flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<IntPair>>>
          inputsPair) {
  ...
  void add_variables(
      flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<UIVariable>>>
          variables) {
    fbb_.AddOffset(UIGraphStructure::VT_VARIABLES, variables);
  }
  void add_ops(
      flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<UIOp>>> ops) {
...
inline flatbuffers::Offset<UIGraphStructure> CreateUIGraphStructureDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<flatbuffers::Offset<flatbuffers::String>> *inputs =
        nullptr,
    const std::vector<flatbuffers::Offset<IntPair>> *inputsPair = nullptr,
    const std::vector<flatbuffers::Offset<flatbuffers::String>> *outputs =
        nullptr,
  ...
  return sd::graph::CreateUIGraphStructure(
      _fbb,
      inputs
          ? _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>>(*inputs)
          : 0,
      inputsPair ? _fbb.CreateVector<flatbuffers::Offset<IntPair>>(*inputsPair)
                 : 0,
      outputs ? _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>>(
                    *outputs)
              : 0,
      variables ? _fbb.CreateVector<flatbuffers::Offset<UIVariable>>(*variables)
                : 0,
...
struct UIVariable FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const IntPair *id() const { return GetPointer<const IntPair *>(VT_ID); }
  ...
  const flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>>
      *controlDepsForOp() const {
    return GetPointer<
        const flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *>(
        VT_CONTROLDEPSFOROP);
  }
  const flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>>
      *controlDepsForVar() const {
    return GetPointer<
        const flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *>(
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_ID) &&
           verifier.VerifyTable(id()) && VerifyOffset(verifier, VT_NAME) &&
           ...
           verifier.VerifyTable(constantValue()) && verifier.EndTable();
  }
};
...
inline flatbuffers::Offset<UIVariable> CreateUIVariable(
    flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<IntPair> id = 0,
...
inline flatbuffers::Offset<UIVariable> CreateUIVariableDirect(
    flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<IntPair> id = 0,
    const char *name = nullptr, VarType type = VarType_VARIABLE,
    DType datatype = DType_INHERIT, const std::vector<int64_t> *shape = nullptr,
    const std::vector<flatbuffers::Offset<flatbuffers::String>> *controlDeps =
        nullptr,
    const char *outputOfOp = nullptr,
    const std::vector<flatbuffers::Offset<flatbuffers::String>> *inputsForOp =
        nullptr,
    const std::vector<flatbuffers::Offset<flatbuffers::String>>
        *controlDepsForOp = nullptr,
    const std::vector<flatbuffers::Offset<flatbuffers::String>>
        *controlDepsForVar = nullptr,
    const char *gradientVariable = nullptr, const char *uiLabelExtra = nullptr,
    flatbuffers::Offset<FlatArray> constantValue = 0) {
  return sd::graph::CreateUIVariable(
      _fbb, id, name ? _fbb.CreateString(name) : 0, type, datatype,
      shape ? _fbb.CreateVector<int64_t>(*shape) : 0,
      controlDeps ? _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>>(
                        *controlDeps)
                  : 0,
      outputOfOp ? _fbb.CreateString(outputOfOp) : 0,
      inputsForOp ? _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>>(
                        *inputsForOp)
                  : 0,
      controlDepsForOp
      ...
      uiLabelExtra ? _fbb.CreateString(uiLabelExtra) : 0, constantValue);
}
...
struct UIOp FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_NAME) &&
           verifier.VerifyString(name()) && VerifyOffset(verifier, VT_OPNAME) &&
           ...
           verifier.VerifyVectorOfStrings(controlDeps()) &&
           VerifyOffset(verifier, VT_UILABELEXTRA) &&
           verifier.VerifyString(uiLabelExtra()) && verifier.EndTable();
  }
};
...
struct UIOpBuilder {
  ...
  explicit UIOpBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
