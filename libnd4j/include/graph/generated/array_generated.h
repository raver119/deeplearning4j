...
inline const ByteOrder (&EnumValuesByteOrder())[2] {
  static const ByteOrder values[] = {ByteOrder_LE, ByteOrder_BE};
  return values;
}

inline const char *const *EnumNamesByteOrder() {
  static const char *const names[] = {"LE", "BE", nullptr};
  return names;
}
...
inline const DType (&EnumValuesDType())[21] {
  static const DType values[] = {
      DType_INHERIT, DType_BOOL,   DType_FLOAT8,   DType_HALF,   DType_HALF2,
      DType_FLOAT,   DType_DOUBLE, DType_INT8,     DType_INT16,  DType_INT32,
      DType_INT64,   DType_UINT8,  DType_UINT16,   DType_UINT32, DType_UINT64,
      DType_QINT8,   DType_QINT16, DType_BFLOAT16, DType_UTF8,   DType_UTF16,
      DType_UTF32};
  return values;
}
...
inline const char *const *EnumNamesDType() {
  static const char *const names[] = {
      "INHERIT", "BOOL",  "FLOAT8", "HALF",     "HALF2", "FLOAT",  "DOUBLE",
      "INT8",    "INT16", "INT32",  "INT64",    "UINT8", "UINT16", "UINT32",
      "UINT64",  "QINT8", "QINT16", "BFLOAT16", "",      "",       "",
      "",        "",      "",       "",         "",      "",       "",
      "",        "",      "",       "",         "",      "",       "",
      "",        "",      "",       "",         "",      "",       "",
      "",        "",      "",       "",         "",      "",       "",
      "",        "UTF8",  "UTF16",  "UTF32",    nullptr};
  return names;
}
...
struct FlatArray FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  enum { VT_SHAPE = 4, VT_BUFFER = 6, VT_DTYPE = 8, VT_BYTEORDER = 10 };
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_SHAPE) &&
           ...
           VerifyField<int8_t>(verifier, VT_BYTEORDER) && verifier.EndTable();
  }
};
...
struct FlatArrayBuilder {
  ...
  void add_byteOrder(ByteOrder byteOrder) {
    fbb_.AddElement<int8_t>(FlatArray::VT_BYTEORDER,
                            static_cast<int8_t>(byteOrder), 0);
  }
  explicit FlatArrayBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
...
inline flatbuffers::Offset<FlatArray> CreateFlatArrayDirect(
    ...
    const std::vector<int8_t> *buffer = nullptr, DType dtype = DType_INHERIT,
    ByteOrder byteOrder = ByteOrder_LE) {
  return sd::graph::CreateFlatArray(
      _fbb, shape ? _fbb.CreateVector<int64_t>(*shape) : 0,
      buffer ? _fbb.CreateVector<int8_t>(*buffer) : 0, dtype, byteOrder);
}
...
inline bool VerifyFlatArrayBuffer(flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<sd::graph::FlatArray>(nullptr);
}

inline bool VerifySizePrefixedFlatArrayBuffer(flatbuffers::Verifier &verifier) {
