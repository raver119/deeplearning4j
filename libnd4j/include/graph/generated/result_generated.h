...
struct FlatTiming FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  enum { VT_ID = 4, VT_NAME = 6, VT_TIMING = 8 };
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.VerifyTable(timing()) && verifier.EndTable();
  }
};
...
inline flatbuffers::Offset<FlatTiming> CreateFlatTimingDirect(
    flatbuffers::FlatBufferBuilder &_fbb, int32_t id = 0,
    const char *name = nullptr, flatbuffers::Offset<LongPair> timing = 0) {
  return sd::graph::CreateFlatTiming(
      _fbb, id, name ? _fbb.CreateString(name) : 0, timing);
}
...
struct FlatResult FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<FlatTiming>> *timing() const {
    return GetPointer<
        const flatbuffers::Vector<flatbuffers::Offset<FlatTiming>> *>(
        VT_TIMING);
  }
...
struct FlatResultBuilder {
  ...
  void add_timing(
      flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<FlatTiming>>>
          timing) {
    fbb_.AddOffset(FlatResult::VT_TIMING, timing);
  }
  void add_footprintForward(int64_t footprintForward) {
    fbb_.AddElement<int64_t>(FlatResult::VT_FOOTPRINTFORWARD, footprintForward,
                             0);
  }
  void add_footprintBackward(int64_t footprintBackward) {
    fbb_.AddElement<int64_t>(FlatResult::VT_FOOTPRINTBACKWARD,
                             footprintBackward, 0);
  }
...
inline flatbuffers::Offset<FlatResult> CreateFlatResultDirect(
  ...
  return sd::graph::CreateFlatResult(
      ...
      footprintForward, footprintBackward);
}
...
inline bool VerifyFlatResultBuffer(flatbuffers::Verifier &verifier) {
