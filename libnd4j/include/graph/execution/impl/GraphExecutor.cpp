...
namespace sd {
    namespace graph {
        ...
        Nd4jStatus GraphExecutor::execute(const std::shared_ptr<sd::ops::DeclarableOp> &op, const ContextPrototype &contextPrototype, const OpSequence &sequence, const OptimizedGraph &graph, VariableProxy &proxy, const int deviceId) const {
