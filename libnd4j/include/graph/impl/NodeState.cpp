...
void NodeState::setInnerTime(Nd4jLong time) { _inner = time; }

void NodeState::setOuterTime(Nd4jLong time) { _outer = time; }

Nd4jLong NodeState::innerTime() { return _inner; }

Nd4jLong NodeState::outerTime() { return _outer; }
