...
namespace sd {
graph_exception::graph_exception(std::string message, Nd4jLong graphId)
    : std::runtime_error(message) {
  this->_message = message;
  this->_graphId = graphId;
}

graph_exception::graph_exception(std::string message, std::string description,
                                 Nd4jLong graphId)
    : std::runtime_error(message) {
  this->_message = message;
...
graph_exception::graph_exception(std::string message, const char* description,
                                 Nd4jLong graphId)
    : std::runtime_error(message) {
  this->_message = message;
  this->_description = description;
