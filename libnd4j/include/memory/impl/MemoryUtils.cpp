...
bool sd::memory::MemoryUtils::retrieveMemoryStatistics(
    sd::memory::MemoryReport &report) {
#if defined(__APPLE__)
  ...
  /*
     ...
     (task_info_t)&t_info, &t_info_count)) return false;
  ...
  */
  ...
  nd4j_debug("Usage: %lld; %lld; %lld; %lld;\n", _usage.ru_ixrss,
             _usage.ru_idrss, _usage.ru_isrss, _usage.ru_maxrss);
