...
void *Workspace::allocateBytes(Nd4jLong numBytes) {
  if (numBytes < 1)
    throw allocation_exception::build(
        "Number of bytes for allocation should be positive", numBytes);
  ...
  nd4j_debug(
      "Allocating %lld bytes from workspace; Current PTR: %p; Current offset: "
      "%lld\n",
...
Nd4jLong Workspace::getAllocatedSecondarySize() { return 0L; }

Nd4jLong Workspace::getCurrentSecondarySize() { return 0L; }

Nd4jLong Workspace::getCurrentSecondaryOffset() { return 0L; }

Nd4jLong Workspace::getSpilledSecondarySize() { return 0L; }

Nd4jLong Workspace::getUsedSecondarySize() { return 0L; }
