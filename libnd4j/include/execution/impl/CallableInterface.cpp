...
void CallableInterface::fill(int threadID, int numThreads, FUNC_1D func,
                             int64_t startX, int64_t stopX, int64_t incX) {
...
void CallableInterface::fill(int threadID, int numThreads, FUNC_2D func,
                             int64_t startX, int64_t stopX, int64_t incX,
...
void CallableInterface::fill(int threadID, int numThreads, FUNC_3D func,
                             int64_t startX, int64_t stopX, int64_t incX,
                             int64_t start_y, int64_t stop_y, int64_t inc_y,
...
void CallableInterface::fill(int threadID, int numThreads, int64_t *lptr,
                             FUNC_RL func, int64_t startX, int64_t stopX,
                             int64_t incX) {
...
void CallableInterface::fill(int threadID, int numThreads, double *dptr,
                             FUNC_RD func, int64_t startX, int64_t stopX,
                             int64_t incX) {
...
void CallableInterface::execute() {
  ...
  switch (_branch) {
    ...
    case 1:
      ...
      break;
    case 2:
      _function_2d(_thread_id, _arguments[0], _arguments[1], _arguments[2],
                   _arguments[3], _arguments[4], _arguments[5]);
      break;
    case 3:
      _function_3d(_thread_id, _arguments[0], _arguments[1], _arguments[2],
                   _arguments[3], _arguments[4], _arguments[5], _arguments[6],
                   _arguments[7], _arguments[8]);
      break;
    case 4:
      _lptr[0] =
          _function_rl(_thread_id, _arguments[0], _arguments[1], _arguments[2]);
      break;
    case 5:
      _dptr[0] =
          _function_rd(_thread_id, _arguments[0], _arguments[1], _arguments[2]);
      break;
  }
