...
#ifndef __JAVACPP_HACK__
  LaunchContext(cudaStream_t* cudaStream, cudaStream_t& specialCudaStream,
                void* reductionPointer = nullptr, void* scalarPointer = nullptr,
...
#endif  // CUDA
  LaunchContext(Nd4jPointer cudaStream, Nd4jPointer reductionPointer = nullptr,
                Nd4jPointer scalarPointer = nullptr,
                Nd4jPointer allocationPointer = nullptr);
  LaunchContext();
  ~LaunchContext();
...
#ifndef __JAVACPP_HACK__
  // this method returns mutex shared between all threads that use the same
  // device
