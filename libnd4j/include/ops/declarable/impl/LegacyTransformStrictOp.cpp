...
LegacyTransformStrictOp::LegacyTransformStrictOp(int opNum)
...
Nd4jStatus LegacyTransformStrictOp::validateAndExecute(Context &block) {
  ...
  NativeOpExecutioner::execTransformStrict(
      block.launchContext(), opNum, input->buffer(), input->shapeInfo(),
 ...
 *
 */
ShapeList *LegacyTransformStrictOp::calculateOutputShape(
