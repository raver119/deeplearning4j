...
LegacyReduceLongOp::LegacyReduceLongOp(int opNum)
 ...
 * dimensions
 */
ShapeList *LegacyReduceLongOp::calculateOutputShape(ShapeList *inputShape,
  ...
  return SHAPELIST(ShapeUtils::evalReduceShapeInfo(
      shape::order(inShape), axis, inShape, DataType::INT64, keepDims,
