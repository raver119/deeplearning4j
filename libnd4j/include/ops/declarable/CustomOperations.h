...
/**
 * This operations exposes given arguments as it's own outputs, but does it only
 * once. Subsequent calls will be served directly by this op.
 *
 * PLEASE NOTE: This operation is internal graph operation, and shouldn't be
 * used directly usually.
 */
