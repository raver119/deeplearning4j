...
/**
 * This operations selects specified index fron NDArrayList and returns it as
 * NDArray Expected arguments: x: non-empty list indices: optional, scalar with
 * index
 *
 * Int args:
 * optional, index
...
/**
 * This operations selects specified indices fron NDArrayList and returns them
 * as NDArray Expected arguments: x: non-empty list indices: optional, vector
 * with indices
 *
 * Int args:
 * optional, indices
...
/**
 * This operations returns scalar, with number of existing arrays within given
 * NDArrayList Expected arguments: x: list
 */
...
/**
 * This operation unpacks given NDArray into specified NDArrayList wrt specified
 * indices
 */
...
/**
 * This operation splits given NDArray into chunks, and stores them into given
 * NDArrayList wert sizes Expected arguments: list: optional, NDArrayList. if
 * not available - new NDArrayList will be created array: array to be split
