...
/**
 * This op implements im2col algorithm, widely used in convolution neural
 * networks Input: 4D input expected
 *
 * Int args:
 * 0: kernel height
 * 1: kernel width
...
/**
 * This op implements col2im algorithm, widely used in convolution neural
 * networks Input: 6D input expected (like output of im2col op)
 *
 * Int args:
 * 0: stride height
 * 1: stride width
 ...
 * Maximum value within each TAD is replaced with 1, other values are set to
 * true.
 *
 * Int args:
 * 0: axis
...
/**
 * This op same as maxpool2d with a variant to return a matrix of indexes for
 * max values
 *
 * Input - 4D tensor
 * Output:
