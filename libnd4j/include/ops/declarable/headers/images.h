 ...
 * Rgb To Hsv
 * Input arrays:
 * 0 - input array with rank >= 1, must have at least one dimension equal 3,
 * that is dimension containing channels. Int arguments: 0 - optional argument,
 * corresponds to dimension with 3 channels
 */
 ...
 * must have size 3 and should contain RGB values.
 */
