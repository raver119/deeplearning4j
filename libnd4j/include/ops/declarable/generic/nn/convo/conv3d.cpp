...
CUSTOM_OP_IMPL(conv3dnew, 2, 1, false, 0, 13) {
    ...
    int isNCDHW = block.numI() > 13 ? !INT_ARG(13) : 1;       // INT_ARG(13): 1-NDHWC, 0-NCDHW
    int wFormat = block.numI() > 14 ? INT_ARG(14) : 0;        // 0-[kD, kH, kW, iC, oC], 1-[oC, iC, kD, kH, kW], 2-[oC, kD, kH, kW, iC]
