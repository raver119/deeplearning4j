...
namespace nd4j {
    namespace ops {
        CUSTOM_OP_IMPL(lstsq, 2, 1, false, 0, 0) {
            ...
            REQUIRE_TRUE(a->sizeAt(-1) == b->sizeAt(-2), 0, "lstsq: The last dimmension of left part should be equal to prelast of right part, but %i and %i are given", a->sizeAt(-1), b->sizeAt(-2));
