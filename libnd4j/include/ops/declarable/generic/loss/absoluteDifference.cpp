...
CUSTOM_OP_IMPL(absolute_difference_loss, 3, 1, false, 0, 1) {
  ...
  REQUIRE_TRUE(labels->isSameShape(predictions), 0,
               "ABSOLUTE_DIFFERENCE_LOSS OP: labels and predictions arrays "
  ...
  REQUIRE_TRUE(
      ...
      "ABSOLUTE_DIFFERENCE_LOSS OP: weights array should be scalar or have the "
  ...
  REQUIRE_TRUE(
      ...
      0,
      "ABSOLUTE_DIFFERENCE_LOSS OP: shapes of weights and labels arrays should "
  ...
  REQUIRE_TRUE(
      reductionMode == 0 || reductionMode == 1 || reductionMode == 2 ||
          reductionMode == 3,
      0,
      "ABSOLUTE_DIFFERENCE_LOSS OP: reduction mode value is not acceptable, "
