 ...
 *
 * IArgs map:
 * IArgs[0] - update operation: 0 - add; 1 - sub; 2 - mul; 3 - div; 4 - rsub; 5
 * - rdiv; 6 - assign IArgs[1] - number of dimensions IArgs[...] - dimensions
...
CONFIGURABLE_OP_IMPL(scatter_update, 2, 1, true, 0, -1) {
  ...
  helpers::scatterUpdate(block.launchContext(), *operand, *updates,
                         &block.getIArguments());
