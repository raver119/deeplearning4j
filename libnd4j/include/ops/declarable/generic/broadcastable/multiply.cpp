...
namespace ops {
    ...
    BROADCASTABLE_OP_IMPL(multiply, 0, 0) {
        ...
        const bool areShapesBroadcastable = ShapeUtils::evalBroadcastShapeInfo(x->shapeInfo(), y->shapeInfo(), true, zShapeInfo, block.workspace());
...
CUSTOM_OP_IMPL(multiply_bp, 3, 2, false, 0, 0) {
    ...
    const bool areShapesBroadcastable = ShapeUtils::evalBroadcastShapeInfo(x->shapeInfo(), y->shapeInfo(), true, dLdzShapeInfo, block.workspace());
