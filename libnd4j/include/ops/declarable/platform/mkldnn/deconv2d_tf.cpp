...
//////////////////////////////////////////////////////////////////////////
static void deconv2TFdBpMKLDNN(const NDArray* weights,
  ...
  w_user_md, {3,2,0,1});  // permute [kH, kW, iC, oC] -> [oC, iC, kH, kW]
...
PLATFORM_IMPL(deconv2d_tf, ENGINE_CPU) {
  ...
  deconv2TFdBpMKLDNN(weights, gradO, gradI, bS, iC, iH, iW, oC, oH, oW,
