...
void crossBatched(sd::LaunchContext *context, NDArray *a, NDArray *b,
                  NDArray *o);

void FORCEINLINE cross(sd::LaunchContext *context, NDArray *a, NDArray *b,
                       NDArray *o) {
  if (a->isR()) {
...
void FORCEINLINE _crossBatched(sd::LaunchContext *context, NDArray *a,
                               NDArray *b, NDArray *o) {
