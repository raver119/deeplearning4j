...
////////////////////////////////////////////////////////////////////////////////
template <typename T>
FORCEINLINE _CUDA_HD void rgbToHsv(const T& r, const T& g, const T& b, T& h,
                                   T& s, T& v) {
...
////////////////////////////////////////////////////////////////////////////////
template <typename T>
FORCEINLINE _CUDA_HD void hsvToRgb(const T& h, const T& s, const T& v, T& r,
                                   T& g, T& b) {
...
////////////////////////////////////////////////////////////////////////////////
template <typename T>
FORCEINLINE _CUDA_HD void rgbYuv(const T& r, const T& g, const T& b, T& y, T& u,
                                 T& v) {
  y = static_cast<T>(0.299) * r + static_cast<T>(0.587) * g +
      static_cast<T>(0.114) * b;
  u = -static_cast<T>(0.14714119) * r - static_cast<T>(0.2888691) * g +
      static_cast<T>(0.43601035) * b;
  v = static_cast<T>(0.61497538) * r - static_cast<T>(0.51496512) * g -
      static_cast<T>(0.10001026) * b;
}

////////////////////////////////////////////////////////////////////////////////
template <typename T>
FORCEINLINE _CUDA_HD void yuvRgb(const T& y, const T& u, const T& v, T& r, T& g,
                                 T& b) {
...
/*////////////////////////////////////////////////////////////////////////////////
template <typename T>
static FORCEINLINE _CUDA_HD void rgb_to_hv(T r, T g, T b, T* h, T* v_min, T*
v_max) { T v_mid; int h_category;
...
////////////////////////////////////////////////////////////////////////////////
template <typename T>
static FORCEINLINE _CUDA_HD void hv_to_rgb(T h, T v_min, T v_max, T* r, T* g, T*
b) { int h_category = static_cast<int>(h); T ratio = h - (T)h_category; bool
increase = ((h_category & 0x1) == 0); if (!increase) ratio = 1 - ratio;
