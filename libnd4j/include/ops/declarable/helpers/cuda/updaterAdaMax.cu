...
///////////////////////////////////////////////////////////////////
template <typename T>
__global__ void adaMaxUpdaterCuda(
    ...
    const Nd4jLong* stmShapeInfo, const T lr, const T beta1, const T beta2,
  ...
  for (Nd4jLong i = blockIdx.x * blockDim.x + threadIdx.x; i < xLen;
    ...
    // u = max(B_2 * u, |grad|)
    stU[stUOffset] = sd::math::nd4j_max((beta2 * initU[initUOffset]),
                                        sd::math::nd4j_abs(grad[xOffset])) +
                     1e-32;
...
///////////////////////////////////////////////////////////////////
template <typename T>
linkage void adaMaxUpdaterCudaLauncher(
...
void updaterAdaMax(sd::LaunchContext* context, const NDArray& gradient,
  ...
  BUILD_SINGLE_SELECTOR(
      gradient.dataType(), adaMaxUpdaterCudaLauncher,
