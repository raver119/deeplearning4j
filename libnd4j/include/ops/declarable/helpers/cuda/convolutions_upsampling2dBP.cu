...
//////////////////////////////////////////////////////////////////////////
template <typename T>
__global__ static void upsampling2dBPCuda(const void* vx,
                                          const Nd4jLong* xShapeInfo, void* vz,
                                          const Nd4jLong* zShapeInfo,
                                          const bool isNCHW) {
  // x (gradO) has shape [bS, iC, factorH*iH, factorW*iW ] (NCHW) or [bS,
  // factorH*iH, factorW*iW, iC] (NHWC) z (gradI) has shape [bS, iC, iH, iW]
  ...
  for (coords[dimIH] = zCoord2; coords[dimIH] < zCoord2 + factorH;
       ++coords[dimIH])
    for (coords[dimIH + 1] = zCoord3; coords[dimIH + 1] < zCoord3 + factorW;
         ++coords[dimIH + 1])
...
//////////////////////////////////////////////////////////////////////////
template <typename T>
static void upsampling2dBPCudaLauncher(
    ...
    void* vz, const Nd4jLong* zShapeInfo, const bool isNCHW) {
  upsampling2dBPCuda<T><<<blocksPerGrid, threadsPerBlock, sharedMem, *stream>>>(
      vx, xShapeInfo, vz, zShapeInfo, isNCHW);
}

//////////////////////////////////////////////////////////////////////////
void ConvolutionUtils::upsampling2dBP(sd::graph::Context& block,
