...
//////////////////////////////////////////////////////////////////////////
template <typename T>
__global__ static void upsampling3dCuda(const void* vx,
                                        const Nd4jLong* xShapeInfo, void* vz,
                                        const Nd4jLong* zShapeInfo,
                                        const int factorD, const int factorH,
                                        const int factorW, const bool isNCDHW) {
  // x has shape [bS, iC, iD, iH, iW] (NCDHW) or [bS, iD, iH, iW, iC] (NDHWC)
  // z has shape [bS, iC, factorD*iD, factorH*iH, factorW*iW ] (NCDHW) or [bS,
...
//////////////////////////////////////////////////////////////////////////
template <typename T>
static void upsampling3dCudaLauncher(
    ...
    void* vz, const Nd4jLong* zShapeInfo, const int factorD, const int factorH,
    const int factorW, const bool isNCDHW) {
  upsampling3dCuda<T><<<blocksPerGrid, threadsPerBlock, sharedMem, *stream>>>(
      vx, xShapeInfo, vz, zShapeInfo, factorD, factorH, factorW, isNCDHW);
}

//////////////////////////////////////////////////////////////////////////
void ConvolutionUtils::upsampling3d(sd::graph::Context& block,
  ...
  BUILD_SINGLE_SELECTOR(
      ...
      (blocksPerGrid, threadsPerBlock, sharedMem,
       ...
       output.specialShapeInfo(), factorD, factorH, factorW, isNCDHW),
      FLOAT_TYPES);
