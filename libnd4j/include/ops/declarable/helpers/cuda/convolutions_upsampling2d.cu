...
//////////////////////////////////////////////////////////////////////////
template <typename T>
__global__ static void upsampling2dCuda(const void* vx,
  ...
  // z has shape [bS, iC, factorH*iH, factorW*iW ] (NCHW) or [bS, factorH*iH,
  // factorW*iW, iC] (NHWC)
...
//////////////////////////////////////////////////////////////////////////
template <typename T>
static void upsampling2dCudaLauncher(
    ...
    void* vz, const Nd4jLong* zShapeInfo, const int factorH, const int factorW,
    const bool isNCHW) {
  upsampling2dCuda<T><<<blocksPerGrid, threadsPerBlock, sharedMem, *stream>>>(
      vx, xShapeInfo, vz, zShapeInfo, factorH, factorW, isNCHW);
}

//////////////////////////////////////////////////////////////////////////
void ConvolutionUtils::upsampling2d(sd::graph::Context& block,
  ...
  BUILD_SINGLE_SELECTOR(
      ...
      (blocksPerGrid, threadsPerBlock, sharedMem,
       ...
       output.specialShapeInfo(), factorH, factorW, isNCHW),
      FLOAT_TYPES);
