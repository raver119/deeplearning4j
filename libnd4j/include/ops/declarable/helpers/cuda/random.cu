 ...
 * */
template <typename T>
static __global__ void fillGammaKernel(T* uList, Nd4jLong uLength, T* alpha,
                                       const Nd4jLong* alphaShape, T* beta,
...
static void fillRandomGamma_(LaunchContext* context,
  ...
  if (beta != nullptr) {
    ...
    copyAlpha->tickWriteDevice();
    copyBeta->tickWriteDevice();
  }
