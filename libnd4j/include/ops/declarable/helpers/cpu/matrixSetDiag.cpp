...
//////////////////////////////////////////////////////////////////////////
template <typename T>
void matrixSetDiag_(const NDArray& input, const NDArray& diagonal,
  ...
  const bool areSameOffsets = shape::haveSameShapeAndStrides(
      xShapeInfo,
...
void matrixSetDiag(sd::LaunchContext* context, const NDArray& input,
                   ...
                   const bool zeroPad) {
  BUILD_SINGLE_SELECTOR(input.dataType(), matrixSetDiag_,
                        (input, diagonal, output, zeroPad), LIBND4J_TYPES);
}
