...
//////////////////////////////////////////////////////////////////////////
template <typename T>
static void upsampling2dBP_(const NDArray& gradO, NDArray& gradI,
                            const bool isNCHW) {
  // gradO has shape [bS, iC, factorH*iH, factorW*iW ] (NCHW) or [bS,
  // factorH*iH, factorW*iW, iC] (NHWC) gradI has shape [bS, iC, iH, iW] (NCHW)
  // or [bS, iH, iW, iC] (NHWC)
...
void ConvolutionUtils::upsampling2dBP(sd::graph::Context& block,
                                      ...
                                      const bool isNCHW) {
  BUILD_SINGLE_SELECTOR(gradO.dataType(), upsampling2dBP_,
