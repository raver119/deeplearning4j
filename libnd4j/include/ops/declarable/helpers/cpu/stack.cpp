...
///////////////////////////////////////////////////////////////////
template <typename T>
static void stack_(const std::vector<const NDArray*>& inArrs, NDArray& output,
                   const int dim) {
...
void stack(sd::LaunchContext* context,
           ...
           const int dim) {
  BUILD_SINGLE_SELECTOR(output.dataType(), stack_, (inArrs, output, dim),
                        LIBND4J_TYPES);
}
...
///////////////////////////////////////////////////////////////////
template <typename T>
static void unstack_(const NDArray& input, const std::vector<NDArray*>& outArrs,
                     const int dim) {
...
void unstack(sd::LaunchContext* context, const NDArray& input,
  ...
  BUILD_SINGLE_SELECTOR(input.dataType(), unstack_, (input, outArrs, dim),
                        LIBND4J_TYPES);
}
