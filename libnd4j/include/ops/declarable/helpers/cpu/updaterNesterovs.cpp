...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename T>
static void nesterovsUpdater_(const NDArray& gradient, const NDArray& initState,
                              NDArray& update, NDArray& stateV,
  ...
  bool bEws1 = 1 == gradient.ews() && 1 == update.ews() && 1 == stateV.ews() &&
               1 == initState.ews();
  ...
  auto func = PRAGMA_THREADS_FOR {
    ...
    for (auto i = start; i < stop; i++) {
      ...
      const auto stOffset =
          bXStSame ? xOffset : shape::getOffset(stateV.shapeInfo(), coords);
...
void updaterNesterovs(sd::LaunchContext* context, const NDArray& gradient,
  ...
  BUILD_SINGLE_SELECTOR(gradient.dataType(), nesterovsUpdater_,
                        (gradient, initState, update, stateV, dLr, dMomentum),
                        FLOAT_TYPES);
}
