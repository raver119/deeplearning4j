...
template <typename T>
static void adjustHue_(const NDArray *input, const NDArray *deltaScalarArr,
...
void adjustHue(sd::LaunchContext *context, const NDArray *input,
  ...
  BUILD_SINGLE_SELECTOR(input->dataType(), adjustHue_,
                        (input, deltaScalarArr, output, dimC), FLOAT_TYPES);
}

/*
template <typename T>
static void adjust_hue_single_(sd::LaunchContext * context, NDArray *array,
...
void adjust_hue_(sd::LaunchContext * context, NDArray *array, NDArray *output,
NDArray* delta, bool isNHWC) { auto xType = array->dataType();
    ...
    if (array->rankOf() == 4) {
        ...
        for (int e = 0; e < tSize; e++) {
            BUILD_SINGLE_SELECTOR(xType, adjust_hue_single_, (context,
tadsIn->at(e), tadsOut->at(e), d, isNHWC);, FLOAT_TYPES);
        ...
        BUILD_SINGLE_SELECTOR(xType, adjust_hue_single_, (context, array,
output, d, isNHWC);, FLOAT_TYPES);
    }
}

BUILD_SINGLE_TEMPLATE(template void adjust_hue_single_, (sd::LaunchContext *
context, NDArray *array, NDArray *output, float delta, bool isNHWC);,
FLOAT_TYPES);
*/
