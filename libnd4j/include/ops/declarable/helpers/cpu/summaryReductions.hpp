...
#if 0
                    //nd4j_printf("%f %f %f , %f %f %f ==> %f %f %f\n", x.n, x.mean, x.M2, y.n, y.mean, y.M2, n, meanD, M2D);
#endif
                    return { n,meanD,M2D };
                }
...
#else
                //nd4j_printf("mth %d %ld\n", maxThreads,inner_total);
