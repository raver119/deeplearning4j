...
//////////////////////////////////////////////////////////////////////////
template <typename T>
static void pooling3d_(sd::graph::Context& block, const NDArray& input,
          ...
          for (int od = start_z; od < stop_z; od += inc_z) {
            for (int oh = 0; oh < oH; ++oh) {
              for (int ow = 0; ow < oW; ++ow) {
                ...
                out[b * oStride0 + c * oStride1 + od * oStride2 +
                    oh * oStride3 + ow * oStride4] = sum;
              }
            }
          }
        }
  ...
  /*************************************************************************/
    ...
    nd4j_printf(
        "ConvolutionUtils::pooling3d: pooling mode argument can take three "
...
void ConvolutionUtils::pooling3d(sd::graph::Context& block,
  ...
  BUILD_SINGLE_SELECTOR(input.dataType(), pooling3d_,
                        (block, input, output, kD, kH, kW, sD, sH, sW, pD, pH,
