...
namespace sd {
BroadcastOpsTuple BroadcastOpsTuple::custom(sd::scalar::Ops scalar,
...
BroadcastOpsTuple BroadcastOpsTuple::Assign() {
  return custom(sd::scalar::CopyPws, sd::pairwise::CopyPws,
                sd::broadcast::CopyPws);
}

BroadcastOpsTuple BroadcastOpsTuple::Divide() {
  return custom(sd::scalar::Divide, sd::pairwise::Divide,
                sd::broadcast::Divide);
}

BroadcastOpsTuple BroadcastOpsTuple::DivideNoNan() {
  return custom(sd::scalar::DivideNoNan, sd::pairwise::DivideNoNan,
                sd::broadcast::DivideNoNan);
}

BroadcastOpsTuple BroadcastOpsTuple::Multiply() {
  return custom(sd::scalar::Multiply, sd::pairwise::Multiply,
                sd::broadcast::Multiply);
}

BroadcastOpsTuple BroadcastOpsTuple::Subtract() {
  return custom(sd::scalar::Subtract, sd::pairwise::Subtract,
                sd::broadcast::Subtract);
}
BroadcastOpsTuple BroadcastOpsTuple::IGamma() {
  return custom(sd::scalar::IGamma, sd::pairwise::IGamma,
                sd::broadcast::IGamma);
}
BroadcastOpsTuple BroadcastOpsTuple::IGammac() {
  return custom(sd::scalar::IGammac, sd::pairwise::IGammac,
                sd::broadcast::IGammac);
}
...
BroadcastOpsTuple BroadcastOpsTuple::PowDerivative() {
  return custom(sd::scalar::PowDerivative, sd::pairwise::PowDerivative,
                sd::broadcast::PowDerivative);
}
