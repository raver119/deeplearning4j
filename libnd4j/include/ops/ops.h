...
#define no_op_exec_special_any                                          \
  ...
  static void execSpecial(const X *dx, const Nd4jLong *xShapeBuffer,    \
                          Z *result, const Nd4jLong *resultShapeBuffer, \
                          X *extraParams, const Nd4jLong *tadShapeInfo, \
...
#define no_op_exec_special_same                                         \
  static const bool requiresSpecial = false;                            \
  static void execSpecial(const X *dx, const Nd4jLong *xShapeBuffer,    \
                          X *result, const Nd4jLong *resultShapeBuffer, \
                          X *extraParams, const Nd4jLong *tadShapeInfo, \
                          const Nd4jLong *tadOffsets) {}
...
#define no_op_exec_special_accumulation_long                             \
  static const bool requiresSpecialAccumulation = false;                 \
  static void execSpecial(                                               \
      const X *x, const Nd4jLong *xShapeInfo, X *extraParams, Z *result, \
      const Nd4jLong *resultShapeInfoBuffer, int *dimension,             \
      int dimensionLength, const Nd4jLong *tadShapeInfo,                 \
      const Nd4jLong *tadOffset) {}
#define no_op_exec_special_accumulation_same                             \
  static const bool requiresSpecialAccumulation = false;                 \
  static void execSpecial(                                               \
      const X *x, const Nd4jLong *xShapeInfo, X *extraParams, X *result, \
      const Nd4jLong *resultShapeInfoBuffer, int *dimension,             \
      int dimensionLength, const Nd4jLong *tadShapeInfo,                 \
      const Nd4jLong *tadOffset) {}
#ifdef __CUDACC__
#define no_op_exec_special_any_cuda                         \
  static __device__ void execSpecialCuda(                   \
      const X *dx, const Nd4jLong *xShapeBuffer, Z *result, \
      const Nd4jLong *resultShapeBuffer, X *extraParams,    \
...
#define no_op_exec_special_same_cuda                        \
  static __device__ void execSpecialCuda(                   \
      const X *dx, const Nd4jLong *xShapeBuffer, X *result, \
      const Nd4jLong *resultShapeBuffer, X *extraParams,    \
      int *allocationPointer, X *reductionPointer,          \
      const Nd4jLong *tadShapeInfo, const Nd4jLong *tadOffsets) {}
#define no_op_exec_special_cuda                             \
  static __device__ void execSpecialCuda(                   \
      const X *dx, const Nd4jLong *xShapeBuffer, Z *result, \
      const Nd4jLong *resultShapeBuffer, Z *extraParams,    \
      int *allocationPointer, Z *reductionPointer,          \
      const Nd4jLong *tadShapeInfo, const Nd4jLong *tadOffsets) {}
#define no_op_exec_special_accumulation_same_cuda                           \
  static inline __device__ void execSpecialCuda(                            \
      const X *dx, const Nd4jLong *xShapeInfo, X *extraParams, X *result,   \
      const Nd4jLong *resultShapeInfo, int *dimension, int dimensionLength, \
      X *reductionBuffer, const Nd4jLong *tadOnlyShapeInfo,                 \
      const Nd4jLong *tadOffsets) {}
#define no_op_exec_special_accumulation_long_cuda                           \
  static inline __device__ void execSpecialCuda(                            \
      const X *dx, const Nd4jLong *xShapeInfo, X *extraParams, Z *result,   \
      const Nd4jLong *resultShapeInfo, int *dimension, int dimensionLength, \
      Z *reductionBuffer, const Nd4jLong *tadOnlyShapeInfo,                 \
      const Nd4jLong *tadOffsets) {}
#define no_op_exec_special_accumulation_cuda                                \
  static inline __device__ void execSpecialCuda(                            \
      const X *dx, const Nd4jLong *xShapeInfo, Z *extraParams, Z *result,   \
      const Nd4jLong *resultShapeInfo, int *dimension, int dimensionLength, \
      Z *reductionBuffer, const Nd4jLong *tadOnlyShapeInfo,                 \
      const Nd4jLong *tadOffsets) {}
...
struct IndexValue {
  ...
  _CUDA_HD IndexValue(const T val, const Nd4jLong ind)
      : index(ind), value(val) {}
};
}  // namespace indexreduce
...
class Add {
 public:
  op_def static Z op(X d1, Y d2) { return static_cast<Z>(d1 + d2); }

  op_def static Z op(X d1, Y d2, Z *params) { return static_cast<Z>(d1 + d2); }

  op_def static Z op(X d1) { return static_cast<Z>(d1); }

  // op for MetaOps
  op_def static Z op(X d1, Y *params) { return static_cast<Z>(d1 + params[0]); }

  op_def static X startingValue() { return static_cast<X>(0.f); }
};

template <typename X, typename Y>
class NewAdd {
 public:
  op_def static X op(X d1, Y d2, X *params) { return d1 + d2; }
};
...
class SquaredSubtract {
 public:
  ...
  op_def static Z op(X d1) { return d1; }
...
class ReverseSubtract {
 public:
  op_def static Z op(X d1, Y d2) { return static_cast<Z>(d2 - d1); }

  op_def static Z op(X d1, Y d2, Z *params) { return static_cast<Z>(d2 - d1); }

  op_def static Z op(X d1) { return d1; }

  // op for MetaOps
  op_def static Z op(X d1, Y *params) { return static_cast<Z>(params[0] - d1); }
};
 ...
 public:
  op_def static Z op(X z, Y c) {
    ...
    return (sd::math::nd4j_exp<Y, Z>(c) - zz * zc +
            (zz * sd::math::nd4j_log<X, Z>(z) - zz +
             static_cast<Z>(0.5f) *
                 sd::math::nd4j_log<Z, Z>(static_cast<Z>(DOUBLE_PI_X) * zz)));
  }
  ...
  op_def static Z op(X z) {
    auto zz = static_cast<Z>(z);
    return (zz * sd::math::nd4j_log<Y, Z>(z) - zz +
            static_cast<Z>(0.5f) *
                sd::math::nd4j_log<Z, Z>(static_cast<Z>(DOUBLE_PI_X) * zz));
  }
  ...
  op_def static X op(X z, Y *params) {
    return (sd::math::nd4j_exp<X, X>(params[0]) - z * params[0] +
            (z * sd::math::nd4j_log<X, Z>(z) - z +
             static_cast<X>(0.5f) * sd::math::nd4j_log<X, Z>(DOUBLE_PI_X * z)));
  }
};
...
class LogPoissonLoss {
 public:
  ...
  op_def static Z op(X z) { return static_cast<Z>(z); }

  // op for MetaOps
  op_def static Z op(X z, Y *params) {
    return (sd::math::nd4j_exp<Y, Z>(params[0]) -
            static_cast<Z>(z) * static_cast<Z>(params[0]));
  }
};
...
class Multiply {
 public:
  ...
  op_def static X startingValue() { return static_cast<X>(1.f); }
};
...
class Divide {
 public:
  ...
  op_def static X startingValue() { return static_cast<X>(1); }
};
 ...
 public:
  op_def static Z op(X d1, Y d2) {
    ...
    return (d1 < static_cast<X>(0)) == (d2 < static_cast<Y>(0))
               ? m
               : sd::math::nd4j_fmod<Z, Y, Z>(m + static_cast<Z>(d2), d2);
  }
  ...
  // op for MetaOps
  op_def static Z op(X d1, Y *params) { return op(d1, params[0]); }
};
...
class CopyPws {
 public:
  op_def static Z op(X d1, Y d2) { return static_cast<Z>(d2); }

  op_def static Z op(X d1, Y d2, Z *params) { return static_cast<Z>(d2); }

  op_def static Z op(X d1) { return static_cast<Z>(d1); }

  op_def static Z op(X d1, Y *params) { return static_cast<Z>(d1); }
};
...
class And {
 public:
  ...
  // op for MetaOps
  op_def static Z op(X d1, X *params) { return static_cast<Z>(119); }
};

template <typename X>
class IntOr {
 public:
  op_def static X op(X d1, X d2) { return d2 | d1; }

  op_def static X op(X d1, X d2, X *params) { return op(d1, d2); }
};
...
class ShiftLeft {
 public:
  op_def static X op(X d1, X d2) { return d1 << d2; }
...
class CyclicShiftLeft {
 public:
  op_def static X op(X d1, X d2) { return sd::math::nd4j_rotl<X>(d1, d2); }
...
class CyclicShiftRight {
 public:
  op_def static X op(X d1, X d2) { return sd::math::nd4j_rotr<X>(d1, d2); }
 ...
 public:
  ...
  op_def static Z op(X d1, X d2, X *params) {
    if (params != nullptr) {
      ...
      return ((d1 == comp && d2 != comp) || (d1 != comp && d2 == comp))
                 ? static_cast<Z>(1)
                 : static_cast<Z>(0);
    } else {
      auto b1 = static_cast<bool>(d1);
...
class LogicalNot {
 public:
  op_def static Z op(X d1, Y d2) { return !((int)d1 && (int)d2); }
  ...
  // op for MetaOps
  op_def static Z op(X d1, Y *params) { return static_cast<X>(119); }
};
...
class LogicalXor {
 public:
  ...
  op_def static Z op(X d1, Y d2, Z *params) { return op(d1, d2); }

  op_def static Z op(X d1) { return d1; }

  // op for MetaOps
  op_def static Z op(X d1, Y *params) { return static_cast<Z>(119); }
};
...
class LogicalAnd {
 public:
  ...
  op_def static Z op(Y d1) { return d1; }
...
class Mod {
 public:
  ...
  op_def static half op(half d1, half d2, half *params) {
          return __float2half(simdOps::Mod<float>::op(__half2float(d1),
  __half2float(d2), nullptr));
  }
   */
...
class Epsilon {
 public:
  op_def static Z op(X d1, X d2) {
    ...
    if (absDiff <= static_cast<X>(MIN_V)) return static_cast<Z>(1);
    return static_cast<Z>(0);
  }

  op_def static Z op(X d1, X d2, X *params) { return op(d1, d2); }

  op_def static Z op(X d1, X *params) { return d1; }
};

template <typename X, typename Z>
class EqualTo {
 public:
  op_def static Z op(X d1, X d2) { return d1 == d2; }
...
class HardTanhDerivative {
 public:
  no_op_exec_special_same no_op_exec_special_same_cuda
      ...
      op_def static X
      op(X d1, X *params) {
    return ((d1 >= static_cast<X>(-1.f) && d1 <= static_cast<X>(1.f))
                ? static_cast<X>(1.f)
                : static_cast<X>(0.f));
  }
};
...
class RelativeError {
 public:
  ...
  op_def static Z op(X d1) { return static_cast<Z>(0); }
};
...
class BinaryRelativeError {
 public:
  no_op_exec_special no_op_exec_special_cuda
    ...
    return sd::math::nd4j_re<X>(d1, d2) > threshold ? static_cast<Z>(1)
                                                    : static_cast<Z>(0);
  }
...
class BinaryMinimumAbsoluteRelativeError {
 public:
  no_op_exec_special no_op_exec_special_cuda
    ...
    return sd::math::nd4j_re<X>(d1, d2) > thresholdRelative
               ? (sd::math::nd4j_abs<X>(d1 - static_cast<X>(d2)) <
                          thresholdAbsolute
                      ? static_cast<Z>(0)
                      : static_cast<Z>(1))
               : static_cast<Z>(0);
...
class ReversePow {
 public:
  ...
  op_def static Z op(X d1, Y d2) { return sd::math::nd4j_pow<X, Y, Z>(d2, d1); }
...
class Pow {
 public:
  ...
  op_def static Z op(X d1, Y d2) { return sd::math::nd4j_pow<X, Y, Z>(d1, d2); }
...
class PowDerivative {
 public:
  no_op_exec_special no_op_exec_special_cuda
      ...
      op_def static Z
      op(X d1, Z *params) {
    return params[0] * sd::math::nd4j_pow<X, Z, Z>(
                           d1, static_cast<Z>(params[0]) - static_cast<Z>(1.f));
  }

  op_def static Z op(X d1, Y d2) {
    return static_cast<Z>(d2) *
           sd::math::nd4j_pow<X, Z, Z>(
               d1, static_cast<Z>(d2) - static_cast<Z>(1.f));
  }
...
class IsNan {
 public:
  ...
  op_def static X startingValue(const X *input) { return static_cast<X>(0); }
...
class IsInfOrNan {
 public:
  ...
  op_def static Z merge(X old, X opOutput, X *extraParams) {
    return opOutput == static_cast<X>(0) && old == static_cast<X>(0)
               ? static_cast<Z>(0)
               : static_cast<Z>(1);
  }
...
class IsFinite {
 public:
  ...
  op_def static X startingValue(const X *input) { return static_cast<X>(1); }
 ...
 public:
  no_op_exec_special_same no_op_exec_special_same_cuda
    ...
    return (ex * (4 * (d1 + 1) + 4 * e2x + e3x + ex * (4 * d1 + 6))) /
           sd::math::nd4j_pow<X, X, X>((2 * ex + e2x + 2), (X)2.f);
  }
};
...
class PreciseGELU {
 public:
  no_op_exec_special_same no_op_exec_special_same_cuda
      ...
      op(X d1, X *params) {
    auto sp =
        sd::math::nd4j_sqrt<X, X>(static_cast<X>(2) / static_cast<X>(M_PI));
    auto xp = d1 + sd::math::nd4j_pow<X, X, X>(static_cast<X>(0.044715) * d1,
                                               static_cast<X>(3));
    return (d1 / static_cast<X>(2)) *
           (static_cast<X>(1) + sd::math::nd4j_tanh<X, X>(sp * xp));
  }
};
...
class GELUDerivative {
 public:
  no_op_exec_special_same no_op_exec_special_same_cuda
    ...
    return (ep * (static_cast<X>(1.f) + ep + x17)) /
           sd::math::nd4j_pow<X, int, X>((static_cast<X>(1.f) + ep), 2);
  }
};
...
class PreciseGELUDerivative {
 public:
  no_op_exec_special_same no_op_exec_special_same_cuda
    ...
    // 0.5 + (0.398942 x + 0.0535161 x^3) Sech[0.797885 x + 0.0356774 x^3]^2 +
    // 0.5 Tanh[0.797885 x + 0.0356774 x^3]
    return static_cast<X>(0.5) + (x39 + x05) * (scz * scz) +
           static_cast<X>(0.5) * sd::math::nd4j_tanh<X, X>(x79 + x03);
  }
};
 ...
 public:
  no_op_exec_special_same no_op_exec_special_same_cuda
    ...
    return (ex * (d1 + ex + static_cast<X>(1.f))) /
           sd::math::nd4j_pow<X, X, X>((ex + static_cast<X>(1.f)),
                                       static_cast<X>(2.f));
  }
};
...
class HardSigmoid {
 public:
  no_op_exec_special_same no_op_exec_special_same_cuda
      ...
      op_def static X
      op(X d1, X *params) {
    return sd::math::nd4j_min<X>(
        static_cast<X>(1),
        sd::math::nd4j_max<X>(static_cast<X>(0), (static_cast<X>(0.2f)) * d1 +
                                                     static_cast<X>(0.5f)));
  }
};
...
class HardSigmoidDerivative {
 public:
  no_op_exec_special_same no_op_exec_special_same_cuda
      ...
      op_def static X
      op(X d1, X *params) {
    return d1 < static_cast<X>(-2.5f) || d1 > static_cast<X>(2.5f)
               ? static_cast<X>(0.f)
               : static_cast<X>(0.2f);
  }
};
 ...
 public:
  no_op_exec_special_same no_op_exec_special_same_cuda
    ...
    if (min == static_cast<X>(0) && max == static_cast<X>(1)) {
      auto val = static_cast<X>(1) /
                 (static_cast<X>(1) + sd::math::nd4j_exp<X, X>(-d1));
...
class RationalTanh {
 public:
  no_op_exec_special_same no_op_exec_special_same_cuda
    ...
    auto tanh =
        sd::math::nd4j_sgn<X, X>(dis) *
        (static_cast<X>(1) -
         (static_cast<X>(1) /
          (static_cast<X>(1) + static_cast<X>(sd::math::nd4j_abs<X>(dis)) +
           sd::math::nd4j_pow<X, X, X>(dis, static_cast<X>(2)) +
           static_cast<X>(1.41645f) *
               sd::math::nd4j_pow<X, X, X>(dis, static_cast<X>(4)))));
...
class RationalTanhDerivative {
 public:
  no_op_exec_special_same no_op_exec_special_same_cuda
    ...
    auto a = static_cast<X>(1.f) + sd::math::nd4j_abs<X>(dis) +
             sd::math::nd4j_pow<X, X, X>(dis, static_cast<X>(2.f)) +
             static_cast<X>(1.41645f) *
                 sd::math::nd4j_pow<X, X, X>(dis, static_cast<X>(4));

    auto tDeriv =
        (static_cast<X>(1.f) +
         sd::math::nd4j_sign<X, X>(dis) *
             (static_cast<X>(2.f) * dis +
              static_cast<X>(4.f) * static_cast<X>(1.41645f) *
                  sd::math::nd4j_pow<X, X, X>(dis, static_cast<X>(3)))) /
        (a * a);

    return static_cast<X>(1.7159f) *
           (static_cast<X>(2.f) / static_cast<X>(3.f)) * tDeriv;
  }
};
...
class RectifiedTanh {
 public:
  no_op_exec_special_same no_op_exec_special_same_cuda
      ...
      op_def static X
      op(X d1, X *params) {
    return sd::math::nd4j_max<X>(static_cast<X>(0),
                                 sd::math::nd4j_tanh<X, X>(d1));
  }
};
...
class RectifiedTanhDerivative {
 public:
  no_op_exec_special_same no_op_exec_special_same_cuda
      ...
      op_def static X
      op(X d1, X *params) {
    return d1 > static_cast<X>(0.f) ? sd::math::nd4j_tanhderivative<X, X>(d1)
                                    : static_cast<X>(0.f);
  }
};
 ...
 public:
  no_op_exec_special_same no_op_exec_special_same_cuda
    ...
    return static_cast<X>(1.f) /
           (sd::math::nd4j_sqrt<X, X>(
               sd::math::nd4j_pow<X, X, X>(d1, static_cast<X>(2.f)) +
               static_cast<X>(1.f)));
  }
};
...
class ACoshDerivative {
 public:
  no_op_exec_special_same no_op_exec_special_same_cuda
      ...
      op(X d1, X *params) {
    return static_cast<X>(1.f) /
           (sd::math::nd4j_sqrt<X, X>(d1 - static_cast<X>(1.f)) *
            sd::math::nd4j_sqrt<X, X>(d1 + static_cast<X>(1.f)));
  }
};
  ...
  no_op_exec_special_same no_op_exec_special_same_cuda
    ...
    return d1 > static_cast<X>(0.0f)
               ...
               : static_cast<X>(SELU_LAMBDA) *
                     (static_cast<X>(SELU_ALPHA) *
                          sd::math::nd4j_exp<X, X>(d1) -
                      static_cast<X>(SELU_ALPHA));
  }
};
 ...
 public:
  no_op_exec_special_same no_op_exec_special_same_cuda
    ...
    return d1 > static_cast<X>(0.f)
               ? static_cast<X>(SELU_LAMBDA)
               : static_cast<X>(SELU_ALPHA) * static_cast<X>(SELU_LAMBDA) *
                     sd::math::nd4j_exp<X, X>(d1);
  }
};
...
class TanDerivative {
 public:
  no_op_exec_special_same no_op_exec_special_same_cuda
      ...
      op(X d1, X *params) {
    return static_cast<X>(1.f) /
           sd::math::nd4j_pow<X, X, X>(sd::math::nd4j_cos<X, X>(d1),
                                       static_cast<X>(2.0f));
  }
};
...
class Sum {
 public:
  ...
  op_def static X op(X d1, X *extraParams) { return d1; }
...
class ReduceSameBenchmarkOp {
 public:
  no_op_exec_special_accumulation_same no_op_exec_special_accumulation_same_cuda
      ...
      const static functions::ReduceType reduceType =
          functions::ReduceType::SUM;

  op_def static X startingValue(const X *input) { return static_cast<X>(0.0f); }
  ...
  op_def static X op(X d1, X *extraParams) {
    ...
    return static_cast<X>(
        sd::math::nd4j_pow<float, float, float>(f1, 3) +
        sd::math::nd4j_log<float, float>(f1) *
            sd::math::nd4j_sin<float, float>(f1) /
            sd::math::nd4j_tanh<float, float>(static_cast<float>(M_E) *
                                              static_cast<float>(M_PI) * f1) *
...
class ASum {
 public:
  ...
  op_def static X op(X d1, X *extraParams) { return sd::math::nd4j_abs<X>(d1); }
...
class CountNonZero {
 public:
  ...
  op_def static Z startingValue(const X *input) { return static_cast<Z>(0); }
  ...
  op_def static Z op(X d1, X *extraParams) {
    return d1 == static_cast<X>(0.0f) ? static_cast<Z>(0.0f)
                                      : static_cast<Z>(1.0f);
  }
...
class CountZero {
 public:
  ...
  op_def static Z startingValue(const X *input) { return static_cast<Z>(0.0f); }
...
class Any {
 public:
  ...
  op_def static Z op(X d1, X *extraParams) { return d1; }

  op_def static Z postProcess(X reduction, Nd4jLong n, X *extraParams) {
    return reduction > static_cast<X>(0) ? static_cast<Z>(1)
                                         : static_cast<Z>(0);
  }
};
...
class Mean {
 public:
  ...
  op_def static Z op(X d1, Z *extraParams) { return d1; }
...
class AMean {
 public:
  ...
  op_def static Z op(X d1, Z *extraParams) { return sd::math::nd4j_abs<X>(d1); }
...
class Max {
 public:
  ...
  op_def static X op(X d1, X d2) { return sd::math::nd4j_max<X>(d1, d2); }
...
class AMax {
 public:
  no_op_exec_special_accumulation_same no_op_exec_special_accumulation_same_cuda
      ...
      const static functions::ReduceType reduceType =
          functions::ReduceType::AMAX;

  op_def static X startingValue(const X *input) { return input[0]; }

  op_def static X merge(X old, X opOutput, X *extraParams) {
    return sd::math::nd4j_max<X>(sd::math::nd4j_abs<X>(old),
                                 sd::math::nd4j_abs<X>(opOutput));
  }

  op_def static X update(X old, X opOutput, X *extraParams) {
    return sd::math::nd4j_max<X>(sd::math::nd4j_abs<X>(opOutput),
                                 sd::math::nd4j_abs<X>(old));
  }

  op_def static X op(X d1, X d2, X *params) {
    return sd::math::nd4j_max<X>(sd::math::nd4j_abs<X>(d1),
                                 sd::math::nd4j_abs<X>(d2));
  }
...
class AMin {
 public:
  no_op_exec_special_accumulation_same no_op_exec_special_accumulation_same_cuda
      ...
      const static functions::ReduceType reduceType =
          functions::ReduceType::AMIN;

  op_def static X startingValue(const X *input) { return input[0]; }

  op_def static X merge(X old, X opOutput, X *extraParams) {
    return sd::math::nd4j_min<X>(sd::math::nd4j_abs<X>(old),
                                 sd::math::nd4j_abs<X>(opOutput));
  }

  op_def static X update(X old, X opOutput, X *extraParams) {
    return sd::math::nd4j_min<X>(sd::math::nd4j_abs<X>(opOutput),
                                 sd::math::nd4j_abs<X>(old));
  }

  op_def static X op(X d1, X d2, X *params) {
    return sd::math::nd4j_min<X>(sd::math::nd4j_abs<X>(d1),
                                 sd::math::nd4j_abs<X>(d2));
  }
...
class Min {
 public:
  ...
  op_def static X op(X d1, X d2) { return sd::math::nd4j_min<X>(d1, d2); }
...
class Norm2 {
 public:
  ...
  op_def static Z op(X d1, Z *extraParams) { return static_cast<Z>(d1 * d1); }
};
...
class NormP {
 public:
  ...
  op_def static Z op(X d1, Z *extraParams) {
    return sd::math::nd4j_pow<X, Z, Z>(sd::math::nd4j_abs<X>(d1),
                                       extraParams[0]);
  }

  op_def static Z postProcess(Z reduction, Nd4jLong n, Z *extraParams) {
    return sd::math::nd4j_pow<Z, Z, Z>(reduction,
                                       static_cast<Z>(1.0f) / extraParams[0]);
  }
};
...
class NormMax {
 public:
  ...
  op_def static Z op(X d1, Z *extraParams) { return static_cast<Z>(d1); }

  op_def static Z postProcess(Z reduction, Nd4jLong n, Z *extraParams) {
    return sd::math::nd4j_max<Z>(sd::math::nd4j_abs<Z>(reduction),
                                 sd::math::nd4j_abs<Z>(reduction));
  }
};
...
class Variance {
 public:
  ...
  op_def static Z postProcess(X reduction, Nd4jLong n, Z *extraParams) {
    ...
    // return (reduction - (sd::math::nd4j_pow<T>(bias, static_cast<T>(2.0f)) /
    // static_cast<T>(n))) / (n - 1)
...
class CosineSimilarity {
 public:
  ...
  op_def static Y startingValue(const X *input) { return static_cast<Y>(0.0f); }

  op_def static Y postProcess(Y reduction, Nd4jLong n, Y *extraParams) {
    return reduction / (sd::math::nd4j_sqrt<Y, Y>(extraParams[0]) *
                        sd::math::nd4j_sqrt<Y, Y>(extraParams[1]));
  }
  ...
  op_def static void aggregateExtraParams(Y *extraParamsTotal,
                                          Y *extraParamsLocal) {
...
class JaccardDistance {
 public:
  ...
  op_def static Y startingValue(const X *input) { return static_cast<X>(0.0f); }
  ...
  op_def static Y num(X d1, X d2) { return sd::math::nd4j_min<X>(d1, d2); }

  op_def static Y denom(X d1, X d2) { return sd::math::nd4j_max<X>(d1, d2); }
...
#ifdef __CUDACC__
  __device__ static inline Y opAtomic(X d1, X d2, Y *extraParams) {
 ...
 public:
  ...
  op_def static Y postProcess(Y reduction, Nd4jLong n, Y *extraParams) {
    return (static_cast<Y>(1.0f)) -
           (reduction / (sd::math::nd4j_sqrt<Y, Y>(extraParams[0]) *
                         sd::math::nd4j_sqrt<Y, Y>(extraParams[1])));
  }

  op_def static Y op(X d1, X d2, Y *extraParams) {
    extraParams[0] +=
        static_cast<Y>(sd::math::nd4j_abs<X>(d1) * sd::math::nd4j_abs<X>(d1));
    extraParams[1] +=
        static_cast<Y>(sd::math::nd4j_abs<X>(d2) * sd::math::nd4j_abs<X>(d2));
    return (d1 * d2);
  }
...
#ifdef __CUDACC__
  static _CUDA_D inline Y opAtomic(X d1, X d2, Y *extraParams) {
    sd::math::atomics::nd4j_atomicAdd(
        &extraParams[0], sd::math::nd4j_abs<Y>(d1) * sd::math::nd4j_abs<Y>(d1));
    sd::math::atomics::nd4j_atomicAdd(
        &extraParams[1], sd::math::nd4j_abs<Y>(d2) * sd::math::nd4j_abs<Y>(d2));
...
class Dot {
 public:
  ...
  op_def static X *generateExtraParams() { return nullptr; }
...
#ifdef __CUDACC__
  __device__ static inline Y opAtomic(X d1, X d2, Y *extraParamsRef) {
...
class EqualsWithEps {
 public:
...
#ifdef __CUDACC__
  __device__ static inline Z opAtomic(X d1, X d2, Z *extraParamsRef) {
    return op(d1, d2, extraParamsRef);
  }
#endif
  ...
  op_def static void aggregateExtraParams(Z *extraParamsTotal,
                                          Z *extraParamsLocal) {}
};
...
class IndexAbsoluteMax {
 public:
  ...
  static _CUDA_HD inline functions::indexreduce::IndexValue<X> update(
  ...
  static _CUDA_HD inline X startingValue(const X *input) { return 0; }

  static _CUDA_HD inline functions::indexreduce::IndexValue<X>
  startingIndexValue(const X *input) {
  ...
  static _CUDA_HD inline functions::indexreduce::IndexValue<X> op(
      functions::indexreduce::IndexValue<X> d1,
...
class FirstIndex {
 public:
  ...
  static _CUDA_HD functions::indexreduce::IndexValue<X> update(
      functions::indexreduce::IndexValue<X> &old,
      functions::indexreduce::IndexValue<X> &opOutput, X *extraParams) {
#ifdef __CUDACC__
...
class SummaryStatsVariance {
 public:
  static _CUDA_HD inline Z getValue(
      const bool biasCorrected,
      functions::summarystats::SummaryStatsData<X> val) {
    if (biasCorrected) {
  ...
  static _CUDA_HD inline functions::summarystats::SummaryStatsData<X> op(
...
class DropOut {
 public:
  no_op_exec_special_same no_op_exec_special_same_cuda
    ...
    X rnd = sd::math::nd4j_abs<X>(
        sd::math::nd4j_cos<X>(static_cast<X>(clock64()) * static_cast<X>(tid) +
...
class DropOutInverted {
 public:
  no_op_exec_special no_op_exec_special_cuda
    ...
    X rnd = static_cast<X>(rand() / RAND_MAX);
#endif
    return rnd >= static_cast<X>(prob)
               ? static_cast<Z>(0.0f)
               : reinterpret_cast<Z>(d1 / static_cast<X>(prob));
  }
};
...
class CompareAndSetTransform {
 public:
  no_op_exec_special_same no_op_exec_special_same_cuda
    ...
    // with mode == 0 we do set if d1 equals to compare, and with mode == 1 - we
    // go otherwise
    int mode = (int)params[3];
    if (mode == 0)  // equals
