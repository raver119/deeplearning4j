...
void TransformBool<X, Y>::exec(int opNum, const void *x,
...
void _CUDA_H TransformBool<X, Z>::exec(const void *vx,
  ...
  sd::TransformLoops<X, Z, X>::template loopTransform<OpType>(
