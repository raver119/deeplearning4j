...
template <typename X>
void PairWiseIntTransform<X>::exec(const int opNum, const void *x,
                                   Nd4jLong xEws, const void *y, Nd4jLong yEws,
                                   void *z, Nd4jLong zEws, void *extraParams,
                                   Nd4jLong n, const uint64_t start,
                                   const uint64_t stop) {
  DISPATCH_BY_OPNUM_T(
...
void PairWiseIntTransform<X>::exec(const int opNum, const void *x,
                                   ...
                                   void *extraParams, const uint64_t start,
                                   const uint64_t stop) {
...
void PairWiseIntTransform<X>::exec(const void *vx, const Nd4jLong *xShapeInfo,
                                   ...
                                   void *vextraParams, const uint64_t start,
                                   const uint64_t stop) {
  auto x = reinterpret_cast<const X *>(vx);
  auto y = reinterpret_cast<const X *>(vy);
  auto z = reinterpret_cast<X *>(vz);
...
BUILD_SINGLE_TEMPLATE(template class SD_EXPORT PairWiseIntTransform, ,
                      INTEGER_TYPES);
}  // namespace pairwise_transforms
}  // namespace functions
