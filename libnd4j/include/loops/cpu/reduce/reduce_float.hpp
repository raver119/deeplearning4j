...
void _CUDA_H ReduceFloatFunction<X, Z>::execScalar(const void *vx,
...
template <typename X, typename Z>
template <typename OpType>
Z _CUDA_H ReduceFloatFunction<X, Z>::execScalar(const void *vx,
                                                const Nd4jLong *xShapeInfo,
                                                void *vextraParams) {
  auto x = reinterpret_cast<const X *>(vx);
  auto extraParams = reinterpret_cast<Z *>(vextraParams);
...
Y ReduceFloatFunction<X, Y>::execScalar(const int opNum, const void *x,
                                        const Nd4jLong *xShapeInfo,
                                        void *extraParams) {
...
template <typename X, typename Y>
void ReduceFloatFunction<X, Y>::execScalar(const int opNum, const void *x,
                                           const Nd4jLong *xShapeInfo,
...
template <typename X, typename Y>
void ReduceFloatFunction<X, Y>::exec(
...
template <typename X, typename Z>
template <typename OpType>
void _CUDA_H ReduceFloatFunction<X, Z>::exec(
...
#ifdef INLINE_LOOPS
  sd::ReductionLoops<X, Z, Z>::template loopReduce<OpType>(
      x, xShapeInfo, z, zShapeInfo, tadOnlyShapeInfo, tadOffsets, extraParams,
      start, stop);
#else
  sd::ReductionFloatLoops<X, Z>::template innerloopReduce<OpType>(
      x, xShapeInfo, z, zShapeInfo, tadOnlyShapeInfo, tadOffsets, extraParams,
      start, stop);
#endif
}
...
template <typename X, typename Z>
template <typename OpType>
void _CUDA_H ReduceFloatFunction<X, Z>::exec(const void *x,
                                             const Nd4jLong *xShapeInfo,
...
template <typename X, typename Z>
template <typename OpType>
Z _CUDA_H ReduceFloatFunction<X, Z>::execScalar(const void *vx, Nd4jLong xEws,
                                                Nd4jLong length,
                                                void *vextraParams) {
  auto x = reinterpret_cast<const X *>(vx);
  auto extraParams = reinterpret_cast<Z *>(vextraParams);
