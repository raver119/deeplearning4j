  ...
  switch (op) {
    ...
    default:
      throw std::runtime_error(
          "fromBroadcastToPairwise: Not convertible operation");
  }
}
...
inline pairwise::BoolOps fromBroadcastToPairwiseBool(broadcast::BoolOps op) {
  switch (op) {
    ...
    default:
      throw std::runtime_error(
          "fromBroadcastToPairwiseBool: Not convertible operation");
  }
}
...
inline pairwise::IntOps fromBroadcastToPairwiseInt(broadcast::IntOps op) {
  switch (op) {
    ...
    default:
      throw std::runtime_error(
          "fromBroadcastToPairwiseInt: Not convertible operation");
  }
}
}  // namespace sd
