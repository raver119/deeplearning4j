...
__global__ void transformBoolSimple(const void *x, const Nd4jLong *xShapeInfo,
...
_CUDA_H void TransformBool<X, Z>::intermediateShaped(
    ...
    void *reductionPointer, const Nd4jLong *tadShapeInfo,
    const Nd4jLong *tadOffsets) {
  transformBoolSimple<X, Z, OpType>
...
BUILD_DOUBLE_TEMPLATE(template class SD_EXPORT TransformBool, , LIBND4J_TYPES,
                      BOOL_TYPES);
}  // namespace transform
}  // namespace functions
