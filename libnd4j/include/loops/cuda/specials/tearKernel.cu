...
////////////////////////////////////////////////////////////////////////
template <typename T>
__device__ void tearKernel(void* vx, Nd4jLong const* xShapeInfo,
...
////////////////////////////////////////////////////////////////////////
template <typename T>
__global__ void execTearKernel(void* vx, Nd4jLong const* xShapeInfo,
                               Nd4jPointer* targets, Nd4jLong const* zShapeInfo,
                               Nd4jLong const* tadShapeInfo,
                               Nd4jLong const* tadOffsets) {
...
BUILD_SINGLE_TEMPLATE(template void SD_EXPORT tearKernelGeneric,
                      (dim3 & launchDims, cudaStream_t* stream, void* vx,
                       Nd4jLong const* xShapeInfo, Nd4jPointer* targets,
                       Nd4jLong const* zShapeInfo, Nd4jLong const* tadShapeInfo,
                       Nd4jLong const* tadOffsets),
                      LIBND4J_TYPES);
}  // namespace sd