...
///////////////////////////////////////////////////////////////////////
    ...
    BUILD_SINGLE_TEMPLATE(template void SD_EXPORT accumulateKernelGeneric, (dim3 & launchDims, cudaStream_t * stream, void * *vx, void * vz, int n, const Nd4jLong length), LIBND4J_TYPES);
}