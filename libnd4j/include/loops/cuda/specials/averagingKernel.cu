...
///////////////////////////////////////////////////////////////////////
template <typename T>
__device__ void averagingKernel(void **vdx, void *vdz, int n, Nd4jLong length,
                                bool propagate) {
...
///////////////////////////////////////////////////////////////////////
template <typename T>
__global__ void execAveragingKernel(void **vdx, void *vdz, int n,
...
///////////////////////////////////////////////////////////////////////
template <typename T>
__host__ void averagingKernelGeneric(dim3 &launchDims, cudaStream_t *stream,
...
BUILD_SINGLE_TEMPLATE(template void SD_EXPORT averagingKernelGeneric,
                      (dim3 & launchDims, cudaStream_t *stream, void **vdx,
                       void *vdz, int n, Nd4jLong length, bool propagate),
                      LIBND4J_TYPES);
}  // namespace sd