...
static __global__ void broadcastBoolSimple(
    void const* x, Nd4jLong const* xShapeInfo, void const* y,
    Nd4jLong const* yShapeInfo, void* z, Nd4jLong const* zShapeInfo,
  ...
  functions::broadcast::BroadcastBool<X, Z>::template transformCuda<OpClass>(
      x, xShapeInfo, y, yShapeInfo, z, zShapeInfo, extraParams, dimension,
...
template <typename X, typename Z, typename OpClass>
static __global__ void broadcastBoolSimple(
    const void const* x, const Nd4jLong const* xShapeInfo, const void const* y,
    const Nd4jLong const* yShapeInfo, void* z, const Nd4jLong const* zShapeInfo,
    void* extraParams) {
  functions::broadcast::BroadcastBool<X, Z>::template transformCuda<OpClass>(
...
static __global__ void broadcastBoolInverseSimple(
    ...
    Nd4jLong const* tadOnlyShapeInfo, Nd4jLong const* tadOffsets,
    Nd4jLong const* tadOnlyShapeInfoZ, Nd4jLong const* tadOffsetsZ) {
  functions::broadcast::BroadcastBool<X, Z>::template transformInverseCuda<
      OpClass>(x, xShapeInfo, y, yShapeInfo, z, zShapeInfo, extraParams,
...
__host__ void BroadcastBool<X, Z>::intermediateBroadcast(
    dim3 launchDims, cudaStream_t* stream, void const* x,
    Nd4jLong const* xShapeInfo, void const* y, Nd4jLong const* yShapeInfo,
    void* z, Nd4jLong const* zShapeInfo, void* extraParams, int* dimension,
  ...
  sd::DebugHelper::checkErrorCode(stream,
                                  "intermediateBroadcastBool(...) failed");
}
...
__host__ void BroadcastBool<X, Z>::intermediateBroadcast(
    ...
    const Nd4jLong* xShapeInfo, const void* y, const Nd4jLong* yShapeInfo,
    void* z, const Nd4jLong* zShapeInfo, void* extraParams) {
  broadcastBoolSimple<X, Z, OpClass>
      <<<launchDims.x, launchDims.y, launchDims.z, *stream>>>(
          x, xShapeInfo, y, yShapeInfo, z, zShapeInfo, extraParams);
  sd::DebugHelper::checkErrorCode(stream,
...
__host__ void BroadcastBool<X, Y>::execBroadcast(
...
__host__ void BroadcastBool<X, Y>::execBroadcast(
  ...
  DISPATCH_BY_OPNUM_TT(intermediateBroadcast,
                       PARAMS(launchDims, stream, x, xShapeInfo, y, yShapeInfo,
...
//////////////////////////////////////////////////////////////////////////
template <typename X, typename Y>
__host__ void BroadcastBool<X, Y>::execInverseBroadcast(
    dim3 launchDims, cudaStream_t* stream, int opNum, void const* x,
    Nd4jLong const* xShapeInfo, void const* y, Nd4jLong const* yShapeInfo,
    void* z, Nd4jLong const* zShapeInfo, void* extraParams, int* dimension,
    int dimensionLength, Nd4jLong const* tadOnlyShapeInfo,
...
__device__ void BroadcastBool<X, Z>::transformInverseCuda(
    void const* vx, Nd4jLong const* xShapeInfo, void const* vy,
    Nd4jLong const* yShapeInfo, void* vz, Nd4jLong const* zShapeInfo,
...
BUILD_DOUBLE_TEMPLATE(template class SD_EXPORT BroadcastBool, , LIBND4J_TYPES,
                      BOOL_TYPES);
}  // namespace broadcast
}  // namespace functions