...
class ReduceSameFunction {
 public:
  ...
  template <typename OpType>
  static __device__ void execScalarCuda(void const* vx,
  ...
  static __device__ void execScalarCudaLegacy(int opNum, void const* vx,
                                              Nd4jLong const* xShapeInfo,
                                              void* extraParams, void* vz,
                                              Nd4jLong const* zShapeInfo,
                                              void* reductionBuffer,
  ...
  static __device__ void transformCudaXD(
      void const* vx, Nd4jLong const* xShapeInfo, void* extraParams, void* vz,
  ...
  static __host__ void intermediateXD(
      ...
      void* extraParams, void* vz, Nd4jLong const* zShapeInfo,
      Nd4jLong const* hZShapeInfo, int* dimension, int dimensionLength,
      void* reductionPointer, Nd4jLong const* tadShapeInfo,
      Nd4jLong const* tadOffsets);
  ...
  static __host__ void execReduceXD(
      ...
      void const* vx, Nd4jLong const* xShapeInfo, Nd4jLong const* hXShapeInfo,
      void* extraParams, void* vz, Nd4jLong const* zShapeInfo,
      Nd4jLong const* hZShapeInfo, int* dimension, int dimensionLength,
      void* reductionPointer, Nd4jLong const* tadShapeInfo,
      Nd4jLong const* tadOffsets);
  ...
  static X execScalar(int opNum, const void *x, const Nd4jLong *xShapeInfo,
                      void *extraParams);
