 ...
 * @param extraParams
 */
void execIndexReduceScalar(Nd4jPointer *extraPointers, int opNum,
                           OpaqueDataBuffer *dbX, const Nd4jLong *hXShapeInfo,
                           const Nd4jLong *dXShapeInfo, void *extraParams,
                           OpaqueDataBuffer *dbZ, const Nd4jLong *hZShapeInfo,
                           const Nd4jLong *dZShapeInfo) {
  try {
    NativeOpExecutioner::execIndexReduceScalar(
        nullptr, opNum, dbX->primary(), hXShapeInfo, dbX->special(),
...
void execIndexReduce(Nd4jPointer *extraPointers, int opNum,
                     ...
                     const Nd4jLong *dXShapeInfo, void *extraParams,
                     OpaqueDataBuffer *dbZ, const Nd4jLong *hZShapeInfo,
                     const Nd4jLong *dZShapeInfo, OpaqueDataBuffer *dbDimension,
                     const Nd4jLong *hDimensionShape,
                     const Nd4jLong *dDimensionShape) {
  try {
    ...
    NativeOpExecutioner::execIndexReduce(
        nullptr, opNum, dbX->primary(), hXShapeInfo, dbX->special(),
        dXShapeInfo, extraParams, hz, hZShapeInfo, dbZ->special(), dZShapeInfo,
        dimension, dimensionLength, hTADShapeInfo, hTADOffsets);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
        e.what());
 ...
 * @param dimensionLength
 */
void execBroadcast(Nd4jPointer *extraPointers, int opNum, OpaqueDataBuffer *dbX,
                   const Nd4jLong *hXShapeInfo, const Nd4jLong *dXShapeInfo,
                   OpaqueDataBuffer *dbY, const Nd4jLong *hYShapeInfo,
                   const Nd4jLong *dYShapeInfo, OpaqueDataBuffer *dbZ,
                   const Nd4jLong *hZShapeInfo, const Nd4jLong *dZShapeInfo,
  ...
  try {
    ...
    auto tadPackZ = sd::ConstantTadHelper::getInstance().tadForDimensions(
        hZShapeInfo, dimension, dimensionLength);
    ...
    NativeOpExecutioner::execBroadcast(
        nullptr, opNum, dbX->primary(), hXShapeInfo, dbX->special(),
        dXShapeInfo, dbY->primary(), hYShapeInfo, dbY->special(), dYShapeInfo,
...
void execBroadcastBool(Nd4jPointer *extraPointers, int opNum,
                       OpaqueDataBuffer *dbX, const Nd4jLong *hXShapeInfo,
                       const Nd4jLong *dXShapeInfo, OpaqueDataBuffer *dbY,
                       const Nd4jLong *hYShapeInfo, const Nd4jLong *dYShapeInfo,
                       OpaqueDataBuffer *dbZ, const Nd4jLong *hZShapeInfo,
                       const Nd4jLong *dZShapeInfo, void *extraParams,
                       OpaqueDataBuffer *dbDimension,
                       const Nd4jLong *hDimensionShape,
                       const Nd4jLong *dDimensionShape) {
  try {
    ...
    NativeOpExecutioner::execBroadcastBool(
        ...
        dimension, dimensionLength, hTADShapeInfo, hTADOffsets, hTADShapeInfoZ,
        hTADOffsetsZ);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
 ...
 * @param n
 */
void execPairwiseTransform(Nd4jPointer *extraPointers, int opNum,
                           OpaqueDataBuffer *dbX, const Nd4jLong *hXShapeInfo,
                           const Nd4jLong *dXShapeInfo, OpaqueDataBuffer *dbY,
                           const Nd4jLong *hYShapeInfo,
                           const Nd4jLong *dYShapeInfo, OpaqueDataBuffer *dbZ,
                           const Nd4jLong *hZShapeInfo,
                           const Nd4jLong *dZShapeInfo, void *extraParams) {
  try {
...
void execReduceSame(Nd4jPointer *extraPointers, int opNum,
                    OpaqueDataBuffer *dbX, const Nd4jLong *hXShapeInfo,
                    const Nd4jLong *dXShapeInfo, void *extraParams,
                    OpaqueDataBuffer *dbZ, const Nd4jLong *hZShapeInfo,
                    const Nd4jLong *dZShapeInfo) {
...
void execReduceBool(Nd4jPointer *extraPointers, int opNum,
                    OpaqueDataBuffer *dbX, const Nd4jLong *hXShapeInfo,
                    const Nd4jLong *dXShapeInfo, void *extraParams,
                    OpaqueDataBuffer *dbZ, const Nd4jLong *hZShapeInfo,
                    const Nd4jLong *dZShapeInfo) {
...
void execReduceLong(Nd4jPointer *extraPointers, int opNum,
                    OpaqueDataBuffer *dbX, const Nd4jLong *hXShapeInfo,
                    const Nd4jLong *dXShapeInfo, void *extraParams,
                    OpaqueDataBuffer *dbZ, const Nd4jLong *hZShapeInfo,
                    const Nd4jLong *dZShapeInfo) {
 ...
 * @param hZShapeInfo
 */
void execReduceFloat2(Nd4jPointer *extraPointers, int opNum,
                      OpaqueDataBuffer *dbX, const Nd4jLong *hXShapeInfo,
                      const Nd4jLong *dXShapeInfo, void *extraParams,
                      OpaqueDataBuffer *dbZ, const Nd4jLong *hZShapeInfo,
                      const Nd4jLong *dZShapeInfo,
  ...
  try {
    ...
    NativeOpExecutioner::execReduceFloat(
        nullptr, opNum, dbX->primary(), hXShapeInfo, dbX->special(),
        dXShapeInfo, extraParams, dbZ->primary(), hZShapeInfo, dbZ->special(),
        dZShapeInfo, dimension, dimensionLength, hTADShapeInfo, hTADOffsets);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
        e.what());
...
void execReduceBool2(Nd4jPointer *extraPointers, int opNum,
                     OpaqueDataBuffer *dbX, const Nd4jLong *hXShapeInfo,
                     const Nd4jLong *dXShapeInfo, void *extraParams,
                     OpaqueDataBuffer *dbZ, const Nd4jLong *hZShapeInfo,
                     const Nd4jLong *dZShapeInfo, OpaqueDataBuffer *dbDimension,
...
void execReduceSame2(Nd4jPointer *extraPointers, int opNum,
                     OpaqueDataBuffer *dbX, const Nd4jLong *hXShapeInfo,
                     const Nd4jLong *dXShapeInfo, void *extraParams,
                     OpaqueDataBuffer *dbZ, const Nd4jLong *hZShapeInfo,
                     const Nd4jLong *dZShapeInfo, OpaqueDataBuffer *dbDimension,
...
void execReduceLong2(Nd4jPointer *extraPointers, int opNum,
                     OpaqueDataBuffer *dbX, const Nd4jLong *hXShapeInfo,
                     const Nd4jLong *dXShapeInfo, void *extraParams,
                     OpaqueDataBuffer *dbZ, const Nd4jLong *hZShapeInfo,
                     const Nd4jLong *dZShapeInfo, OpaqueDataBuffer *dbDimension,
 ...
 * @param hZShapeInfo
 */
void execReduce3(Nd4jPointer *extraPointers, int opNum, OpaqueDataBuffer *dbX,
                 const Nd4jLong *hXShapeInfo, const Nd4jLong *dXShapeInfo,
                 void *extraParams, OpaqueDataBuffer *dbY,
                 const Nd4jLong *hYShapeInfo, const Nd4jLong *dYShapeInfo,
                 OpaqueDataBuffer *dbZ, const Nd4jLong *hZShapeInfo,
                 const Nd4jLong *dZShapeInfo) {
  try {
    NativeOpExecutioner::execReduce3(
        nullptr, opNum, dbX->primary(), hXShapeInfo, dbX->special(),
        dXShapeInfo, extraParams, dbY->primary(), hYShapeInfo, dbY->special(),
...
void execReduce3Tad(
    Nd4jPointer *extraPointers, int opNum, OpaqueDataBuffer *dbX,
    const Nd4jLong *hXShapeInfo, const Nd4jLong *dXShapeInfo, void *extraParams,
    OpaqueDataBuffer *dbY, const Nd4jLong *hYShapeInfo,
    const Nd4jLong *dYShapeInfo, OpaqueDataBuffer *dbZ,
    const Nd4jLong *hZShapeInfo, const Nd4jLong *dZShapeInfo,
    OpaqueDataBuffer *dbDimension, const Nd4jLong *hDimensionShape,
    const Nd4jLong *dDimensionShape, const Nd4jLong *tadOnlyShapeInfo,
    const Nd4jLong *tadOffsets, const Nd4jLong *yTadOnlyShapeInfo,
    const Nd4jLong *yTadOffsets) {
  try {
    auto dimension = reinterpret_cast<int *>(dbDimension->primary());
    auto dimensionLength = static_cast<int>(shape::length(hDimensionShape));
    ...
    if (extraPointers == nullptr || extraPointers[2] == 0) {
      NativeOpExecutioner::execReduce3(
          LaunchContext::defaultContext(), opNum, dbX->primary(), hXShapeInfo,
          dbX->special(), dXShapeInfo, extraParams, dbY->primary(), hYShapeInfo,
          dbY->special(), dYShapeInfo, dbZ->primary(), hZShapeInfo,
          dbZ->special(), dZShapeInfo, dimension, dimensionLength,
 ...
 * @param n
 */
void execScalar(Nd4jPointer *extraPointers, int opNum, OpaqueDataBuffer *dbX,
                const Nd4jLong *hXShapeInfo, const Nd4jLong *dXShapeInfo,
                OpaqueDataBuffer *dbZ, const Nd4jLong *hZShapeInfo,
                const Nd4jLong *dZShapeInfo, OpaqueDataBuffer *dbScalar,
                const Nd4jLong *hScalarShapeInfo,
                const Nd4jLong *dScalarShapeInfo, void *extraParams) {
  try {
    NativeOpExecutioner::execScalar(
        nullptr, opNum, dbX->primary(), hXShapeInfo, dbX->special(),
        dXShapeInfo, dbZ->primary(), hZShapeInfo, dbZ->special(), dZShapeInfo,
        dbScalar->primary(), hScalarShapeInfo, dbScalar->special(),
        dScalarShapeInfo, extraParams);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
        e.what());
...
void execScalarBool(Nd4jPointer *extraPointers, int opNum,
                    OpaqueDataBuffer *dbX, const Nd4jLong *hXShapeInfo,
                    const Nd4jLong *dXShapeInfo, OpaqueDataBuffer *dbZ,
                    const Nd4jLong *hZShapeInfo, const Nd4jLong *dZShapeInfo,
 ...
 * @param extraParams
 */
void execSummaryStatsScalar(Nd4jPointer *extraPointers, int opNum,
                            OpaqueDataBuffer *dbX, const Nd4jLong *hXShapeInfo,
                            const Nd4jLong *dXShapeInfo, void *extraParams,
                            OpaqueDataBuffer *dbZ, const Nd4jLong *hZShapeInfo,
                            const Nd4jLong *dZShapeInfo, bool biasCorrected) {
  try {
 ...
 * @param hZShapeInfo
 */
void execSummaryStats(Nd4jPointer *extraPointers, int opNum,
                      OpaqueDataBuffer *dbX, const Nd4jLong *hXShapeInfo,
                      const Nd4jLong *dXShapeInfo, void *extraParams,
                      OpaqueDataBuffer *dbZ, const Nd4jLong *hZShapeInfo,
                      const Nd4jLong *dZShapeInfo, bool biasCorrected) {
 ...
 * @param dimensionLength
 */
void execSummaryStatsTad(Nd4jPointer *extraPointers, int opNum,
                         OpaqueDataBuffer *dbX, const Nd4jLong *hXShapeInfo,
                         const Nd4jLong *dXShapeInfo, void *extraParams,
                         OpaqueDataBuffer *dbZ, const Nd4jLong *hZShapeInfo,
                         const Nd4jLong *dZShapeInfo,
                         OpaqueDataBuffer *dbDimension,
                         const Nd4jLong *hDimensionShape,
                         const Nd4jLong *dDimensionShape, bool biasCorrected,
  ...
  try {
    ...
    NativeOpExecutioner::execSummaryStats(
        nullptr, opNum, dbX->primary(), hXShapeInfo, dbX->special(),
        dXShapeInfo, extraParams, dbZ->primary(), hZShapeInfo, dbZ->special(),
        dZShapeInfo, dimension, dimensionLength, tadShapeInfo, tadOffsets,
        biasCorrected);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
...
void execReduce3All(Nd4jPointer *extraPointers, int opNum,
                    OpaqueDataBuffer *dbX, const Nd4jLong *hXShapeInfo,
                    const Nd4jLong *dXShapeInfo, void *extraParamsVals,
                    OpaqueDataBuffer *dbY, const Nd4jLong *hYShapeInfo,
                    const Nd4jLong *dYShapeInfo, OpaqueDataBuffer *dbZ,
                    const Nd4jLong *hZShapeInfo, const Nd4jLong *dZShapeInfo,
                    OpaqueDataBuffer *dbDimension,
  ...
  try {
    ...
    NativeOpExecutioner::execReduce3All(
        nullptr, opNum, dbX->primary(), hXShapeInfo, dbX->special(),
        dXShapeInfo, extraParamsVals, dbY->primary(), hYShapeInfo,
        dbY->special(), dYShapeInfo, dbZ->primary(), hZShapeInfo,
        dbZ->special(), dZShapeInfo, dimension, dimensionLength, xTadShapeInfo,
 ...
 */
void specialConcat(Nd4jPointer *extraPointers, int dimension, int numArrays,
                   Nd4jPointer *data, Nd4jPointer *inputShapeInfo, void *hZ,
                   Nd4jLong const *hZShapeInfo, Nd4jPointer *tadPointers,
                   Nd4jPointer *offsetPointers) {
  try {
    auto zType = sd::ArrayOptions::dataType(hZShapeInfo);

    BUILD_SINGLE_SELECTOR(zType, sd::SpecialMethods,
                          ::concatCpuGeneric(dimension, numArrays, data,
                                             inputShapeInfo, hZ, hZShapeInfo),
                          LIBND4J_TYPES);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
 ...
 * Since we'll use this from java, jni compiler would like to have method no
 * matter what.
 */
 ...
 *
 * PLEASE NOTE: This method is NOT supported and has NO effect in CPU-based
 * backend.
 *
 * @param pointer pointer that'll be used for allocation
 * @param memorySize memory size, in bytes
...
Nd4jPointer createContext() { return 0L; }

Nd4jPointer createStream() { return 0L; }

Nd4jPointer createEvent() { return 0L; }

int getDeviceMajor(int deviceId) { return 0; }

int getDeviceMinor(int deviceId) { return 0; }

int registerEvent(Nd4jPointer event, Nd4jPointer stream) { return 0L; }

int setDevice(int deviceId) { return 0L; }

Nd4jLong getDeviceFreeMemory(int deviceId) { return 0L; }

Nd4jLong getDeviceFreeMemoryDefault() { return 0L; }

Nd4jLong getDeviceTotalMemory(int deviceId) { return 0L; }

int memcpySync(Nd4jPointer dst, Nd4jPointer src, Nd4jLong size, int flags,
               Nd4jPointer reserved) {
  return 0L;
}

int memcpyAsync(Nd4jPointer dst, Nd4jPointer src, Nd4jLong size, int flags,
                Nd4jPointer reserved) {
  return 0L;
}

int memsetSync(Nd4jPointer dst, int value, Nd4jLong size, int flags,
               Nd4jPointer reserved) {
  return 0L;
}

int memsetAsync(Nd4jPointer dst, int value, Nd4jLong size, int flags,
                Nd4jPointer reserved) {
  return 0L;
}

int destroyEvent(Nd4jPointer event) { return 0L; }

int streamSynchronize(Nd4jPointer stream) { return 0L; }

int eventSynchronize(Nd4jPointer event) { return 0L; }
...
sd::TadPack *tadOnlyShapeInfo(Nd4jLong const *hXShapeInfo, int *dimension,
                              int dimensionLength) {
  auto pack = new TadPack();
  try {
    *pack = sd::ConstantTadHelper::getInstance().tadForDimensions(
        hXShapeInfo, dimension, dimensionLength);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
...
Nd4jLong getNumberOfTads(sd::TadPack *pack) { return pack->numberOfTads(); }

int getShapeInfoLength(sd::TadPack *pack) { return pack->shapeInfoLength(); }

int memcpyConstantAsync(Nd4jLong dst, Nd4jPointer src, Nd4jLong size, int flags,
                        Nd4jPointer reserved) {
  // no-op
  return 0L;
}
...
template <typename T>
void pullRowsGeneric(void *vx, Nd4jLong const *hXShapeInfo, void *vz,
                     Nd4jLong const *hZShapeInfo, const int n,
                     Nd4jLong const *indexes, Nd4jLong const *tadShapeInfo,
                     Nd4jLong const *tadOffsets, Nd4jLong const *zTadShapeInfo,
  ...
  auto func = PRAGMA_THREADS_FOR {
    for (auto idx = start; idx < stop; idx++) {
      ...
      if (xEWS == 1 && zEWS == 1) {
        ...
        for (Nd4jLong i = 0; i < tadLength; i++) {
          auto xOffset =
              xTadOffsetForBlock + shape::getIndexOffset(i, tadShapeInfo);
          auto zOffset =
              zTadOffsetForBlock + shape::getIndexOffset(i, zTadShapeInfo);
...
void pullRows(Nd4jPointer *extraPointers, OpaqueDataBuffer *dbX,
              Nd4jLong const *hXShapeInfo, Nd4jLong const *dXShapeInfo,
              OpaqueDataBuffer *dbZ, Nd4jLong const *hZShapeInfo,
              Nd4jLong const *dZShapeInfo, Nd4jLong n, Nd4jLong *indexes,
  ...
  try {
    ...
    BUILD_SINGLE_SELECTOR(
        xType, pullRowsGeneric,
        (dbX->primary(), hXShapeInfo, dbZ->primary(), hZShapeInfo, n, indexes,
         tadShapeInfo, tadOffsets, zTadShapeInfo, zTadOffsets),
        LIBND4J_TYPES);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
...
template <typename T>
void tearGeneric(void *vx, Nd4jLong const *hXShapeInfo, Nd4jPointer *targets,
                 Nd4jLong const *hZShapeInfo, Nd4jLong const *tadShapeInfo,
  ...
  auto func = PRAGMA_THREADS_FOR {
    for (auto i = start; i < stop; i++) {
      ...
      if (zEWS == 1 && tadEWS == 1) {
        ...
        for (Nd4jLong j = 0; j < tadLength; j++)
          hZ[shape::getIndexOffset(j, hZShapeInfo)] =
              s[shape::getIndexOffset(j, tadShapeInfo)];
      }
    }
  };
...
void tear(Nd4jPointer *extraPointers, OpaqueDataBuffer *dbX,
          Nd4jLong const *hXShapeInfo, Nd4jLong const *dXShapeInfo,
          Nd4jPointer *targets, Nd4jLong const *hZShapeInfo,
          Nd4jLong const *tadShapeInfo, Nd4jLong const *tadOffsets) {
  try {
    auto xType = sd::ArrayOptions::dataType(hXShapeInfo);

    BUILD_SINGLE_SELECTOR(xType, tearGeneric,
                          (dbX->primary(), hXShapeInfo, targets, hZShapeInfo,
...
void average(Nd4jPointer *extras, Nd4jPointer *hX, const Nd4jLong *hXShapeInfo,
             Nd4jPointer *dX, const Nd4jLong *dXShapeInfo, void *z,
             const Nd4jLong *hZShapeInfo, void *dz, const Nd4jLong *dZShapeInfo,
             int n, Nd4jLong length, bool propagate) {
  try {
    auto xType = sd::ArrayOptions::dataType(hXShapeInfo);

    BUILD_SINGLE_SELECTOR(
        xType, sd::SpecialMethods,
        ::averageGeneric(hX, z, hZShapeInfo, n, length, propagate),
        LIBND4J_TYPES);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
...
void accumulate(Nd4jPointer *extras, Nd4jPointer *hX,
                Nd4jLong const *hXShapeInfo, Nd4jPointer *dX,
                Nd4jLong const *dXShapeInfo, void *hz,
                Nd4jLong const *hZShapeInfo, void *dz,
                Nd4jLong const *dZShapeInfo, int n, Nd4jLong length) {
  try {
    auto xType = sd::ArrayOptions::dataType(hXShapeInfo);

    BUILD_SINGLE_SELECTOR(xType, sd::SpecialMethods,
                          ::accumulateGeneric(hX, hz, hZShapeInfo, n, length),
                          LIBND4J_TYPES);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
...
void encodeThresholdP1(Nd4jPointer *extraPointers, void *hX,
                       Nd4jLong const *hXShapeInfo, Nd4jLong N, int *dz,
                       float threshold) {
  // TODO: to be implemented
}

void encodeThresholdP2Int(Nd4jPointer *extraPointers, int *hX, Nd4jLong N,
                          int *dz) {
  // TODO: to be implemented
}

void encodeThresholdP3(Nd4jPointer *extraPointers, void *hX,
                       Nd4jLong const *hXShapeInfo, int *offsets, Nd4jLong N,
                       int *dz) {
...
void decodeThreshold(Nd4jPointer *extraPointers, void *hX, Nd4jLong N, void *dz,
                     const Nd4jLong *hZShapeInfo) {
  // TODO: to be implemented
}
...
void decodeBitmap(Nd4jPointer *extraPointers, void *hX, Nd4jLong N, void *dz,
                  Nd4jLong const *hZShapeInfo) {
  NativeOpExecutioner::decodeBitmap(hX, N, dz, hZShapeInfo);
}

template <typename T>
void shuffleGeneric(void **hX, Nd4jLong *const *hXShapeInfo, void **dz,
                    Nd4jLong *const *hZShapeInfo, int N, int *shuffleMap,
        ...
        for (Nd4jLong r = 0; r < numTads; r++) {
          ...
          if (tadEWS == 1) {
            ...
            for (Nd4jLong i = 0; i < tadLength; i++) {
              ...
              sd::math::nd4j_swap<T>(hX[offset + oldOffset],
                                     hX[offset + newOffset]);
            }
          }
        }
...
void shuffle(Nd4jPointer *extras, Nd4jPointer *hX, Nd4jPointer *hXShapeInfo,
             Nd4jPointer *dX, Nd4jPointer *dXShapeInfo, Nd4jPointer *hz,
             Nd4jPointer *hZShapeInfo, Nd4jPointer *dz,
  ...
  try {
    ...
    BUILD_SINGLE_SELECTOR(
        xType, shuffleGeneric,
        (hX, xShape, hz, zShape, N, shuffleMap, tadOnlyShapeInfo, tadOffset),
        LIBND4J_TYPES);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
...
void execScalarTad(Nd4jPointer *extraPointers, int opNum, OpaqueDataBuffer *dbX,
                   Nd4jLong const *hXShapeInfo, Nd4jLong const *dXShapeInfo,
                   OpaqueDataBuffer *dbZ, Nd4jLong const *hZShapeInfo,
                   Nd4jLong const *dZShapeInfo, OpaqueDataBuffer *dbScalars,
                   Nd4jLong const *hScalarShapeInfo,
                   Nd4jLong const *dScalarShapeInfo, void *extraParams,
                   OpaqueDataBuffer *dbDimension,
  ...
  try {
    ...
    NativeOpExecutioner::execScalar(
        nullptr, opNum, dbX->primary(), hXShapeInfo, dbX->special(),
        dXShapeInfo, extraParams, dbZ->primary(), hZShapeInfo, dbZ->special(),
        dZShapeInfo, dbScalars->primary(), hScalarShapeInfo,
        dbScalars->special(), dScalarShapeInfo, dimension,
        shape::length(hDimensionShape), tadShapeInfo, tadOffsets, tadShapeInfoZ,
        tadOffsetsZ);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
...
void execScalarBoolTad(
    Nd4jPointer *extraPointers, int opNum, OpaqueDataBuffer *dbX,
    const Nd4jLong *hXShapeInfo, const Nd4jLong *dXShapeInfo,
    OpaqueDataBuffer *dbZ, const Nd4jLong *hZShapeInfo,
    const Nd4jLong *dZShapeInfo, OpaqueDataBuffer *dbScalars,
    const Nd4jLong *hScalarShapeInfo, const Nd4jLong *dScalarShapeInfo,
    void *extraParams, OpaqueDataBuffer *dbDimension,
    const Nd4jLong *hDimensionShape, const Nd4jLong *dDimensionShape,
  ...
  try {
    ...
    NativeOpExecutioner::execScalarBool(
        ...
        dXShapeInfo, extraParams, dbZ->primary(), hZShapeInfo, dbZ->special(),
        dZShapeInfo, dbScalars->primary(), hScalarShapeInfo,
        dbScalars->special(), dScalarShapeInfo, dimension, dimensionLength,
...
void execAggregate(Nd4jPointer *extraPointers, int opNum, void **arguments,
                   int numArguments, Nd4jLong **shapeArguments,
                   int numShapeArguments, int *indexArguments,
                   int numIndexArguments, int **intArrays, int numIntArrays,
                   void *realArguments, int numRealArguments,
                   sd::DataType dtype) {}

void batchExecutor(Nd4jPointer *extraPointers, int numAggregates, int opNum,
                   int maxArgs, int maxShapes, int maxIntArrays,
                   int maxIntArraySize, int maxIdx, int maxReals,
                   void *ptrToArguments, sd::DataType dtype) {}

void execAggregateBatch(Nd4jPointer *extraPointers, int numAggregates,
                        int opNum, int maxArgs, int maxShapes, int maxIntArrays,
                        int maxIntArraySize, int maxIdx, int maxReals,
                        void *ptrToArguments, sd::DataType dtype) {}

void execRandom(Nd4jPointer *extraPointers, int opNum, Nd4jPointer state,
                OpaqueDataBuffer *dbZ, const Nd4jLong *hZShapeInfo,
                const Nd4jLong *dZShapeInfo, void *extraArguments) {
  try {
    NativeOpExecutioner::execRandom(nullptr, opNum, state, dbZ->primary(),
...
void execRandom3(Nd4jPointer *extraPointers, int opNum, Nd4jPointer state,
                 OpaqueDataBuffer *dbX, const Nd4jLong *hXShapeInfo,
                 const Nd4jLong *dXShapeInfo, OpaqueDataBuffer *dbY,
                 const Nd4jLong *hYShapeInfo, const Nd4jLong *dYShapeInfo,
                 OpaqueDataBuffer *dbZ, const Nd4jLong *hZShapeInfo,
  ...
  try {
    NativeOpExecutioner::execRandom(
        nullptr, opNum, state, dbX->primary(), hXShapeInfo, dbX->special(),
        dXShapeInfo, dbY->primary(), hYShapeInfo, dbY->special(), dYShapeInfo,
...
void execRandom2(Nd4jPointer *extraPointers, int opNum, Nd4jPointer state,
                 OpaqueDataBuffer *dbX, const Nd4jLong *hXShapeInfo,
                 const Nd4jLong *dXShapeInfo, OpaqueDataBuffer *dbZ,
                 const Nd4jLong *hZShapeInfo, const Nd4jLong *dZShapeInfo,
                 void *extraArguments) {
  try {
    NativeOpExecutioner::execRandom(nullptr, opNum, state, dbX->primary(),
                                    hXShapeInfo, dbX->special(), dXShapeInfo,
...
Nd4jPointer initRandom(Nd4jPointer *extraPointers, long seed, long bufferSize,
...
void refreshBuffer(Nd4jPointer *extraPointers, long seed,
...
void reSeedBuffer(Nd4jPointer *extraPointers, long seed,
                  Nd4jPointer ptrRandom) {
  auto generator = reinterpret_cast<sd::graph::RandomGenerator *>(ptrRandom);
...
void sort(Nd4jPointer *extraPointers, void *hX, const Nd4jLong *hXShapeInfo,
          void *dX, const Nd4jLong *dXShapeInfo, bool descending) {
  try {
...
void sortTad(Nd4jPointer *extraPointers, void *hX, const Nd4jLong *hXShapeInfo,
             void *dX, const Nd4jLong *dXShapeInfo, int *dimension,
             int dimensionLength, const Nd4jLong *tadShapeInfo,
             const Nd4jLong *tadOffsets, bool descending) {
  try {
    NativeOpExecutioner::execSort(hX, hXShapeInfo, dimension, dimensionLength,
...
void sortCooIndices(Nd4jPointer *extraPointers, Nd4jLong *indices, void *values,
                    Nd4jLong length, int rank) {
  try {
...
Nd4jLong encodeBitmap(Nd4jPointer *extraPointers, void *hX,
                      Nd4jLong const *hXShapeInfo, Nd4jLong N, int *dz,
                      float threshold) {
...
template <typename T>
FORCEINLINE int estimateThresholdGeneric(Nd4jPointer *extraPointers,
                                         Nd4jPointer hX, int N, T threshold) {
...
int estimateThreshold(Nd4jPointer *extraPointers, Nd4jPointer hX,
                      Nd4jLong const *hXShapeInfo, int N, float threshold) {
  try {
    auto xType = ArrayOptions::dataType(hXShapeInfo);
    BUILD_SINGLE_SELECTOR(xType, return estimateThresholdGeneric,
                          (extraPointers, hX, N, threshold), FLOAT_TYPES);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
        e.what());
...
Nd4jLong getShapeListSize(sd::ShapeList *list) { return list->size(); }
...
sd::ShapeList *_calculateOutputShapes(
    Nd4jPointer *extraPointers, sd::ops::DeclarableOp *op,
    Nd4jPointer *inputBuffers, Nd4jPointer *inputShapes, int numInputShapes,
    double *tArgs, int numTArgs, Nd4jLong *iArgs, int numIArgs, bool *bArgs,
    int numBArgs, int *dArgs, int numDArgs) {
  sd::graph::VariableSpace varSpace;
  Context block(2, &varSpace);
  sd::ShapeList inShapes;

  for (int e = 0; e < numIArgs; e++) block.appendI(iArgs[e]);

  for (int e = 0; e < numTArgs; e++) block.appendT(tArgs[e]);

  for (int e = 0; e < numBArgs; e++) block.appendB(bArgs[e]);

  for (int e = 0; e < numDArgs; e++) block.appendD((sd::DataType)dArgs[e]);

  for (int e = 0; e < numInputShapes; e++) {
    auto shape_ = reinterpret_cast<Nd4jLong *>(inputShapes[e]);

    // we shouldn't copy buffer if that's empty array
    void *buffer_ = sd::ArrayOptions::arrayType(shape_) == ArrayType::EMPTY
                        ? nullptr
                        : inputBuffers[e];

    auto array = std::make_shared<NDArray>(
        buffer_, shape_, LaunchContext::defaultContext(), false);
...
sd::ShapeList *calculateOutputShapes2(Nd4jPointer *extraPointers, Nd4jLong hash,
                                      Nd4jPointer *inputBuffers,
                                      Nd4jPointer *inputShapes,
                                      int numInputShapes, double *tArgs,
                                      int numTArgs, Nd4jLong *iArgs,
                                      int numIArgs, bool *bArgs, int numBArgs,
                                      int *dArgs, int numDArgs) {
  try {
    auto op = sd::ops::OpRegistrator::getInstance().getOperation(hash);

    return _calculateOutputShapes(
        extraPointers, op.get(), inputBuffers, inputShapes, numInputShapes,
        tArgs, numTArgs, iArgs, numIArgs, bArgs, numBArgs, dArgs, numDArgs);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
        e.what());
...
sd::ShapeList *_calculateOutputShapes(Nd4jPointer *extraPointers,
...
sd::ShapeList *calculateOutputShapes(Nd4jPointer *extraPointers, Nd4jLong hash,
                                     Nd4jPointer *inputShapes,
                                     int numInputShapes, double *tArgs,
                                     int numTArgs, Nd4jLong *iArgs,
                                     int numIArgs) {
  try {
    ...
    return _calculateOutputShapes(extraPointers, op.get(), inputShapes,
                                  numInputShapes, tArgs, numTArgs, iArgs,
                                  numIArgs);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
...
int execCustomOp2(Nd4jPointer *extraPointers, Nd4jLong hash,
...
Nd4jStatus realExec(sd::ops::DeclarableOp *op, Nd4jPointer *extraPointers,
                    Nd4jLong hash, Nd4jPointer *inputBuffers,
                    Nd4jPointer *inputShapes, int numInputs,
                    Nd4jPointer *outputBuffers, Nd4jPointer *outputShapes,
                    int numOutputs, double *tArgs, int numTArgs,
                    Nd4jLong *iArgs, int numIArgs, bool *bArgs, int numBArgs,
                    bool isInplace) {
  if (op == nullptr)
  ...
  for (int e = 0; e < numInputs; e++) {
    ...
    void *buffer = sd::ArrayOptions::arrayType(shape) == ArrayType::EMPTY
                       ? nullptr
                       : inputBuffers[e];
  ...
  if (!isInplace)
    for (int e = 0; e < numOutputs; e++) {
      ...
      auto shape =
          shape::copyShape(reinterpret_cast<Nd4jLong *>(outputShapes[e]));
      void *buffer = sd::ArrayOptions::arrayType(shape) == ArrayType::EMPTY
                         ? nullptr
                         : outputBuffers[e];
      ...
      for (int i = 0; i < numInputs; i++) {
        void *ibuffer = sd::ArrayOptions::arrayType(shape) == ArrayType::EMPTY
                            ? nullptr
                            : inputBuffers[i];
        if (ibuffer == buffer) {
          canNullify = false;
      ...
      if (canNullify)
        memset((uint8_t *)buffer, '\0',
               shape::length(shape) *
                   DataTypeUtils::sizeOfElement(ArrayOptions::dataType(shape)));
  ...
  auto hZ = op->execute(inputs, outputs, ttArgs, iiArgs, biArgs,
                        std::vector<sd::DataType>(), isInplace);
  // auto hZ = op->execute(inputs, ttArgs, iiArgs, isInplace);

  if (!isInplace)
    for (int e = 0; e < numOutputs; e++) {
      // shape::printShapeInfoLinear("JVM output shape", (int *)
      // outputShapes[e]); shape::printShapeInfoLinear("C++ output shape", (int
      // *) outputs[e]->shapeInfo()); outputs[e]->printIndexedBuffer("C++ raw
      // output"); outputs[e]->printBuffer("C++ indexed output");

      if (outputs[e]->ordering() !=
          shape::order(reinterpret_cast<Nd4jLong *>(outputShapes[e])))
        outputs[e]->streamline(
            shape::order(reinterpret_cast<Nd4jLong *>(outputShapes[e])));
    }
...
int execCustomOp(Nd4jPointer *extraPointers, Nd4jLong hash,
                 Nd4jPointer *inputBuffers, Nd4jPointer *inputShapes,
                 int numInputs, Nd4jPointer *outputBuffers,
                 Nd4jPointer *outputShapes, int numOutputs, double *tArgs,
                 int numTArgs, Nd4jLong *iArgs, int numIArgs, bool *bArgs,
                 int numBArgs, bool isInplace) {
  try {
    auto op = sd::ops::OpRegistrator::getInstance().getOperation(hash);
    return realExec(op.get(), extraPointers, hash, inputBuffers, inputShapes,
                    numInputs, outputBuffers, outputShapes, numOutputs, tArgs,
                    numTArgs, iArgs, numIArgs, bArgs, numBArgs, isInplace);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
        e.what());
...
int registerGraph(Nd4jPointer *extraPointers, Nd4jLong graphId,
                  Nd4jPointer flatBufferPointer) {
  try {
...
sd::graph::VariablesSet *executeStoredGraph(Nd4jPointer *extraPointers,
                                            Nd4jLong graphId,
                                            Nd4jPointer *inputBuffers,
                                            Nd4jPointer *inputShapes,
...
Nd4jStatus execCustomOpWithScope(Nd4jPointer *extraPointers, Nd4jPointer state,
                                 Nd4jLong opHash, Nd4jLong *scopes,
                                 int numScopes, Nd4jPointer *inputBuffers,
                                 Nd4jPointer *inputShapes, int numInputs,
                                 Nd4jPointer *outputBuffers,
...
/*
 * TypeDef:
 *     void convertTypes(Nd4jPointer *extras, int srcType, Nd4jPointer hX, long
 * N, int dstType, Nd4jPointer hZ);
 */
void convertTypes(Nd4jPointer *extras, int srcType, Nd4jPointer hX, Nd4jLong N,
                  int dstType, Nd4jPointer hZ) {
  ...
  if (srcType == ND4J_FLOAT8) {
    if (dstType == ND4J_FLOAT8) {
      ...
      // sd::TypeCast::convertGeneric<sd::float8, sd::uint8>(nullptr, hx, N,
      // hz);
    } else if (dstType == ND4J_FLOAT16) {
      // sd::TypeCast::convertGeneric<sd::float8, float16>(nullptr, hx, N, hz);
    } else if (dstType == ND4J_INT16) {
      // sd::TypeCast::convertGeneric<sd::float8, sd::int16>(nullptr, hx, N,
      // hz);
    } else if (dstType == ND4J_UINT16) {
      // sd::TypeCast::convertGeneric<sd::float8, sd::uint16>(nullptr, hx, N,
      // hz);
    ...
    if (dstType == ND4J_FLOAT8) {
      //    sd::TypeCast::convertGeneric<uint8_t, sd::float8>(nullptr, hx, N,
      //    hz);
    } else if (dstType == ND4J_INT8) {
      ...
      //       sd::TypeCast::convertGeneric<uint8_t, uint16_t>(nullptr, hx, N,
      //       hz);
    } else if (dstType == ND4J_FLOAT24) {
    ...
    if (dstType == ND4J_FLOAT8) {
      //    sd::TypeCast::convertGeneric<float16, sd::float8>(nullptr, hx, N,
      //    hz);
    } else if (dstType == ND4J_INT8) {
      ...
      //            sd::TypeCast::convertGeneric<float16, uint16_t>(nullptr, hx,
      //            N, hz);
    } else if (dstType == ND4J_FLOAT24) {
      // TODO: .... ^^^
    } else if (dstType == ND4J_FLOAT32) {
    ...
    if (dstType == ND4J_FLOAT8) {
      //   sd::TypeCast::convertGeneric<int16_t, sd::float8>(nullptr, hx, N,
      //   hz);
    } else if (dstType == ND4J_INT8) {
      ...
      //            sd::TypeCast::convertGeneric<int16_t, uint16_t>(nullptr, hx,
      //            N, hz);
    } else if (dstType == ND4J_FLOAT24) {
      // TODO...
    } else if (dstType == ND4J_FLOAT32) {
    ...
    if (dstType == ND4J_FLOAT8) {
      ...
      //            sd::TypeCast::convertGeneric<float, uint16_t>(nullptr, hx,
      //            N, hz);
    } else if (dstType == ND4J_FLOAT24) {
    } else if (dstType == ND4J_DOUBLE) {
    ...
    if (dstType == ND4J_FLOAT8) {
      ...
      //            sd::TypeCast::convertGeneric<double, uint16_t>(nullptr, hx,
      //            N, hz);
    } else if (dstType == ND4J_FLOAT24) {
    } else if (dstType == ND4J_FLOAT32) {
...
/*
void fillUtf8String(Nd4jPointer *extraPointers, const char **strings, int
numStrings, Nd4jPointer buffer) { auto hZ =
reinterpret_cast<sd::utf8string**>(buffer); for (int e = 0; e < numStrings; e++)
{ hZ[e] = reinterpret_cast<sd::utf8string*>(createUtf8String(extraPointers,
strings[e]));
    }
}
 */

Nd4jPointer createUtf8String(Nd4jPointer *extraPointers, const char *string,
                             int length) {
...
static void _scatterUpdate(
    ...
    const Nd4jLong *hXShapeInfo, const Nd4jLong *hXOffsets, void *dX,
    const Nd4jLong *dXShapeInfo, const Nd4jLong *dXOffsets, void *hY,
    const Nd4jLong *hYShapeInfo, const Nd4jLong *hYOffsets, void *dY,
    const Nd4jLong *dYShapeInfo, const Nd4jLong *dYOffsets, void *vIindexes,
    const Nd4jLong *hIndicesShapeInfo, void *dIindexes,
    const Nd4jLong *dIndicesShapeInfo) {
  auto hIindexes = reinterpret_cast<I *>(vIindexes);
  auto func = PRAGMA_THREADS_DO {
    for (int i = 0; i < numOfSubArrs; ++i) {
      int threadIndex = thread_id;
      const auto xIndex = hIindexes[i];
      const bool isOwner = xIndex < numThreads
                               ? threadIndex == xIndex
                               : threadIndex == xIndex % numThreads;

      if (!isOwner) continue;

      NDArray inSubArr(
          reinterpret_cast<int8_t *>(hX) +
              (hXOffsets[hIindexes[i]] * DataTypeUtils::sizeOf(hXShapeInfo)),
          hXShapeInfo);
      NDArray updSubArr(reinterpret_cast<int8_t *>(hY) +
                            (hYOffsets[i] * DataTypeUtils::sizeOf(hXShapeInfo)),
                        hYShapeInfo);
      ...
      switch (opCode) {
        case 0:
          ...
          break;
        case 1:
          inSubArr.applyPairwiseTransform(pairwise::Subtract, updSubArr,
                                          inSubArr);
          break;
        case 2:
          inSubArr.applyPairwiseTransform(pairwise::Multiply, updSubArr,
                                          inSubArr);
          break;
        case 3:
          inSubArr.applyPairwiseTransform(pairwise::Divide, updSubArr,
                                          inSubArr);
          break;
        case 4:
          inSubArr.applyPairwiseTransform(pairwise::ReverseSubtract, updSubArr,
                                          inSubArr);
          break;
        case 5:
          inSubArr.applyPairwiseTransform(pairwise::ReverseDivide, updSubArr,
                                          inSubArr);
          break;
        case 6:
          inSubArr.applyPairwiseTransform(pairwise::CopyPws, updSubArr,
                                          inSubArr);
          break;
        default:
          continue;
...
void scatterUpdate(Nd4jPointer *extraPointers, int opCode, int numOfSubArrs,
                   ...
                   const Nd4jLong *hXOffsets, void *dX,
                   const Nd4jLong *dXShapeInfo, const Nd4jLong *dXOffsets,
                   void *hY, const Nd4jLong *hYShapeInfo,
                   const Nd4jLong *hYOffsets, void *dY,
                   const Nd4jLong *dYShapeInfo, const Nd4jLong *dYOffsets,
                   void *hIindexes, const Nd4jLong *hIndicesShapeInfo,
                   void *dIindexes, const Nd4jLong *dIndicesShapeInfo) {
  auto iType = ArrayOptions::dataType(hIndicesShapeInfo);

  try {
    BUILD_SINGLE_SELECTOR(
        iType, _scatterUpdate,
        (extraPointers, opCode, numOfSubArrs, hX, hXShapeInfo, hXOffsets, dX,
         dXShapeInfo, dXOffsets, hY, hYShapeInfo, hYOffsets, dY, dYShapeInfo,
         dYOffsets, hIindexes, hIndicesShapeInfo, dIindexes, dIndicesShapeInfo),
        INDEXING_TYPES);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
...
void inspectArray(Nd4jPointer *extraPointers, Nd4jPointer buffer,
...
sd::ConstantShapeBuffer *shapeBuffer(int rank, Nd4jLong *shape,
                                    Nd4jLong *strides, sd::DataType dtype,
                                    char order, Nd4jLong ews, bool empty) {
  try {
...
void deleteConstantShapeBuffer(sd::ConstantShapeBuffer *ptr) { delete ptr; }
...
sd::ConstantDataBuffer *constantBufferLong(sd::DataType dtype,
                                           const Nd4jLong *data, int length) {
  return nullptr;
}

sd::ConstantDataBuffer *constantBufferDouble(sd::DataType dtype, double *data,
                                             int length) {
  return nullptr;
}

sd::ConstantDataBuffer *constantBuffer(sd::DataType dtype,
                                       sd::ConstantDescriptor *descriptor) {
  try {
    return sd::ConstantHelper::getInstance().constantBuffer(*descriptor,
                                                             dtype);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
...
sd::graph::RandomGenerator *getGraphContextRandomGenerator(
    sd::graph::Context *ptr) {
...
void setGraphContextCudaContext(sd::graph::Context *ptr, void *stream,
                                void *reductionPointer,
                                void *allocationPointer) {}
void setGraphContextInputArray(sd::graph::Context *ptr, int index, void *buffer,
                               void *shapeInfo, void *specialBuffer,
                               void *specialShapeInfo) {
  ptr->setInputArray(index, buffer, shapeInfo, specialBuffer, specialShapeInfo);
}
void setGraphContextOutputArray(sd::graph::Context *ptr, int index,
                                void *buffer, void *shapeInfo,
                                void *specialBuffer, void *specialShapeInfo) {
  ptr->setOutputArray(index, buffer, shapeInfo, specialBuffer,
                      specialShapeInfo);
}

void setGraphContextInputBuffer(OpaqueContext *ptr, int index,
                                OpaqueDataBuffer *buffer, void *shapeInfo,
                                void *specialShapeInfo) {
  ptr->setInputArray(index, buffer, shapeInfo, specialShapeInfo);
}

void setGraphContextOutputBuffer(OpaqueContext *ptr, int index,
                                 OpaqueDataBuffer *buffer, void *shapeInfo,
                                 void *specialShapeInfo) {
  ptr->setOutputArray(index, buffer, shapeInfo, specialShapeInfo);
}

void setGraphContextTArguments(sd::graph::Context *ptr, double *arguments,
                               int numberOfArguments) {
  ptr->setTArguments(arguments, numberOfArguments);
}
void setGraphContextIArguments(sd::graph::Context *ptr, Nd4jLong *arguments,
                               int numberOfArguments) {
  ptr->setIArguments(arguments, numberOfArguments);
}
void setGraphContextBArguments(sd::graph::Context *ptr, bool *arguments,
                               int numberOfArguments) {
  ptr->setBArguments(arguments, numberOfArguments);
}

void setGraphContextDArguments(OpaqueContext *ptr, int *arguments,
                               int numberOfArguments) {
...
sd::graph::RandomGenerator *createRandomGenerator(Nd4jLong rootSeed,
                                                  Nd4jLong nodeSeed) {
...
void setRandomGeneratorStates(sd::graph::RandomGenerator *ptr,
                              Nd4jLong rootSeed, Nd4jLong nodeSeed) {
...
int getRandomGeneratorRelativeInt(sd::graph::RandomGenerator *ptr,
                                  Nd4jLong index) {
  return ptr->relativeInt(index);
}

Nd4jLong getRandomGeneratorRelativeLong(sd::graph::RandomGenerator *ptr,
                                        Nd4jLong index) {
...
Nd4jPointer shapeBufferForNumpy(Nd4jPointer npyArray) {
  try {
    ...
    if (shape.size() == 1 && shape[0] == 0) {
      ...
      if (shapeSize > 0)
        shapeBuffer = sd::ShapeBuilders::emptyShapeInfo(
            dtype, arr.fortranOrder ? 'f' : 'c', shape);
      else
        shapeBuffer = sd::ShapeBuilders::emptyShapeInfo(dtype);
    } else {
      shapeBuffer = sd::ShapeBuilders::createShapeInfo(
          dtype, arr.fortranOrder ? 'f' : 'c', shape);
    }
    return const_cast<Nd4jLong *>(
        sd::ConstantShapeHelper::getInstance().createFromExisting(shapeBuffer,
                                                                   true));
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
...
void sortByKey(Nd4jPointer *extraPointers, void *x, const Nd4jLong *xShapeInfo,
               void *dx, const Nd4jLong *dxShapeInfo, void *y,
               const Nd4jLong *yShapeInfo, void *dy,
               const Nd4jLong *dyShapeInfo, bool descending) {
  try {
    ...
    BUILD_DOUBLE_SELECTOR(xType, yType, sd::DoubleMethods,
                          ::sortByKey(x, xShapeInfo, y, yShapeInfo, descending),
...
void sortByValue(Nd4jPointer *extraPointers, void *x,
                 const Nd4jLong *xShapeInfo, void *dx,
                 const Nd4jLong *dxShapeInfo, void *y,
                 const Nd4jLong *yShapeInfo, void *dy,
                 const Nd4jLong *dyShapeInfo, bool descending) {
  try {
    auto xType = ArrayOptions::dataType(xShapeInfo);
    ...
    BUILD_DOUBLE_SELECTOR(
        xType, yType, sd::DoubleMethods,
        ::sortByValue(x, xShapeInfo, y, yShapeInfo, descending), LIBND4J_TYPES,
        LIBND4J_TYPES);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
...
void sortTadByKey(Nd4jPointer *extraPointers, void *x,
                  const Nd4jLong *xShapeInfo, void *dx,
                  const Nd4jLong *dxShapeInfo, void *y,
                  const Nd4jLong *yShapeInfo, void *dy,
                  const Nd4jLong *dyShapeInfo, int *dimension,
  ...
  try {
    ...
    BUILD_DOUBLE_SELECTOR(
        xType, yType, sd::DoubleMethods,
        ::sortTadByKey(x, xShapeInfo, y, yShapeInfo, dimension, dimensionLength,
                       descending),
        LIBND4J_TYPES, LIBND4J_TYPES);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
...
void sortTadByValue(Nd4jPointer *extraPointers, void *x,
                    const Nd4jLong *xShapeInfo, void *dx,
                    const Nd4jLong *dxShapeInfo, void *y,
                    const Nd4jLong *yShapeInfo, void *dy,
                    const Nd4jLong *dyShapeInfo, int *dimension,
  ...
  try {
    ...
    BUILD_DOUBLE_SELECTOR(
        xType, yType, sd::DoubleMethods,
        ::sortTadByValue(x, xShapeInfo, y, yShapeInfo, dimension,
                         dimensionLength, descending),
        LIBND4J_TYPES, LIBND4J_TYPES);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
...
Nd4jPointer lcScalarPointer(OpaqueLaunchContext *lc) { return nullptr; }

Nd4jPointer lcReductionPointer(OpaqueLaunchContext *lc) { return nullptr; }

Nd4jPointer lcAllocationPointer(OpaqueLaunchContext *lc) { return nullptr; }

Nd4jPointer lcExecutionStream(OpaqueLaunchContext *lc) { return nullptr; }

Nd4jPointer lcCopyStream(OpaqueLaunchContext *lc) { return nullptr; }

Nd4jPointer lcBlasHandle(OpaqueLaunchContext *lc) { return nullptr; }

Nd4jPointer lcSolverHandle(OpaqueLaunchContext *lc) { return nullptr; }
...
int optimalLevel() {
  ...
  if (features.avx && features.avx2 && features.avx512f && features.avx512vl &&
      features.avx512bw && features.avx512dq && features.avx512cd)
    return 3;
...
bool isMinimalRequirementsMet() {
  ...
  return features.avx && features.avx2 && features.avx512f &&
...
OpaqueDataBuffer *dbAllocateDataBuffer(Nd4jLong elements, int dataType,
                                       bool allocateBoth) {
  return allocateDataBuffer(elements, dataType, allocateBoth);
}

OpaqueDataBuffer *allocateDataBuffer(Nd4jLong elements, int dataType,
                                     bool allocateBoth) {
  try {
    auto dtype = DataTypeUtils::fromInt(dataType);
    return new sd::InteropDataBuffer(elements * DataTypeUtils::sizeOf(dtype),
                                     dtype, allocateBoth);
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
...
OpaqueDataBuffer *dbCreateExternalDataBuffer(Nd4jLong elements, int dataType,
                                             Nd4jPointer primary,
                                             Nd4jPointer special) {
...
void dbSetPrimaryBuffer(OpaqueDataBuffer *dataBuffer, Nd4jPointer primaryBuffer,
                        Nd4jLong numBytes) {
  dataBuffer->setPrimary(primaryBuffer, numBytes);
}

void dbSetSpecialBuffer(OpaqueDataBuffer *dataBuffer, Nd4jPointer specialBuffer,
                        Nd4jLong numBytes) {
...
void dbExpandBuffer(OpaqueDataBuffer *dataBuffer, Nd4jLong elements) {
  try {
    dataBuffer->dataBuffer()->expand(
        elements *
        DataTypeUtils::sizeOf(dataBuffer->dataBuffer()->getDataType()));
  } catch (std::exception &e) {
    sd::LaunchContext::defaultContext()->errorReference()->setErrorCode(1);
    sd::LaunchContext::defaultContext()->errorReference()->setErrorMessage(
        e.what());
...
OpaqueDataBuffer *dbCreateView(OpaqueDataBuffer *dataBuffer, Nd4jLong length,
                               Nd4jLong offset) {
...
BUILD_SINGLE_TEMPLATE(template void pullRowsGeneric,
                      (void *, Nd4jLong const *, void *, Nd4jLong const *,
                       const int, Nd4jLong const *, Nd4jLong const *,
                       Nd4jLong const *, Nd4jLong const *, Nd4jLong const *),
                      LIBND4J_TYPES);
BUILD_SINGLE_TEMPLATE(template void tearGeneric,
                      (void *, Nd4jLong const *, Nd4jPointer *,
                       Nd4jLong const *, Nd4jLong const *, Nd4jLong const *),
                      LIBND4J_TYPES);
BUILD_SINGLE_TEMPLATE(template void shuffleGeneric,
                      (void **, Nd4jLong *const *, void **, Nd4jLong *const *,
                       int, int *, Nd4jLong *const *, Nd4jLong *const *),
                      LIBND4J_TYPES);
