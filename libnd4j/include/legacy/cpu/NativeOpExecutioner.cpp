...
void NativeOpExecutioner::execIndexReduceScalar(
  ...
  BUILD_DOUBLE_SELECTOR(xType, zType,
                        hz[0] = functions::indexreduce::IndexReduce,
                        ::execScalar(opNum, hX, hXShapeInfo, extraParams),
...
void NativeOpExecutioner::execIndexReduce(
    ...
    const Nd4jLong *hXShapeInfo, const void *dX, const Nd4jLong *dXShapeInfo,
    void *extraParams, void *hZ, const Nd4jLong *hZShapeInfo, void *dZ,
    const Nd4jLong *dZShapeInfo, int *dimension, int dimensionLength,
  ...
  BUILD_DOUBLE_SELECTOR(
      ...
      ::exec(opNum, hX, hXShapeInfo, extraParams, hz, hZShapeInfo, dimension,
...
void NativeOpExecutioner::execBroadcast(
    ...
    void *dZ, const Nd4jLong *dZShapeInfo, int *dimension, int dimensionLength,
  ...
  BUILD_PAIRWISE_SELECTOR(
      ...
      ::exec(opNum, hX, hXShapeInfo, hY, hYShapeInfo, hZ, hZShapeInfo,
             dimension, dimensionLength, tadOnlyShapeInfo, tadOffsets,
             tadOnlyShapeInfoZ, tadOffsetsZ),
      LIBND4J_TYPES, LIBND4J_TYPES);
#else

  auto loopKind = sd::LoopKind::deduceKindOfLoopBroadcast(
      hXShapeInfo, hYShapeInfo, hZShapeInfo);
  ...
  auto func = PRAGMA_THREADS_FOR {
    BUILD_SINGLE_SELECTOR_THRICE(
        ...
        ::exec(opNum, hX, hXShapeInfo, hY, hYShapeInfo, hZ, hZShapeInfo,
               dimension, dimensionLength, tadOnlyShapeInfo, tadOffsets,
               tadOnlyShapeInfoZ, tadOffsetsZ, loopKind, start, stop),
        LIBND4J_TYPES);
  };
...
void NativeOpExecutioner::execInverseBroadcast(
  ...
  BUILD_PAIRWISE_SELECTOR(
      xType, yType, zType, functions::broadcast::Broadcast,
      ::execInverse(opNum, hX, hXShapeInfo, hY, hYShapeInfo, hZ, hZShapeInfo,
                    dimension, dimensionLength, tadOnlyShapeInfo, tadOffsets,
                    tadOnlyShapeInfoZ, tadOffsetsZ),
      LIBND4J_TYPES, LIBND4J_TYPES);
#else
  auto func = PRAGMA_THREADS_FOR {
    BUILD_SINGLE_SELECTOR_THRICE(
        ...
        ::execInverse(opNum, hX, hXShapeInfo, hY, hYShapeInfo, hZ, hZShapeInfo,
                      dimension, dimensionLength, tadOnlyShapeInfo, tadOffsets,
                      tadOnlyShapeInfoZ, tadOffsetsZ, start, stop),
        LIBND4J_TYPES);
  };
...
void NativeOpExecutioner::execBroadcastBool(
  ...
  auto func = PRAGMA_THREADS_FOR {
    BUILD_DOUBLE_SELECTOR(
        ...
        ::exec(opNum, hX, hXShapeInfo, hY, hYShapeInfo, hZ, hZShapeInfo,
               extraParams, dimension, dimensionLength, tadOnlyShapeInfo,
               tadOffsets, tadOnlyShapeInfoZ, tadOffsetsZ, start, stop),
...
void NativeOpExecutioner::execBroadcastInt(
  ...
  if (xType != yType || xType != zType)
    throw sd::datatype_exception::build("NativeOpExecutioner::execBroadcastInt",
                                        zType, xType, yType);

  if (!sd::DataTypeUtils::isZ(zType))
    throw sd::datatype_exception::build(
        "NativeOpExecutioner::execBroadcastInt requires integer data type",
        zType);
...
void NativeOpExecutioner::execInverseBroadcastInt(
  ...
  if (xType != yType || xType != zType)
    throw sd::datatype_exception::build(
        "NativeOpExecutioner::execInverseBroadcastInt", zType, xType, yType);

  if (!sd::DataTypeUtils::isZ(zType))
    throw sd::datatype_exception::build(
        "NativeOpExecutioner::execInverseBroadcastInt requires integer data "
        "type",
        zType);
...
#ifdef __ND4J_EXPERIMENTAL__
  BUILD_PAIRWISE_SELECTOR(xType, yType, zType,
...
void NativeOpExecutioner::execPairwiseBoolTransform(
  ...
  if (xType != yType)
    throw sd::datatype_exception::build(
        "NativeOpExecutioner::execPairwiseBoolTransform", xType, yType);

  if (zType != sd::DataType::BOOL)
    throw sd::datatype_exception::build(
        "NativeOpExecutioner::execPairwiseBoolTransform", sd::DataType::BOOL,
        zType);
  ...
  auto func = PRAGMA_THREADS_FOR {
    BUILD_DOUBLE_SELECTOR(xType, zType,
                          ...
                          ::exec(opNum, hX, hXShapeInfo, hY, hYShapeInfo, hZ,
                                 hZShapeInfo, extraParams, start, stop),
                          LIBND4J_TYPES, BOOL_TYPES);
  };
...
void NativeOpExecutioner::execPairwiseIntTransform(
  ...
  if (xType != yType || xType != zType)
    throw sd::datatype_exception::build(
        "NativeOpExecutioner::execPairwiseIntTransform", zType, xType, yType);

  if (!sd::DataTypeUtils::isZ(zType))
    throw sd::datatype_exception::build(
        "NativeOpExecutioner::execSPairwiseInt requires integer data type",
        zType);

  auto func = PRAGMA_THREADS_FOR {
    BUILD_SINGLE_SELECTOR(xType,
...
void NativeOpExecutioner::execReduceFloat(
  ...
  const sd::LoopKind::Kind kindOfLoop = sd::LoopKind::deduceKindOfLoopTadXZ(
      hXShapeInfo, hZShapeInfo, tadShapeInfo);
...
void NativeOpExecutioner::execReduceFloatScalar(
  ...
  BUILD_DOUBLE_SELECTOR(
      xType, zType, functions::reduce::ReduceFloatFunction,
      ::execScalar(opNum, hX, hXShapeInfo, extraParams, hZ, hZShapeInfo),
      LIBND4J_TYPES, FLOAT_TYPES);
}
...
void NativeOpExecutioner::execReduce3Scalar(
  ...
  BUILD_DOUBLE_SELECTOR(xType, zType, functions::reduce3::Reduce3,
                        ::execScalar(opNum, hX, hXShapeInfo, extraParamsVals,
                                     hY, hYShapeInfo, hZ, hZShapeInfo),
                        LIBND4J_TYPES, FLOAT_TYPES);
}
...
void NativeOpExecutioner::execReduce3(
  ...
  // BUILD_DOUBLE_SELECTOR(xType, zType, functions::reduce3::Reduce3,
  // ::exec(opNum, hX, hXShapeInfo, extraParamsVals, hY, hYShapeInfo, hZ,
...
void NativeOpExecutioner::execReduce3(
  ...
  auto func = PRAGMA_THREADS_FOR {
    BUILD_DOUBLE_SELECTOR(
        ...
        ::exec(opNum, hX, hXShapeInfo, extraParamsVals, hY, hYShapeInfo, hZ,
               hZShapeInfo, dimension, dimensionLength, start, stop),
        LIBND4J_TYPES, FLOAT_TYPES);
  };
...
void NativeOpExecutioner::execReduce3All(
    ...
    const Nd4jLong *xOffsets, const Nd4jLong *yTadShapeInfo,
  ...
  auto func = PRAGMA_THREADS_FOR {
    BUILD_DOUBLE_SELECTOR(
        xType, zType, functions::reduce3::Reduce3,
        ::execAll(opNum, hX, hXShapeInfo, extraParamsVals, hY, hYShapeInfo, hZ,
                  hZShapeInfo, dimension, dimensionLength, xTadShapeInfo,
                  xOffsets, yTadShapeInfo, yOffsets, start, stop),
        LIBND4J_TYPES, FLOAT_TYPES);
  };
...
void NativeOpExecutioner::execReduce3TAD(
    ...
    const void *dY, const Nd4jLong *dYShapeInfo, void *hZ,
    const Nd4jLong *hZShapeInfo, void *dZ, const Nd4jLong *dZShapeInfo,
    int *dimension, int dimensionLength, const Nd4jLong *tadShapeInfo,
    const Nd4jLong *tadOffsets, const Nd4jLong *yTadShapeInfo,
    const Nd4jLong *yTadOffsets) {
  auto xType = sd::ArrayOptions::dataType(hXShapeInfo);
  auto zType = sd::ArrayOptions::dataType(hZShapeInfo);
...
void NativeOpExecutioner::execScalar(
    ...
    const Nd4jLong *hScalarShapeInfo, const void *dScalar,
  ...
  BUILD_PAIRWISE_SELECTOR(xType, yType, zType,
                          ...
                          ::transform(opNum, hX, hXShapeInfo, hZ, hZShapeInfo,
                                      hScalar, extraParams),
                          LIBND4J_TYPES, LIBND4J_TYPES);
#else
  if (xType != yType || xType != zType)
    throw sd::datatype_exception::build("NativeOpExecutioner::execScalar",
                                        zType, xType, yType);

  auto func = PRAGMA_THREADS_FOR {
    BUILD_SINGLE_SELECTOR_THRICE(
        xType, functions::scalar::ScalarTransform,
        ::transform(opNum, hX, hXShapeInfo, hZ, hZShapeInfo, hScalar,
                    extraParams, start, stop),
        LIBND4J_TYPES);
  };
...
void NativeOpExecutioner::execScalar(
  ...
  BUILD_PAIRWISE_SELECTOR(
      ...
      ::transform(opNum, hX, hXShapeInfo, extraParams, hZ, hZShapeInfo,
                  hScalars, dimension, dimensionLength, tadShapeInfo,
  ...
  auto func = PRAGMA_THREADS_FOR {
    BUILD_SINGLE_SELECTOR_THRICE(
        ...
        ::transform(opNum, hX, hXShapeInfo, extraParams, hZ, hZShapeInfo,
                    hScalars, dimension, dimensionLength, tadShapeInfo,
                    tadOffsets, tadShapeInfoZ, tadOffsetsZ, start, stop),
        LIBND4J_TYPES);
  };
...
void NativeOpExecutioner::execScalarBool(
  ...
  if (xType != yType)
    throw sd::datatype_exception::build("NativeOpExecutioner::execScalarBool",
                                        xType, yType);
  ...
  auto func = PRAGMA_THREADS_FOR {
    BUILD_DOUBLE_SELECTOR(xType, zType, functions::scalar::ScalarBoolTransform,
                          ::transform(opNum, hX, hXShapeInfo, hZ, hZShapeInfo,
                                      hScalar, extraParams, start, stop),
                          LIBND4J_TYPES, BOOL_TYPES);
  };
...
void NativeOpExecutioner::execScalarInt(
  ...
  if (xType != yType || xType != zType)
    throw sd::datatype_exception::build("NativeOpExecutioner::execScalarInt",
                                        xType, yType);

  if (!sd::DataTypeUtils::isZ(zType))
    throw sd::datatype_exception::build("NativeOpExecutioner::execScalarInt",
                                        sd::DataType::INT32, zType);
...
void NativeOpExecutioner::execScalarInt(
  ...
  if (!sd::DataTypeUtils::isZ(zType))
    throw sd::datatype_exception::build(
        "NativeOpExecutioner::execScalarInt requires integer data type", zType);
...
void NativeOpExecutioner::execSummaryStats(
  ...
  BUILD_DOUBLE_SELECTOR(xType, zType,
                        ...
                        ::exec(opNum, biasCorrected, hX, hXShapeInfo,
                               extraParams, hZ, hZShapeInfo, nullptr, 1),
                        LIBND4J_TYPES, FLOAT_TYPES);
}
...
void NativeOpExecutioner::execSummaryStatsScalar(
  ...
  BUILD_DOUBLE_SELECTOR(xType, zType,
                        functions::summarystats::SummaryStatsReduce,
                        ::execScalar(opNum, biasCorrected, hX, hXShapeInfo,
                                     extraParams, hZ, hZShapeInfo),
                        LIBND4J_TYPES, FLOAT_TYPES);
}
...
void NativeOpExecutioner::execSummaryStats(
  ...
  BUILD_DOUBLE_SELECTOR(
      ...
      ::exec(opNum, biasCorrected, hX, hXShapeInfo, extraParams, hZ,
...
void NativeOpExecutioner::execTransformFloat(
  ...
  auto func = PRAGMA_THREADS_DO {
    BUILD_DOUBLE_SELECTOR(xType, zType, functions::transform::TransformFloat,
                          ::exec(opNum, hX, hXShapeInfo, hZ, hZShapeInfo,
                                 extraParams, thread_id, numThreads),
                          LIBND4J_TYPES, FLOAT_TYPES);
  };
...
void NativeOpExecutioner::execRandom(sd::LaunchContext *lc, int opNum,
  ...
  BUILD_SINGLE_SELECTOR(
      ...
      ::execTransform(opNum, state, hZ, hZShapeInfo, extraArguments),
      FLOAT_TYPES);
...
void NativeOpExecutioner::execRandom(
    sd::LaunchContext *lc, int opNum, Nd4jPointer state, const void *hX,
    const Nd4jLong *hXShapeInfo, const void *dX, const Nd4jLong *dXShapeInfo,
    void *hZ, const Nd4jLong *hZShapeInfo, void *dZ,
  ...
  BUILD_SINGLE_SELECTOR(zType, functions::random::RandomFunction,
                        ::execTransform(opNum, state, hX, hXShapeInfo, hZ,
...
void NativeOpExecutioner::execRandom(
    ...
    const void *hY, const Nd4jLong *hYShapeInfo, const void *dY,
    const Nd4jLong *dYShapeInfo, void *hZ, const Nd4jLong *hZShapeInfo,
    void *dZ, const Nd4jLong *dZShapeInfo, void *extraArguments) {
  auto xType = sd::ArrayOptions::dataType(hZShapeInfo);

  BUILD_SINGLE_SELECTOR(
      xType, functions::random::RandomFunction,
      ::execTransform(opNum, state, hX, hXShapeInfo, hY, hYShapeInfo, hZ,
                      hZShapeInfo, extraArguments),
      FLOAT_TYPES);
