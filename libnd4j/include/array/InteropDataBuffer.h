...
namespace sd {
/**
 * This class is a wrapper for DataBuffer, suitable for sharing DataBuffer
 * between front-end and back-end languages
 */
class SD_EXPORT InteropDataBuffer {
 private:
