...
template <typename T, typename = typename std::enable_if<
                          DataTypeUtils::scalarTypesForNDarray<T>::value>::type>
...
template <
    ...
    typename = typename std::enable_if<
        std::is_same<NDArray, typename std::decay<T1>::type>::value &&
...
class SD_EXPORT NDArray {
 private:
  ...
  template <typename T>
  void templatedSet(void* buffer, const Nd4jLong xOfsset, sd::DataType dtype,
                    const void* value);

  template <typename T>
  void templatedAssign(void* xBuffer, const Nd4jLong xOffset,
                       const void* yBuffer, const Nd4jLong yOffset) const;

  template <typename X, typename Y>
  void templatedDoubleAssign(void* xBuffer, const Nd4jLong xOffset,
                             const void* yBuffer, const Nd4jLong yOffset) const;
 ...
 protected:
  /**
   *  if true then array doesn't own buffer and simply points to another's
   * buffer
   */
  bool _isView = false;
 ...
 public:
  ...
  NDArray(std::shared_ptr<DataBuffer> buffer, const ShapeDescriptor& descriptor,
          ...
          const Nd4jLong offset = 0);

  NDArray(std::shared_ptr<DataBuffer> buffer, char order,
  ...
  NDArray(const std::u16string& u16string,
          sd::DataType dtype = sd::DataType::UTF16,
          sd::LaunchContext* context = sd::LaunchContext::defaultContext());
  ...
  NDArray(const std::u32string& u32string,
          sd::DataType dtype = sd::DataType::UTF32,
          sd::LaunchContext* context = sd::LaunchContext::defaultContext());
   ...
   */
  NDArray(const std::vector<Nd4jLong>& shape,
          const std::vector<const char16_t*>& strings,
          sd::DataType dtype = sd::DataType::UTF16,
          sd::LaunchContext* context = sd::LaunchContext::defaultContext());
  NDArray(const std::vector<Nd4jLong>& shape,
          const std::vector<std::u16string>& string,
          sd::DataType dtype = sd::DataType::UTF16,
          sd::LaunchContext* context = sd::LaunchContext::defaultContext());
   ...
   */
  NDArray(const std::vector<Nd4jLong>& shape,
          const std::vector<const char32_t*>& strings,
          sd::DataType dtype = sd::DataType::UTF32,
          sd::LaunchContext* context = sd::LaunchContext::defaultContext());
  NDArray(const std::vector<Nd4jLong>& shape,
          const std::vector<std::u32string>& string,
          sd::DataType dtype = sd::DataType::UTF32,
          sd::LaunchContext* context = sd::LaunchContext::defaultContext());
   ...
   *  do not allocate memory, memory for array is passed from outside
   */
  NDArray(void* buffer, Nd4jLong* shapeInfo,
          sd::LaunchContext* context = sd::LaunchContext::defaultContext(),
          bool isBuffAlloc = false);
  NDArray(void* buffer, const Nd4jLong* shapeInfo,
          sd::LaunchContext* context = sd::LaunchContext::defaultContext(),
          bool isBuffAlloc = false);
   ...
   */
  NDArray(void* buffer, void* bufferD, const Nd4jLong* shapeInfo,
          sd::LaunchContext* context = sd::LaunchContext::defaultContext(),
          bool isBuffAlloc = false, bool isBuffDAlloc = false);
  ...
  /**
   *  constructor creates new NDArray using shape information from "shapeInfo",
   * set all elements in new array to zeros, if copyStrides is true then use
   * stride values from "shapeInfo", else calculate strides independently
   */
  NDArray(const Nd4jLong* shapeInfo, bool copyStrides = false,
          sd::LaunchContext* context = sd::LaunchContext::defaultContext(),
          bool nullify = true);

  /**
   *  constructor creates new NDArray using shape information from "shapeInfo",
   * set all elements in new array to be zeros, if copyStrides is true then use
   * stride values from "shapeInfo", else calculate strides independently set
   * dtype as array type
   */
  NDArray(const Nd4jLong* shapeInfo, sd::DataType dtype,
          bool copyStrides = false,
          sd::LaunchContext* context = sd::LaunchContext::defaultContext(),
          bool nullify = true);

  /**
   *  this constructor creates new array using shape information contained in
   * vector argument
   */
  NDArray(char order, const std::vector<Nd4jLong>& shape,
          sd::DataType dtype = DOUBLE,
          sd::LaunchContext* context = sd::LaunchContext::defaultContext());

  /**
   * This constructor creates new array with elements copied from data and using
   * shape information stored in shape, elements from data will be casted to
   * dtype
   */
  NDArray(char order, const std::vector<Nd4jLong>& shape,
          const std::vector<double>& data, sd::DataType dtype = DOUBLE,
          sd::LaunchContext* context = sd::LaunchContext::defaultContext());

  /**
   *  this constructor creates new array using given buffer (without memory
   * allocation) and shape information stored in shape
   */
  NDArray(void* buffer, char order, const std::vector<Nd4jLong>& shape,
          sd::DataType dtype,
          sd::LaunchContext* context = sd::LaunchContext::defaultContext(),
          const bool isBuffAlloc = false);
   ...
   */
  explicit NDArray(
      const NDArray* other, bool copyStrides = false,
      sd::LaunchContext* context = sd::LaunchContext ::defaultContext());

  /**
   *  this constructor creates scalar(and set its value = 0) or empty array
   * depending on bool argument isScalar
   */
  NDArray(sd::DataType dtype,
          sd::LaunchContext* context = sd::LaunchContext::defaultContext(),
          bool isScalar = true);
  ...
  /**
   * This method returns buffer pointer offset by given number of elements, wrt
   * own data type
   * @param offset
   * @return
   */
   ...
   *  in particular, when _dataType != other._dataType and both shapes are the
   * same, there will be allocation of new _buffer and _dataType acquires
   * other._dataType
   */
  ...
  /**
   *  create a new array by replicating current array by repeats times along
   * given dimension axis - axis along which to repeat elements repeats - number
   * of repetitions
   */
   ...
   *  repeats - vector containing numbers of repetition for elements at given
   * axis
   */
  void repeat(const int axis, const std::vector<int>& repeats,
              NDArray& target) const;

  /**
   *  creates array which points on certain sub-range of this array, sub-range
   * is defined by given indices
   */
  ...
  /**
   *   returns device buffer if compilation is for cuda case, otherwise returns
   * host buffer
   */
  void* platformBuffer();
  ...
  void copyBuffersContinuouslyFrom(const NDArray& other,
                                   size_t sizeToCopyInBytes = 0,
                                   Nd4jLong offsetThis = 0,
                                   Nd4jLong offsetOther = 0);

  /**
   *  permutes the dimensions in array according to "dimensions" array, new
   * array points on _buffer of this array
   */
  ...
  void permute(const Nd4jLong* dimensions, const int rank,
               NDArray& target) const;
  void permute(const std::vector<Nd4jLong>& dimensions, NDArray& target) const;

  /**
   * This method streamlines given view or permuted array, and reallocates
   * buffer
   */
   ...
   *  sync - if true check whether host buffer is actual, if it is not then make
   * it so
   */
  ...
  /**
   *  prints _buffer (if host = true) or _bufferD (if host = false) as it is,
   * that is in current state without checking buffer status
   */
  template <typename T>
  void printCurrentBuffer(const bool host = true, const char* msg = nullptr,
                          const int precision = 1) const;

  /**
   *  prints buffer elements, takes into account offset between elements
   * (element-wise-stride) msg - message to print out limit - number of array
  ...
  /**
   * This method explicitly enforces new shape for this NDArray, old
   * shape/stride information is lost
   */
  void enforce(const std::initializer_list<Nd4jLong>& dimensions,
               char order = 'a');
  void enforce(std::vector<Nd4jLong>& dimensions, char order = 'a');

  /**
   *  method reduces array by excluding its shapes along dimensions present in
   * given dimensions vector, result is stored in new array to be returned
   *  dimensions - array of dimensions to reduce along
   *  keepDims - if true then put unities in place of reduced dimensions
   */

  NDArray reduceAlongDimension(sd::reduce::FloatOps op,
                               const std::vector<int>& dimensions,
                               const bool keepDims = false,
                               const bool supportOldShapes = false) const;
  NDArray reduceAlongDimension(sd::reduce::FloatOps op,
                               const std::initializer_list<int>& dimensions,
                               const bool keepDims = false,
                               const bool supportOldShapes = false) const;

  NDArray reduceAlongDimension(sd::reduce::SameOps op,
                               const std::vector<int>& dimensions,
                               const bool keepDims = false,
                               const bool supportOldShapes = false) const;
  NDArray reduceAlongDimension(sd::reduce::SameOps op,
  ...
  NDArray reduceAlongDimension(sd::reduce::BoolOps op,
                               const std::vector<int>& dimensions,
                               const bool keepDims = false,
                               const bool supportOldShapes = false) const;
  NDArray reduceAlongDimension(sd::reduce::BoolOps op,
  ...
  NDArray reduceAlongDimension(sd::reduce::LongOps op,
                               const std::vector<int>& dimensions,
                               const bool keepDims = false,
                               const bool supportOldShapes = false) const;
  NDArray reduceAlongDimension(sd::reduce::LongOps op,
  ...
  /**
   *  method reduces array by excluding its shapes along dimensions present in
   * given dimensions vector target - where to save result of reducing
   *  dimensions - array of dimensions to reduce along
   *  keepDims - if true then put unities in place of reduced dimensions
   *  extras - extra parameters
   */
  void reduceAlongDimension(sd::reduce::FloatOps op, NDArray& target,
                            const std::vector<int>& dimensions,
                            const bool keepDims = false,
                            const bool supportOldShapes = false,
                            const bool checkTargetShape = true) const;
  void reduceAlongDimension(sd::reduce::SameOps op, NDArray& target,
                            const std::vector<int>& dimensions,
                            const bool keepDims = false,
                            const bool supportOldShapes = false,
                            const bool checkTargetShape = true) const;
  void reduceAlongDimension(sd::reduce::BoolOps op, NDArray& target,
                            const std::vector<int>& dimensions,
                            const bool keepDims = false,
                            const bool supportOldShapes = false,
                            const bool checkTargetShape = true) const;
  void reduceAlongDimension(sd::reduce::LongOps op, NDArray& target,
                            const std::vector<int>& dimensions,
                            const bool keepDims = false,
                            const bool supportOldShapes = false,
                            const bool checkTargetShape = true) const;
   ...
   */
  NDArray reduceNumber(sd::reduce::FloatOps ops,
                       void* extraParams = nullptr) const;
  NDArray reduceNumber(sd::reduce::SameOps ops,
                       void* extraParams = nullptr) const;
  NDArray reduceNumber(sd::reduce::BoolOps ops,
                       void* extraParams = nullptr) const;
  NDArray reduceNumber(sd::reduce::LongOps ops,
                       void* extraParams = nullptr) const;

  void reduceNumber(sd::reduce::FloatOps ops, NDArray& target,
                    void* extraParams = nullptr) const;
  void reduceNumber(sd::reduce::SameOps ops, NDArray& target,
                    void* extraParams = nullptr) const;
  void reduceNumber(sd::reduce::BoolOps ops, NDArray& target,
                    void* extraParams = nullptr) const;
  void reduceNumber(sd::reduce::LongOps ops, NDArray& target,
                    void* extraParams = nullptr) const;

  /**
   *  returns element index which corresponds to some condition imposed by
   * operation extraParams - extra parameters for operation
   */
  NDArray indexReduceNumber(sd::indexreduce::Ops op,
                            ExtraArguments* extraParams = nullptr);

  /**
   *  returns index of max element in a given array (optionally: along given
   * dimension(s)) dimensions - optional vector with dimensions
   */
  ...
  void applyTransform(sd::transform::SameOps op, NDArray& target,
                      ExtraArguments* extraParams = nullptr);
  void applyTransform(sd::transform::AnyOps op, NDArray& target,
                      ExtraArguments* extraParams = nullptr);
  void applyTransform(sd::transform::BoolOps op, NDArray& target,
                      ExtraArguments* extraParams = nullptr);
  void applyTransform(sd::transform::StrictOps op, NDArray& target,
                      ExtraArguments* extraParams = nullptr);

  /**
   *  apply OpName transformation to this array and store result in new array to
   * be returned extraParams - extra parameters for operation
   */
  NDArray transform(sd::transform::FloatOps op,
                    void* extraParams = nullptr) const&;
  NDArray transform(sd::transform::SameOps op,
                    void* extraParams = nullptr) const&;
  NDArray transform(sd::transform::BoolOps op,
                    void* extraParams = nullptr) const&;
  NDArray transform(sd::transform::StrictOps op,
                    void* extraParams = nullptr) const&;
  ...
  /**
   *  apply pairwise OpName transformation based on "this" and "other" arras
   * elements, store result in this array other - second array necessary for
   * pairwise operation extraParams - extra parameters for operation
   */
  void applyPairwiseTransform(sd::pairwise::Ops op, const NDArray& other,
                              ExtraArguments* extraParams = nullptr);

  /**
   *  apply pairwise OpName transformation based on "this" and "other" arras
   * elements, store result in target array other - second array necessary for
   * pairwise operation target - where to store result extraParams - extra
  ...
  void applyPairwiseTransform(sd::pairwise::BoolOps op, const NDArray& other,
                              NDArray& target,
                              ExtraArguments* extraParams = nullptr) const;

  void applyPairwiseTransform(sd::pairwise::IntOps op, const NDArray& other,
                              NDArray& target,
                              ExtraArguments* extraParams = nullptr) const;

  /**
   *  apply operation which requires broadcasting, broadcast a smaller array
   * (tad) along  bigger one (this) tad - array to broadcast dimensions -
   * dimensions array to broadcast along target - where to store result
   *  extraParams - extra parameters for operation
   */
  void applyBroadcast(sd::broadcast::Ops op,
                      const std::initializer_list<int> dimensions,
                      const NDArray& tad, NDArray& target,
                      ExtraArguments* extraArgs = nullptr);

  void applyBroadcast(sd::broadcast::Ops op, const std::vector<int>& dimensions,
                      const NDArray& tad, NDArray& target,
                      ExtraArguments* extraArgs = nullptr);

  void applyBroadcast(sd::broadcast::BoolOps op,
                      const std::vector<int>& dimensions, const NDArray& tad,
                      NDArray& target, ExtraArguments* extraArgs = nullptr);

  void applyBroadcast(sd::broadcast::IntOps op,
                      const std::vector<int>& dimensions, const NDArray& tad,
                      NDArray& target, ExtraArguments* extraArgs = nullptr);

  /**
   *  apply operation which requires broadcasting, broadcast one tensor along
   * another, also this method checks the possibility of broadcasting other -
   * input array extraParams - extra parameters for operation
   */
  NDArray applyTrueBroadcast(sd::BroadcastOpsTuple op, const NDArray& other,
                             ExtraArguments* extraArgs = nullptr) const&;
  NDArray applyTrueBroadcast(sd::BroadcastOpsTuple op, NDArray&& other,
                             ExtraArguments* extraArgs = nullptr) const&;
  NDArray applyTrueBroadcast(sd::BroadcastOpsTuple op, NDArray&& other,
                             ExtraArguments* extraArgs = nullptr) &&;
  NDArray applyTrueBroadcast(sd::BroadcastOpsTuple op, const NDArray& other,
   ...
   *  apply operation which requires broadcasting, broadcast one tensor along
   * another, also this method checks the possibility of broadcasting other -
   * input array target - where to store result checkTargetShape - if true check
   * whether target shape is suitable for broadcasting extraParams - extra
   * parameters for operation
   */
  void applyTrueBroadcast(sd::BroadcastOpsTuple op, const NDArray& other,
                          NDArray& target, const bool checkTargetShape = true,
                          ExtraArguments* extraArgs = nullptr) const;

  void applyTrueBroadcast(sd::BroadcastBoolOpsTuple op, const NDArray& other,
                          NDArray& target, const bool checkTargetShape = true,
                          ExtraArguments* extraArgs = nullptr) const;

  void applyTrueBroadcast(sd::BroadcastIntOpsTuple op, const NDArray& other,
                          NDArray& target, const bool checkTargetShape = true,
                          ExtraArguments* extraArgs = nullptr) const;
   ...
   */
  template <typename T>
  void applyScalar(sd::scalar::Ops op, const T scalar, NDArray& target,
                   ExtraArguments* extraParams = nullptr);
  ...
  template <typename T>
  void applyScalar(sd::scalar::IntOps op, const T scalar, NDArray& target,
                   ExtraArguments* extraParams = nullptr) const;
   ...
   *  extraParams - extra parameters for operation
   */
  void applyScalarArr(sd::scalar::Ops op, const NDArray& scalar,
                      NDArray& target, ExtraArguments* extraParams = nullptr);

  void applyScalarArr(sd::scalar::BoolOps op, const NDArray& scalar,
                      NDArray& target,
                      ExtraArguments* extraParams = nullptr) const;

  void applyScalarArr(sd::scalar::IntOps op, const NDArray& scalar,
                      NDArray& target,
                      ExtraArguments* extraParams = nullptr) const;
  ...
  template <typename Lambda>
  FORCEINLINE void applyPairwiseLambda(const NDArray& other, Lambda func,
                                       NDArray& target);
  ...
  template <typename Lambda>
  FORCEINLINE void applyIndexedPairwiseLambda(NDArray& other, Lambda func,
                                              NDArray& target);

  template <typename Lambda>
  FORCEINLINE void applyTriplewiseLambda(NDArray& second, NDArray& third,
                                         Lambda func, NDArray& target);
#else
   ...
   */
  template <typename T>
  void applyPairwiseLambda(const NDArray& other,
                           const std::function<T(T, T)>& func, NDArray& target);

  template <typename T>
  void applyIndexedLambda(const std::function<T(Nd4jLong, T)>& func,
                          NDArray& target);

  template <typename T>
  void applyIndexedPairwiseLambda(NDArray& other,
                                  const std::function<T(Nd4jLong, T, T)>& func,
                                  NDArray& target);

  template <typename T>
  void applyTriplewiseLambda(NDArray& second, NDArray& third,
                             const std::function<T(T, T, T)>& func,
                             NDArray& target);
#endif
   ...
   */
  NDArray applyIndexReduce(sd::indexreduce::Ops op,
                           const std::vector<int>& dimensions,
   ...
   *  extraArgs - extra parameters for operation
   */
  void applyIndexReduce(sd::indexreduce::Ops op, NDArray& target,
                        const std::vector<int>& dimensions,
                        const ExtraArguments* extraParams = nullptr) const;

  /**
   *  apply reduce3 operation OpName to this and other array, return result in
   * new output array other - input array extraArgs - extra parameters for
   * operation
   */
  NDArray applyReduce3(sd::reduce3::Ops op, const NDArray& other,
                       const ExtraArguments* extraParams = nullptr) const;

  /**
   *  apply reduce3 operation OpName to this and other array, return result in
   * new output array other - input array dimensions - vector of dimensions to
   * reduce along (tads not axis) extraArgs - extra parameters for operation
   */
  NDArray applyAllReduce3(sd::reduce3::Ops op, const NDArray& other,
                          const std::vector<int>& dimensions,
                          const ExtraArguments* extraParams = nullptr) const;

  /**
   *  apply reduce3 (exec) operation OpName to this and other array, return
   * result in new output array other - input array dimensions - vector of
   * dimensions to reduce along (same as reduceAlongDimension) extraArgs - extra
   * parameters for operation
   */
  NDArray applyReduce3(sd::reduce3::Ops op, const NDArray& other,
                       const std::vector<int>& dimensions,
  ...
  NDArray varianceAlongDimension(
      sd::variance::Ops op, const bool biasCorrected,
      const std::initializer_list<int>& dimensions) const;

  void varianceAlongDimension(sd::variance::Ops op, NDArray& target,
                              const bool biasCorrected,
                              const std::vector<int>& dimensions) const;
  void varianceAlongDimension(
  ...
  /**
   *   apply transpose operation to the copy of this array, that is this array
   * remains unaffected
   */
  ...
  /**
   *  perform transpose operation and store result in target, this array remains
   * unaffected target - where to store result
   */
  void transpose(NDArray& target) const;

  /**
   *  apply in-place transpose operation to this array, so this array becomes
   * transposed
   */
  void transposei();
   ...
   */
  Nd4jLong tensorsAlongDimension(
      const std::initializer_list<int> dimensions) const;
  Nd4jLong tensorsAlongDimension(const std::vector<int>& dimensions) const;

  /**
   *  returns true if elements of two arrays are equal to within given epsilon
   * value other - input array to compare eps - epsilon, this value defines the
   * precision of elements comparison
   */
  ...
  /**
   *  subtract given row vector from all rows of this array, store result in
   * target row - row vector to subtract target - where to store result
   */
  void subRowVector(const NDArray& row, NDArray& target) const;

  /**
   *  multiply all rows of this array on given row vector, store result in
   * target row - row vector to multiply on target - where to store result
   */
  ...
  /**
   *  add given column vector to all columns of this array, store result in
   * target column - column vector to add target - where to store result
   */
  void addColumnVector(const NDArray& column, NDArray& target) const;

  /**
   *  add given column vector to all columns of this array, this array becomes
   * affected (in-place operation) column - column vector to add
   */
  void addiColumnVector(const NDArray& column);

  /**
   *  multiply all columns of this array on given column vector, this array
   * becomes affected (in-place operation) column - column vector to multiply on
   */
  ...
  /**
   *  set new order and shape in case of suitable array length (in-place
   * operation) order - order to set shape - shape to set copyToNewBuff - if
   * true then old buffer will be copied to new buffer if last one will be
   * allocated after reshaping if there was permute applied before or there are
   * weird strides, then new buffer is allocated for array
   */
  bool reshapei(const char order, const std::initializer_list<Nd4jLong>& shape,
                const bool copyToNewBuff = true);
  ...
  /**
   *  creates new array with corresponding order and shape, new array will point
   * on _buffer of this array order - order to set shape - shape to set
   *
   * if permute have been applied before or there are weird strides, then new
   * buffer is allocated for new array
   */
  NDArray reshape(const char order, const std::vector<Nd4jLong>& shape,
                  const bool copyToNewBuff = true) const&;
  NDArray reshape(const char order, const std::vector<Nd4jLong>& shape,
                  const bool copyToNewBuff = true) &&;
   ...
   * (in-place operation) repeats - contains numbers of repetitions
   */
  void tilei(const std::vector<Nd4jLong>& repeats);

  /**
   *  returns new array which is created by repeating of this array the number
   * of times given by reps repeats - contains numbers of repetitions
   */
  NDArray tile(const std::vector<Nd4jLong>& repeats) const;

  /**
   *  change an array by repeating it the number of times given by reps
   * (in-place operation) repeats - contains numbers of repetitions target -
   * where to store result
   */
  void tile(const std::vector<Nd4jLong>& repeats, NDArray& target) const;

  /**
   *  change an array by repeating it the number of times to acquire the new
   * shape which is the same as target shape target - where to store result
   */
  ...
  /**
   *  operator returns subarray with buffer pointing at this->_buffer with
   * offset defined by given intervals idx - intervals of indexes which define
   * the subarrays to point on, idx has form {dim0Start,dim0End,
   * dim1Start,dim1End, ....} and length (2 * this->rankOf()) when (dimStart ==
   * dimEnd) then whole range will be used for current dimension
   *  keepUnitiesInShape - if false then eliminate unities from resulting array
   * shape, for example {1,a,1,b} -> {a,b} isStrided - if true then idx has
   * length (3 * this->rankOf()) and contains additional stride numbers which
   * correspond to stride between dimStart and dimEnd, so structure of idx is
   * like {dim0Start,dim0End,dim0Stride,    dim1Start,dim1End,dim1Stride, ....}
   */
  NDArray operator()(const std::vector<Nd4jLong>& idx,
                     const bool keepUnitiesInShape = false,
                     const bool isStrided = false) const;

  /**
   *  evaluates subarray with buffer pointing at this->_buffer and offset
   * defined by given sequential index subArrIdx and dimensions in dimsToExclude
   *  subArrIdx - index of current sub-array
   *  dimsToExclude - MUST BE SORTED, dimensions to evaluate sub-array along,
   * i.e. when shape is [2,3,4,5] and dimsToExclude={0,2}, then there will be 8
   * sub-arrays with shape [3,5], and subArrIdx must be in range [0,7] if
   * dimsToExclude is empty then idxRanges containing all zeros (means whole
   * array) will be returned. keepUnitiesInShape - if false then eliminate
   * unities from resulting array shape, for example {1,a,1,b} -> {a,b}
   */
  NDArray operator()(const Nd4jLong subArrIdx,
   ...
   * original this-buffer) dimsToExclude - MUST BE SORTED, dimensions to
   * evaluate sub-array along, i.e. when shape is [2,3,4,5] and
   * dimsToExclude={0,2}, then there will be 8 sub-arrays with shape [3,5] if
   * dimsToExclude.size() = array rank it means sub-array is whole array and
   * copy of original_shapeInfo will be returned and one zero offset
   * subArrShapeInfo    - output argument, contains shapeInfo common for all
   ...
   * {a,b}
   */
  void getSubArrShapeAndOffsets(const std::vector<int>& dimsToExclude,
  ...
  /**
   *  makes array to be identity matrix (not necessarily square), that is set
   * all diagonal elements = 1, rest = 0
   */
  void setIdentity();

  /**
   *  swaps the contents of tow arrays,
   *  PLEASE NOTE: method doesn't take into account the shapes of arrays, shapes
   * may be different except one condition: arrays lengths must be the same
   */
  void swapUnsafe(NDArray& other);

  /**
   *  return vector with buffer which points on corresponding diagonal elements
   * of array type - means of vector to be returned: column ('c') or row ('r')
   */
  NDArray diagonal(const char type) const;

  /**
   * fill target matrix with given value in one or two directions from main
   * diagonal:
   *   - down from main diagonal starting at subdiagonal number "lower" if
   * direction = 'd' (down) or 'b' (both)
   *   - up from main diagonal starting at superdiagonal number "upper"if
   * direction = 'u' (up) or 'b' (both) direction - in what direction to fill
   * matrix. There are 3 possible directions: 'u' - fill up, mathematically this
   * corresponds to lower triangular matrix, subdiagonal "lower" unaffected 'l'
   * - fill down, mathematically this corresponds to upper triangular matrix,
   * superdiagonal "upper" remains unaffected 'b' - fill in both directions,
   * both "lower" and "upper" are taken into account rest of target elements are
   * equal to this array elements target and this array should have same shapes,
   * except when this_rank = 1 (in that case should be target_rank = 2)
   */
  template <typename T>
  void fillAsTriangular(const float value, int lower, int upper,
                        NDArray& target, const char direction = 'b');

  /**
   *  change an array by repeating it the number of times in order to acquire
   * new shape equal to the input shape
   *
   *  shape  - contains new shape to broadcast array to
   *  target - optional argument, if target != nullptr the resulting array will
   * be placed in target, in opposite case tile operation is done in place
   */
  NDArray tileToShape(const Nd4jLong* shapeInfo);
  void tileToShape(const std::vector<Nd4jLong>& shape, NDArray& target);
#ifndef __JAVACPP_HACK__
  void tileToShape(const std::initializer_list<Nd4jLong>& shape,
                   NDArray& target);
#endif
  ...
  /**
   *  calculates the trace of an array, that is sum of elements on main diagonal
   * = sum array[i, i, i, ...]
   */
  double getTrace() const;

  ResultSet multipleTensorsAlongDimension(
      const std::vector<int>& indices,
      const std::vector<int>& dimensions) const;

  ResultSet allTensorsAlongDimension(
      const std::initializer_list<int>& dimensions) const;
  ...
  FORCEINLINE bool isSameShape(const NDArray& other) const;
  FORCEINLINE bool isSameShape(
      const std::initializer_list<Nd4jLong>& shape) const;
  ...
  /**
   *  returns true if these two NDArrays have same rank, dimensions, strides,
   * ews and order
   */
   ...
   */
  template <typename T>
  T e(const Nd4jLong i, const Nd4jLong j, const Nd4jLong k,
  ...
  /**
   *  assigns given scalar to array element by given index, regards array buffer
   * as linear i - element index in array value - scalar value to assign
   */
  template <typename T>
  ...
  template <typename T>
  void p(const Nd4jLong i, const Nd4jLong j, const Nd4jLong k, const Nd4jLong l,
         const T value);
  void p(const Nd4jLong i, const Nd4jLong j, const Nd4jLong k, const Nd4jLong l,
         NDArray const& value);
  ...
  /**
   *  returns true if all dimensions of array except one are unities, for
   * example: [1,1,n,1], [n,1,1], [n], ... posOfNonUnityDim - one dimension with
   * value > 1
   */
...
//////////////////////////////////////////////////////////////////////////
Nd4jLong* NDArray::shapeOf() const { return shape::shapeOf(_shapeInfo); }

//////////////////////////////////////////////////////////////////////////
Nd4jLong* NDArray::stridesOf() const { return shape::stride(_shapeInfo); }

//////////////////////////////////////////////////////////////////////////
int NDArray::rankOf() const { return shape::rank(_shapeInfo); }

//////////////////////////////////////////////////////////////////////////
Nd4jLong NDArray::lengthOf() const { return _length; }
...
bool NDArray::isSameShape(const NDArray* other) const {
  ...
  return isSameShape(std::vector<Nd4jLong>(
      other->_shapeInfo + 1, other->_shapeInfo + 1 + other->_shapeInfo[0]));
}
...
bool NDArray::operator==(const NDArray& other) const {
  // if (this->dataType() != other.dataType())    // this comparison is already
  // present in equalsTo
  //         return false;
...
T& NDArray::t(const Nd4jLong i) {
  // if (i >= _length)
  //     throw std::invalid_argument("NDArray::t(i): input index is out of array
  //     length !");
  if (DataTypeUtils::fromT<T>() != _dataType)
    throw std::invalid_argument(
        "NDArray::t(i): type of array is not equal to template type T!");
...
T& NDArray::t(const Nd4jLong i, const Nd4jLong j) {
  if (rankOf() != 2 || i >= sizeAt(0) || j >= sizeAt(1))
    throw std::invalid_argument(
        "NDArray::t(i,j): one of input indexes is out of array length or "
        "rank!=2 !");
  if (DataTypeUtils::fromT<T>() != _dataType)
    throw std::invalid_argument(
        "NDArray::t(i,j): type of array is not equal to template type T!");
...
T& NDArray::t(const Nd4jLong i, const Nd4jLong j, const Nd4jLong k) {
  if (rankOf() != 3 || i >= sizeAt(0) || j >= sizeAt(1) || k >= sizeAt(2))
    throw std::invalid_argument(
        "NDArray::t(i,j,k): one of input indexes is out of array length or "
        "rank!=3!");
  if (DataTypeUtils::fromT<T>() != _dataType)
    throw std::invalid_argument(
        "NDArray::t(i,j,k): type of array is not equal to template type T!");
...
T& NDArray::t(const Nd4jLong i, const Nd4jLong j, const Nd4jLong k,
  ...
  if (rankOf() != 4 || i >= sizeAt(0) || j >= sizeAt(1) || k >= sizeAt(2) ||
      w >= sizeAt(3))
    throw std::invalid_argument(
        "NDArray::t(i,j,k,w): one of input indexes is out of array length or "
        "rank!=4 !");
  if (DataTypeUtils::fromT<T>() != _dataType)
    throw std::invalid_argument(
        "NDArray::t(i,j,k,w): type of array is not equal to template type T!");
...
const void* NDArray::buffer() const {
  return _buffer->primary() != nullptr
             ? static_cast<int8_t*>(_buffer->primary()) + (_offset * sizeOfT())
             : nullptr;
}
...
//////////////////////////////////////////////////////////////////////////
const Nd4jLong* NDArray::shapeInfo() const { return _shapeInfo; }
...
////////////////////////////////////////////////////////////////////////
Nd4jLong NDArray::bufferOffset() const { return _offset; }
