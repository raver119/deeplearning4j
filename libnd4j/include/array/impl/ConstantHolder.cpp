...
BUILD_SINGLE_TEMPLATE(template SD_EXPORT bool ConstantHolder::hasBuffer, (void),
                      LIBND4J_TYPES);
...
BUILD_SINGLE_TEMPLATE(template SD_EXPORT void ConstantHolder::addBuffer,
                      (ConstantDataBuffer & cb), LIBND4J_TYPES);
...
BUILD_SINGLE_TEMPLATE(template SD_EXPORT ConstantDataBuffer*
                          ConstantHolder::getConstantDataBuffer,
                      (), LIBND4J_TYPES);
}  // namespace sd