...
class SD_EXPORT ArrayOptions {
 ...
 public:
  ...
  static FORCEINLINE _CUDA_HD bool hasPropertyBitSet(const Nd4jLong *shapeInfo,
                                                     int property);
  static FORCEINLINE _CUDA_HD bool togglePropertyBit(Nd4jLong *shapeInfo,
                                                     int property);
  static FORCEINLINE _CUDA_HD void unsetPropertyBit(Nd4jLong *shapeInfo,
                                                    int property);
  static FORCEINLINE _CUDA_HD void setPropertyBit(Nd4jLong *shapeInfo,
                                                  int property);
  static FORCEINLINE _CUDA_HD void setPropertyBits(
      Nd4jLong *shapeInfo, std::initializer_list<int> properties);
  ...
  static FORCEINLINE _CUDA_HD void setDataType(Nd4jLong *shapeInfo,
                                               const sd::DataType dataType);

  static FORCEINLINE _CUDA_HD void copyDataType(Nd4jLong *to,
                                                const Nd4jLong *from);
};
...
FORCEINLINE _CUDA_HD bool ArrayOptions::hasExtraProperties(
    Nd4jLong *shapeInfo) {
  return hasPropertyBitSet(shapeInfo, ARRAY_EXTRAS);
}

FORCEINLINE _CUDA_HD bool ArrayOptions::hasPropertyBitSet(
    const Nd4jLong *shapeInfo, int property) {
...
FORCEINLINE _CUDA_HD sd::DataType ArrayOptions::dataType(
  ...
  if (hasPropertyBitSet(shapeInfo, ARRAY_FLOAT))
    ...
    if (hasPropertyBitSet(shapeInfo, ARRAY_CHAR))
      ...
      // shape::printShapeInfoLinear("Bad unsigned datatype (not)stored in
      // shape", const_cast<Nd4jLong*>(shapeInfo));
    ...
    // shape::printShapeInfoLinear("Bad signed datatype (not)stored in shape",
    // const_cast<Nd4jLong*>(shapeInfo));
#ifndef __CUDA_ARCH__
...
FORCEINLINE _CUDA_HD SpaceType
ArrayOptions::spaceType(const Nd4jLong *shapeInfo) {
...
FORCEINLINE _CUDA_HD ArrayType
ArrayOptions::arrayType(const Nd4jLong *shapeInfo) {
...
FORCEINLINE _CUDA_HD bool ArrayOptions::togglePropertyBit(Nd4jLong *shapeInfo,
                                                          int property) {
...
FORCEINLINE _CUDA_HD void ArrayOptions::setPropertyBit(Nd4jLong *shapeInfo,
                                                       int property) {
  extra(shapeInfo) |= property;
}

FORCEINLINE _CUDA_HD void ArrayOptions::unsetPropertyBit(Nd4jLong *shapeInfo,
                                                         int property) {
  extra(shapeInfo) &= property;
}

FORCEINLINE _CUDA_HD SparseType
ArrayOptions::sparseType(const Nd4jLong *shapeInfo) {
...
FORCEINLINE _CUDA_HD void ArrayOptions::setPropertyBits(
    Nd4jLong *shapeInfo, std::initializer_list<int> properties) {
...
FORCEINLINE _CUDA_HD void ArrayOptions::setDataType(
    Nd4jLong *shapeInfo, const sd::DataType dataType) {
  resetDataType(shapeInfo);
  if (dataType == sd::DataType::UINT8 || dataType == sd::DataType::UINT16 ||
      dataType == sd::DataType::UINT32 || dataType == sd::DataType::UINT64) {
...
////////////////////////////////////////////////////////////////////////////////
FORCEINLINE _CUDA_HD void ArrayOptions::copyDataType(Nd4jLong *to,
                                                     const Nd4jLong *from) {
