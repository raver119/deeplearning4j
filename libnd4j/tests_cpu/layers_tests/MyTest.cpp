...
TEST_F(MyTests, test_rgb_to_yiq_1) {
    /**
...
TEST_F(MyTests, test_rgb_to_yiq_2) {
...
TEST_F(MyTests, test_rgb_to_yiq_3) {
...
TEST_F(MyTests, test_rgb_to_yiq_4) {
...
TEST_F(MyTests, test_rgb_to_yiq_5) {
...
TEST_F(MyTests, test_rgb_to_yiq_6) {
    ...
    //get subarray 
    std::unique_ptr<NDArray> subArrRgbs(rgbs.subarray({ NDIndex::all(), NDIndex::point(0) }));
    std::unique_ptr<NDArray> expected(yiqs.subarray({ NDIndex::all(), NDIndex::point(0) }));
    subArrRgbs->reshapei({ 3 });
    expected->reshapei({ 3 });
#if 0
    //[RANK][SHAPE][STRIDES][OPTIONS][EWS][ORDER]
...
TEST_F(MyTests, test_yiq_to_rgb_1) {
...
TEST_F(MyTests, test_yiq_to_rgb_2) {
...
TEST_F(MyTests, test_yiq_to_rgb_3) {
...
TEST_F(MyTests, test_yiq_to_rgb_4) {
...
TEST_F(MyTests, test_yiq_to_rgb_5) {
...
TEST_F(MyTests, test_yiq_to_rgb_6) {
    ...
    //get subarray 
    std::unique_ptr<NDArray> subArrYiqs(yiqs.subarray({ NDIndex::all(), NDIndex::point(0) }));
    std::unique_ptr<NDArray> expected(rgbs.subarray({ NDIndex::all(), NDIndex::point(0) }));
    ...
    Context ctx(1);
    ctx.setInputArray(0, subArrYiqs.get());
    ctx.setOutputArray(0, &actual);
    nd4j::ops::yiq_to_rgb op;
    auto status = op.execute(&ctx);
