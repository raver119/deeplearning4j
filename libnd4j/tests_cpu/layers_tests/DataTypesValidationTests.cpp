...
TEST_F(DataTypesValidationTests, Basic_Test_2) {
  ...
  auto exp = NDArrayFactory::create<float16>(
      'c', {1, 4, 1, 4},
      {2., 4., 6., 8., 2., 4., 6., 8., 2., 4., 6., 8., 2., 4., 6., 8.});
...
TEST_F(DataTypesValidationTests, Basic_Test_3) {
  ...
  auto exp = NDArrayFactory::create<bfloat16>(
      'c', {1, 4, 1, 4},
      {2., 4., 6., 8., 2., 4., 6., 8., 2., 4., 6., 8., 2., 4., 6., 8.});
  ...
  sd::ops::conv2d op;
  auto result = op.execute({&input, &weights}, {&out}, {},
                           {1, 1, 1, 1, 0, 0, 1, 1, 0, 0}, {});
...
TEST_F(DataTypesValidationTests, test_bits_hamming_distance_1) {
  auto x = NDArrayFactory::create<int>('c', {3},
                                       {0b01011000, 0b01011111, 0b01111110});
  auto y = NDArrayFactory::create<int>('c', {3},
                                       {0b00010110, 0b01011000, 0b01011000});
