...
TEST_F(MultiDataTypeTests, DataTypeUtils_Test_2) {
  ...
  ASSERT_EQ(sd::DOUBLE,
            DataTypeUtils::pickPairwiseResultType(sd::DOUBLE, sd::INT32));
}
...
TEST_F(MultiDataTypeTests, Basic_Test_3) {
  ...
  auto e = NDArrayFactory::create<double>(
      'c', {2, 3}, {0.0f, 2.0f, 4.0f, 6.0f, 8.0f, 10.0f});
...
TEST_F(MultiDataTypeTests, ndarray_repeat_test1) {
  ...
  NDArray exp('c', {2, 4}, {0.5, 0.5, 1.5, 1.5, 2.5, 2.5, 3.5, 3.5},
              sd::DataType::HALF);
...
TEST_F(MultiDataTypeTests, ndarray_reduceAlongDimension_test1) {
  ...
  auto scalar1 =
      x.reduceAlongDimension(sd::reduce::CountNonZero, {} /*whole range*/);
  ASSERT_EQ(scalar1, exp1);

  auto scalar2 =
      x.reduceAlongDimension(sd::reduce::CountZero, {} /*whole range*/, true);
...
TEST_F(MultiDataTypeTests, ndarray_reduceAlongDimension_test4) {
  ...
  auto scalar1 =
      x.reduceAlongDimension(sd::reduce::IsPositive, {} /*whole range*/);
  ASSERT_EQ(scalar1, exp1);
...
TEST_F(MultiDataTypeTests, ndarray_varianceNumber_test1) {
  ...
  NDArray exp1('c', {}, std::vector<double>{1.666666667},
               sd::DataType::FLOAT32);
  NDArray exp2('c', {}, std::vector<double>{1.118033989},
               sd::DataType::FLOAT32);
  ...
  auto scalar2 =
      x.varianceNumber(variance::SummaryStatsStandardDeviation, false);
  ASSERT_EQ(scalar2, exp2);
}
...
TEST_F(MultiDataTypeTests, ndarray_operatorPlusEqual_test1) {
  ...
  NDArray x1('c', {2, 3}, {1.5, 2.5, 3.5, 4.5, 5.5, 6.5},
             sd::DataType::FLOAT32);
  ...
  NDArray exp4('c', {2, 3}, {12.5, 24.5, 36.5, 48.5, 60.5, 72.5},
               sd::DataType::FLOAT32);
...
TEST_F(MultiDataTypeTests, ndarray_operatorMinusEqual_test1) {
  ...
  NDArray exp4('c', {2, 3}, {-6.5, -14.5, -22.5, -30.5, -38.5, -46.5},
               sd::DataType::FLOAT32);
...
TEST_F(MultiDataTypeTests, ndarray_operatorMultiplyEqual_test1) {
  ...
  NDArray exp4('c', {2, 3}, {1.5, 12.5, 35, 81, 148.5, 253.5},
               sd::DataType::FLOAT32);
...
TEST_F(MultiDataTypeTests, ndarray_operatorDivideEqual_test1) {
  ...
  NDArray exp4('c', {2, 3},
               {0.25, 0.3125, 0.4375, 0.5625, 0.611111111, 0.722222222},
               sd::DataType::FLOAT32);
...
TEST_F(MultiDataTypeTests, ndarray_operatorDivideEqual_test2) {
  ...
  NDArray exp5('c', {2, 2}, {0, 0.45454545, 0.909090909, 1.363636364},
               sd::DataType::FLOAT32);
...
TEST_F(MultiDataTypeTests, ndarray_applyTransformSame_test1) {
  ...
  NDArray exp5('c', {3, 2}, {0, 2.25, 6.25, 12.25, 20.25, 30.25},
               sd::DataType::DOUBLE);
...
TEST_F(MultiDataTypeTests, ndarray_applyPairwiseTransform_test1) {
  ...
  NDArray exp2('c', {2, 3}, {0.5, 2.5, 4.5, 6.5, 8.5, 5.},
               sd::DataType::FLOAT32);
  NDArray exp3('c', {2, 3}, {1, 1, 1, 1, 1, 0}, sd::DataType::BOOL);
  NDArray exp4('c', {2, 3}, {0.5, 2.5, 4.5, 6.5, 8.5, 5.},
               sd::DataType::DOUBLE);
...
TEST_F(MultiDataTypeTests, ndarray_applyTrueBroadcast_test2) {
  ...
  x1.applyTrueBroadcast(
      BroadcastBoolOpsTuple(sd::scalar::EqualTo, sd::pairwise::EqualTo,
                            sd::broadcast::EqualTo),
      x2, x3);
  ASSERT_EQ(x3, exp1);
  ...
  x4.applyTrueBroadcast(
      BroadcastBoolOpsTuple(sd::scalar::EqualTo, sd::pairwise::EqualTo,
                            sd::broadcast::EqualTo),
      x1, x3);
  ASSERT_EQ(x3, exp2);

  x5.applyTrueBroadcast(
      BroadcastBoolOpsTuple(sd::scalar::EqualTo, sd::pairwise::EqualTo,
                            sd::broadcast::EqualTo),
      x4, x6);
  ASSERT_EQ(x6, exp3);
...
TEST_F(MultiDataTypeTests, ndarray_applyIndexedPairwiseLambda_test1) {
  ...
  auto func1 = [](Nd4jLong idx, float elem1, float elem2) {
    return elem1 + elem2 + idx;
  };
  auto func2 = [](Nd4jLong idx, int elem1, float elem2) {
    return elem1 + elem2 + idx;
  };
  auto func3 = [](Nd4jLong idx, int elem1, double elem2) {
    return elem1 + elem2 + idx;
  };
  auto func4 = [](Nd4jLong idx, double elem1, float elem2) {
    return elem1 + elem2 + idx;
  };
  auto func5 = [](Nd4jLong idx, float elem1, int elem2) {
    return elem1 - elem2 + idx;
  };
...
TEST_F(MultiDataTypeTests, ndarray_applyTriplewiseLambda_test1) {
  ...
  auto func1 = [](double elem1, float elem2, int elem3) {
    return elem1 + elem2 + elem3;
  };
  auto func2 = [](float elem1, float elem2, float elem3) {
    return elem1 + elem2 + elem3;
  };
  auto func3 = [](int elem1, int elem2, int elem3) {
    return elem1 + elem2 + elem3;
  };
  auto func4 = [](bool elem1, bool elem2, bool elem3) {
    return elem1 + elem2 + elem3;
  };
...
TEST_F(MultiDataTypeTests, RowCol_test1) {
  ...
  NDArray exp3('c', {2, 3}, {1.5, 2.5, 3.5, 4.6, 5.6, 6.6},
               sd::DataType::DOUBLE);
...
TEST_F(MultiDataTypeTests, assign_test2) {
  ...
  NDArray exp2('c', {3, 2}, {1.5, 2.5, 3.5, 4.5, 5.5, 6.5},
               sd::DataType::DOUBLE);
...
TEST_F(MultiDataTypeTests, aaa) {
  ...
  NativeOpExecutioner::execRandom(
      LaunchContext::defaultContext(), sd::random::UniformDistribution, &gen,
