...
TEST_F(ShapeUtilsTests, evalReduceShapeInfo_test1) {
  ...
  auto newShapeInfo =
      ShapeUtils::evalReduceShapeInfo('c', dimensions, x.shapeInfo());
...
TEST_F(ShapeUtilsTests, evalReduceShapeInfo_test2) {
  ...
  auto newShapeInfo =
      ShapeUtils::evalReduceShapeInfo('c', dimensions, x.shapeInfo(), true);
...
TEST_F(ShapeUtilsTests, evalPermutFromTo_test1) {
  ...
  std::vector<int> result =
      ShapeUtils::evalPermutFromTo({a, b, c, d}, {c, d, a, b});
...
TEST_F(ShapeUtilsTests, evalPermutFromTo_test2) {
  ...
  std::vector<int> result =
      ShapeUtils::evalPermutFromTo({a, b, c, d}, {a, b, d, c});
...
TEST_F(ShapeUtilsTests, evalPermutFromTo_test4) {
  ...
  std::vector<int> result =
      ShapeUtils::evalPermutFromTo({a, b, c, d}, {a, b, c, d});
...
TEST_F(ShapeUtilsTests, evalPermutFromTo_test5) {
  ...
  // EXPECT_THROW(ShapeUtils::evalPermutFromTo({a,b,c,d}, {c,d,a,8}), const
  // char*);
  ASSERT_TRUE(1);
}
...
TEST_F(ShapeUtilsTests, evalPermutFromTo_test6) {
  ...
  // EXPECT_THROW(ShapeUtils::evalPermutFromTo({a,b,c,d}, {a,b,c,d,d}), const
  // char*);
  ASSERT_TRUE(1);
}
