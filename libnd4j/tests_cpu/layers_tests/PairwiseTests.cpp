...
class EqualsTest : public testing::Test {
 public:
  ...
  float dataSecond[12] = {1.0f, 2.0f, 3.0f, 4.0f,  5.0f,  6.0f,
...
TEST_F(EqualsTest, Eps) {
  ...
  functions::reduce3::Reduce3<float, float>::execScalar(
      opNum, data, firstShapeBuffer, extraArgs, dataSecond, secondShapeBuffer,
      val.buffer(), val.shapeInfo());
