...
TEST_F(ConditionalTests, Flat_Test_1) {
    ...
    auto exp = NDArrayFactory::create<float>({2, 2}, {-2, -2, -2, -2});
...
TEST_F(ConditionalTests, Flat_Test_2) {
    ...
    auto exp = NDArrayFactory::create<float>( {2, 2}, {1, 1, 1, 1});
...
TEST_F(ConditionalTests, Flat_Test_5) {
    ...
    auto exp = NDArrayFactory::create<float>( {2, 2}, {4, 4, 4, 4});
    ASSERT_TRUE(exp.equalsTo(z));
...
TEST_F(ConditionalTests, Flat_Test_7) {
    ...
    auto exp = NDArrayFactory::create<float>( {2, 2}, {-3, -3, -3, -3});
    ASSERT_TRUE(exp.equalsTo(z));
...
TEST_F(ConditionalTests, Flat_Test_8) {
    ...
    auto exp = NDArrayFactory::create<float>({2, 2}, {15, 15, 15, 15});
    ASSERT_TRUE(exp.equalsTo(z));
