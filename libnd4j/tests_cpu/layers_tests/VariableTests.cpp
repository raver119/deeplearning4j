...
TEST_F(VariableTests, Test_FlatVariableDataType_1) {
  ...
  auto fArray =
      CreateFlatArray(builder, fShape, fBuffer, sd::graph::DType::DType_FLOAT);

  auto flatVar = CreateFlatVariable(builder, fVid, 0,
...
TEST_F(VariableTests, Test_FlatVariableDataType_2) {
  ...
  auto fArray =
      CreateFlatArray(builder, fShape, fBuffer, sd::graph::DType::DType_DOUBLE);

  auto flatVar = CreateFlatVariable(builder, fVid, 0,
                                    sd::graph::DType::DType_DOUBLE, 0, fArray);
...
TEST_F(VariableTests, Test_FlatVariableDataType_4) {
    ...
    auto flatVar = CreateFlatVariable(builder, fVid, 0,
sd::graph::DType::DType_FLOAT, fShape, 0, 0, VarType_PLACEHOLDER);
