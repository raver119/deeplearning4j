...
TEST_F(RNGTests, Test_Dropout_1) {
  ...
  RandomLauncher::applyDropOut(LaunchContext::defaultContext(), _rngA, &x0,
                               0.5);
  RandomLauncher::applyDropOut(LaunchContext::defaultContext(), _rngB, &x1,
                               0.5);
...
TEST_F(RNGTests, Test_DropoutInverted_1) {
  ...
  // x0.template applyRandom<randomOps::DropOutInverted<float>>(_rngA, nullptr,
  // &x0, prob); x1.template
  // applyRandom<randomOps::DropOutInverted<float>>(_rngB, nullptr, &x1, prob);
  RandomLauncher::applyInvertedDropOut(LaunchContext::defaultContext(), _rngA,
                                       &x0, 0.5);
  RandomLauncher::applyInvertedDropOut(LaunchContext::defaultContext(), _rngB,
                                       &x1, 0.5);
  ASSERT_TRUE(x0.equalsTo(&x1));
...
TEST_F(RNGTests, Test_Launcher_3) {
  ...
  RandomLauncher::applyAlphaDropOut(LaunchContext::defaultContext(), _rngA, &x0,
                                    0.5f, 0.2f, 0.1f, 0.3f);
  RandomLauncher::applyAlphaDropOut(LaunchContext::defaultContext(), _rngB, &x1,
                                    0.5f, 0.2f, 0.1f, 0.3f);
...
TEST_F(RNGTests, Test_Uniform_1) {
  ...
  RandomLauncher::fillUniform(LaunchContext::defaultContext(), _rngA, &x0, 1.0f,
                              2.0f);
  RandomLauncher::fillUniform(LaunchContext::defaultContext(), _rngB, &x1, 1.0f,
                              2.0f);
...
TEST_F(RNGTests, Test_Bernoulli_1) {
  ...
  RandomLauncher::fillBernoulli(LaunchContext::defaultContext(), _rngA, &x0,
                                1.0f);
  RandomLauncher::fillBernoulli(LaunchContext::defaultContext(), _rngB, &x1,
                                1.0f);
...
TEST_F(RNGTests, Test_Gaussian_1) {
  ...
  RandomLauncher::fillGaussian(LaunchContext::defaultContext(), _rngA, &x0,
                               1.0f, 2.0f);
  RandomLauncher::fillGaussian(LaunchContext::defaultContext(), _rngB, &x1,
                               1.0f, 2.0f);
...
TEST_F(RNGTests, Test_Gaussian_22) {
  ...
  RandomLauncher::fillGaussian(sd::LaunchContext::defaultContext(), _rngA, &x0,
                               0.0f, 1.0f);
  RandomLauncher::fillGaussian(LaunchContext::defaultContext(), _rngB, &x1,
                               0.0f, 1.0f);
...
TEST_F(RNGTests, Test_Gaussian_3) {
  ...
  RandomLauncher::fillGaussian(LaunchContext::defaultContext(), _rngA, &x0, 0.0,
                               1.0);

  auto mean = x0.meanNumber();  //.e<double>(0);
  auto stdev = x0.varianceNumber(sd::variance::SummaryStatsStandardDeviation,
                                 false);  //.e<double>(0);
...
TEST_F(RNGTests, Test_LogNormal_1) {
  ...
  RandomLauncher::fillLogNormal(LaunchContext::defaultContext(), _rngA, &x0,
                                1.0f, 2.0f);
  RandomLauncher::fillLogNormal(LaunchContext::defaultContext(), _rngB, &x1,
                                1.0f, 2.0f);
...
TEST_F(RNGTests, Test_Truncated_1) {
  ...
  RandomLauncher::fillTruncatedNormal(LaunchContext::defaultContext(), _rngA,
                                      &x0, 1.0f, 2.0f);
  RandomLauncher::fillTruncatedNormal(LaunchContext::defaultContext(), _rngB,
                                      &x1, 1.0f, 2.0f);
  ...
  auto deviation =
      x1.varianceNumber(variance::SummaryStatsStandardDeviation, false);
...
TEST_F(RNGTests, Test_Truncated_21) {
  ...
  auto deviation0 =
      x0.varianceNumber(variance::SummaryStatsStandardDeviation, false);
...
TEST_F(RNGTests, Test_Binomial_1) {
  ...
  RandomLauncher::fillBinomial(LaunchContext::defaultContext(), _rngA, &x0, 3,
                               2.0f);
  RandomLauncher::fillBinomial(LaunchContext::defaultContext(), _rngB, &x1, 3,
                               2.0f);
...
TEST_F(RNGTests, Test_Uniform_2) {
  ...
  auto result =
      op.execute(_rngA, {&input}, {1.0f, 2.0f}, {}, {sd::DataType::FLOAT32});
...
TEST_F(RNGTests, Test_Uniform_SGA_3) {
  ...
  RandomLauncher::fillUniform(LaunchContext::defaultContext(), _rngB, &x1,
                              -sd::DataTypeUtils::template max<float>(),
                              sd::DataTypeUtils::template max<float>());
...
TEST_F(RNGTests, Test_ExponentialDistribution_3_SGA) {
  ...
  //    mean.printBuffer("Mean for exponential with param 1.0 (1 exp) is");
  //    variance.printBuffer("Variance for exponential with param 1. (1 exp)
  //    is"); ASSERT_FALSE(nexp0->equalsTo(z));
  //    ASSERT_FALSE(nexp1->equalsTo(z));
  //    ASSERT_FALSE(nexp2->equalsTo(z));
  mean = exp0.reduceNumber(reduce::Mean);
  variance = exp0.varianceNumber(variance::SummaryStatsVariance, false);
...
namespace sd {
namespace tests {
static void fillList(Nd4jLong seed, int numberOfArrays,
                     std::vector<Nd4jLong>& shape, std::vector<NDArray*>& list,
  ...
  for (int i = 0; i < numberOfArrays; i++) {
    ...
    sd::ops::randomuniform op;
    op.execute(*rng, {&arrayI, &min, &max}, {arrayR}, {}, {DataType::DOUBLE},
               {}, {}, false);
...
TEST_F(RNGTests, Test_Uniform_4) {
  ...
  RandomLauncher::fillUniform(LaunchContext::defaultContext(), _rngB, &x1, 1.0,
                              2.0);
...
TEST_F(RNGTests, test_choice_1) {
  ...
  NativeOpExecutioner::execRandom(
      sd::LaunchContext ::defaultContext(), random::Choice, &rng, x->buffer(),
      x->shapeInfo(), x->specialBuffer(), x->specialShapeInfo(), prob->buffer(),
      prob->shapeInfo(), prob->specialBuffer(), prob->specialShapeInfo(),
...
TEST_F(RNGTests, test_multinomial_1) {
  NDArray probs('f', {3, 3}, {0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3},
                sd::DataType::FLOAT32);
  NDArray expected('f', {3, 3}, {0., 1, 2, 2, 0, 0, 1, 2, 1},
                   sd::DataType::INT64);
  ...
  ASSERT_EQ(Status::OK(), op.execute(rng, {&probs, &samples}, {&output}, {},
                                     {0}, {}, {INT64}, false));
  ...
  NDArray expectedZ('c', {3, 3}, {0., 0, 0, 0, 0, 0, 0, 0, 0},
                    sd::DataType::INT64);
...
TEST_F(RNGTests, test_multinomial_2) {
  ...
  NDArray probs('c', {3, 5},
                {0.2, 0.3, 0.5, 0.3, 0.5, 0.2, 0.5, 0.2, 0.3, 0.35, 0.25, 0.3,
                 0.25, 0.25, 0.5},
                sd::DataType::FLOAT32);
  NDArray expected('c', {3, 20},
                   {0, 2, 0, 2, 0, 4, 2, 0, 1, 2, 0, 2, 3, 0, 0, 2, 4, 4, 1, 0,
                    2, 3, 2, 3, 0, 1, 3, 1, 1, 1, 2, 4, 3, 3, 1, 4, 4, 2, 0, 0,
                    3, 3, 3, 0, 0, 2, 2, 3, 3, 0, 0, 2, 3, 4, 2, 2, 3, 2, 1, 2},
                   sd::DataType::INT64);
  ...
  NDArray probs2('c', {5, 3},
                 {0.2, 0.3, 0.5, 0.3, 0.5, 0.2, 0.5, 0.2, 0.3, 0.35, 0.25, 0.3,
                  0.25, 0.25, 0.5},
                 sd::DataType::FLOAT32);
  NDArray expected2('c', {20, 3}, {0, 2, 3, 2, 3, 3, 0, 2, 3, 2, 3, 0, 0, 0, 0,
                                   4, 1, 2, 2, 3, 2, 3, 1, 3, 1, 1, 3, 2, 1, 0,
                                   0, 2, 0, 2, 4, 2, 3, 3, 3, 0, 3, 4, 0, 1, 2,
                                   2, 0, 2, 4, 4, 0, 4, 2, 2, 1, 0, 1, 0, 0, 2},
                    sd::DataType::INT64);
  NDArray output2('c', {20, 3}, sd::DataType::INT64);

  rng.setStates(1234, 1234);
  ASSERT_EQ(Status::OK(), op.execute(rng, {&probs2, &samples}, {&output2}, {},
                                     {1}, {}, {INT64}, false));
...
TEST_F(RNGTests, test_multinomial_3) {
  NDArray probs('c', {4, 3},
                {0.3, 0.3, 0.4, 0.3, 0.4, 0.3, 0.3, 0.3, 0.4, 0.4, 0.3, 0.3},
                sd::DataType::FLOAT32);
  ...
  ASSERT_EQ(Status::OK(), op.execute(rng, {&probs, &samples}, {&expected}, {},
                                     {0}, {}, {INT64}, false));
...
TEST_F(RNGTests, test_multinomial_5) {
  ...
  NDArray samples('c', {1}, std::vector<double>{1. * Samples},
                  sd::DataType::INT32);

  NDArray probs('c', {ClassValue, batchValue}, {1.0, 1.0},
                sd::DataType::FLOAT32);
  ...
  auto deviation =
      output.varianceNumber(variance::SummaryStatsStandardDeviation, false);
  ...
  deviation =
      outputR.varianceNumber(variance::SummaryStatsStandardDeviation, false);
  mean = outputR.meanNumber();
  // printf("Random seed - Var: %f  Mean: %f \n", deviation.e<double>(0),
  // mean.e<double>(0));
...
TEST_F(RNGTests, test_multinomial_6) {
  ...
  sd::ops::random_multinomial op;
  NDArray probExpect('c', {ClassValue}, {0.058, 0.096, 0.1576, 0.2598, 0.4287},
                     sd::DataType::DOUBLE);

  // without seed
  NDArray probsR('c', {batchValue, ClassValue}, {1., 1.5, 2., 2.5, 3.},
                 sd::DataType::FLOAT32);
  ...
  RandomGenerator rng(1234, 1234);
  NDArray probs('c', {batchValue, ClassValue}, {1., 1.5, 2., 2.5, 3.},
                sd::DataType::FLOAT32);
