...
TEST_F(ScalarTests, Test_Concat_2) {
    auto t = NDArrayFactory::create<float>(1.0f);
    auto u = NDArrayFactory::create<float>(  {3}, {2, 3, 4});
    auto v = NDArrayFactory::create<float>(5.0f);
    auto exp = NDArrayFactory::create<float>(  {5}, {1, 2, 3, 4, 5});
...
TEST_F(ScalarTests, Test_Concat_3) {
    auto t = NDArrayFactory::create<float>(  {3}, {1, 2, 3});
...
TEST_F(ScalarTests, Test_ExpandDims_1) {
    auto x = NDArrayFactory::create<float>(2.0f);
    auto exp = NDArrayFactory::create<float>(  {1}, {2.0f});
...
TEST_F(ScalarTests, Test_Concat_Scalar_1) {
    ...
    auto exp = NDArrayFactory::create<float>(  {4, 1}, {1, 2, 3, 4});
...
TEST_F(ScalarTests, Test_Concat_Scalar_2) {
    ...
    auto v = NDArrayFactory::create<float>(  {1, 1}, {3.0f});
    auto w = NDArrayFactory::create<float>(  {1, 1}, {4.0f});
    auto exp = NDArrayFactory::create<float>(  {1, 4}, {1, 2, 3, 4});
