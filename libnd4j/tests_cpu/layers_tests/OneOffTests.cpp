...
TEST_F(OneOffTests, test_pad_1D_1) {
    auto e = NDArrayFactory::create<float>(  {7}, {10.f,0.778786f, 0.801198f, 0.724375f, 0.230894f, 0.727141f,10.f});
...
TEST_F(OneOffTests, test_tensor_array_1) {
    auto e = NDArrayFactory::create<float>(  {2, 3}, {0.77878559f, 0.80119777f, 0.72437465f, 0.23089433f, 0.72714126f, 0.18039072f});
...
TEST_F(OneOffTests, test_tensor_array_3) {
    auto e = NDArrayFactory::create<int>(  {3, 2, 3}, {7, 2, 9, 4, 3, 3, 8, 7, 0, 0, 6, 8, 7, 9, 0, 1, 1, 4});
...
TEST_F(OneOffTests, test_tensor_array_4) {
    auto e = NDArrayFactory::create<Nd4jLong>(  {2, 3}, {4, 3, 1, 1, 1, 0});
...
TEST_F(OneOffTests, test_assert_4) {
    auto e = NDArrayFactory::create<Nd4jLong>(  {2, 2}, {1, 1, 1, 1});
...
//     auto e = NDArrayFactory::create<float>(  {5}, {1.f, 2.f, 3.f, 4.f, 5.f});
...
TEST_F(OneOffTests, test_non2d_1) {
    auto e = NDArrayFactory::create<float>(  {1, 1}, {5.42746449f});
...
TEST_F(OneOffTests, test_reduce_all_1) {
    auto e = NDArrayFactory::create<bool>(  {1, 4}, {true, false, false, false});
