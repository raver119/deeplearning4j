...
TEST_F(LegacyOpsCudaTests, test_sort_1) {
  auto x = NDArrayFactory::create<float>(  {4}, {4.f, 2.f, 1.f, 3.f});
  auto e = NDArrayFactory::create<float>(  {4}, {1.f, 2.f, 3.f, 4.f});
...
TEST_F(LegacyOpsCudaTests, test_sort_2) {
  auto x = NDArrayFactory::create<float>(   {4}, {4.f, 2.f, 1.f, 3.f});
  auto e = NDArrayFactory::create<float>(   {4}, {4.f, 3.f, 2.f, 1.f});
...
TEST_F(LegacyOpsCudaTests, test_sort_3) {
  auto x = NDArrayFactory::create<double>(  {4}, {0.5, 0.4, 0.1, 0.2});
  auto e = NDArrayFactory::create<double>(  {4}, {0.1, 0.2, 0.4, 0.5});
...
TEST_F(LegacyOpsCudaTests, test_sort_4) {
  auto x = NDArrayFactory::create<double>(  {4}, {7, 4, 9, 2});
  auto e = NDArrayFactory::create<double>(  {4}, {2, 4, 7, 9});
