...
public class UnsortedSegmentSumBp extends DynamicCustomOp {
    ...
    public UnsortedSegmentSumBp(SameDiff sameDiff, SDVariable data, SDVariable segmentIds, SDVariable gradient, int numSegments) {
        super(null, sameDiff,  new SDVariable[] {data, segmentIds, gradient}, false);
        this.numSegments = numSegments;
        addIArgument(numSegments);
    }

    public UnsortedSegmentSumBp(){ }

    @Override
    public String opName(){
        return "unsorted_segment_sum_bp";
    }
