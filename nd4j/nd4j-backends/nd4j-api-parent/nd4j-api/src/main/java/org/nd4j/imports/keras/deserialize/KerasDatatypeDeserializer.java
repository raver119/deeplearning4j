...
public class KerasDatatypeDeserializer extends StdDeserializer<DataType> {
    public KerasDatatypeDeserializer() {
    ...
    public DataType deserialize(JsonParser jsonParser, DeserializationContext deserializationContext)
        ...
        String name = jsonParser.getValueAsString().toLowerCase();
        return DataType.fromNumpy(name);
    }
}
