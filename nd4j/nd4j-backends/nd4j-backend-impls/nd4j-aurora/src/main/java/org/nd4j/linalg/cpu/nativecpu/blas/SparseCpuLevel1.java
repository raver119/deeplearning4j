...
public class SparseCpuLevel1 extends SparseBaseLevel1 {
    ...
    protected double ddoti(long N, INDArray X, DataBuffer indx, INDArray Y) {
        return nativeOps.callDouble("cblas_ddoti", (int) N, (DoublePointer) X.data().addressPointer(),(IntPointer) indx.addressPointer(),
    ...
    protected double sdoti(long N, INDArray X, DataBuffer indx, INDArray Y) {
        return nativeOps.callDouble("cblas_sdoti", (int) N, (FloatPointer) X.data().addressPointer(),(IntPointer) indx.addressPointer(),
    ...
    protected double snrm2(long N, INDArray X, int incx){
        return nativeOps.callDouble("cblas_snrm2", (int) N, (FloatPointer) X.data().addressPointer(), incx);
    }
    ...
    protected double dasum(long N, INDArray X, int incrx){
        return nativeOps.callDouble("cblas_dasum", (int) N, (DoublePointer) X.data().addressPointer(), incrx);
    }
    ...
    protected double sasum(long N, INDArray X, int incrx){
        return nativeOps.callDouble("cblas_sasum", (int) N, (FloatPointer) X.data().addressPointer(), incrx);
    }
    ...
    protected int isamin(long N, INDArray X, int incX) {
        return nativeOps.callInt("cblas_isamin", (int) N, (FloatPointer) X.data().addressPointer(), incX);
    }
    ...
    protected int idamin(long N, INDArray X, int incX) {
        return nativeOps.callInt("cblas_idamin", (int) N, (DoublePointer) X.data().addressPointer(), incX);
    }
    @Override
    ...
    protected void daxpyi(long N, double alpha, INDArray X, DataBuffer pointers, INDArray Y){
        nativeOps.call("cblas_daxpyi", (int) N, alpha, (DoublePointer) X.data().addressPointer(), (IntPointer) pointers.addressPointer(),
                (DoublePointer) Y.data().addressPointer());
    }
    ...
    protected void saxpyi(long N, double alpha, INDArray X, DataBuffer pointers, INDArray Y) {
        nativeOps.call("cblas_saxpyi", (int) N, (float) alpha, (FloatPointer) X.data().addressPointer(), (IntPointer) pointers.addressPointer(),
                (FloatPointer) Y.data().addressPointer());
    }
    ...
    protected void droti(long N, INDArray X, DataBuffer indexes, INDArray Y, double c, double s) {
        nativeOps.call("cblas_droti", (int) N, (DoublePointer) X.data().addressPointer(), (IntPointer) indexes.addressPointer(),
    ...
    protected void sroti(long N, INDArray X, DataBuffer indexes, INDArray Y, double c, double s) {
        nativeOps.call("cblas_sroti", (int) N, (FloatPointer) X.data().addressPointer(), (IntPointer) indexes.addressPointer().capacity(X.columns()),
    ...
    protected void dscal(long N, double a, INDArray X, int incx) {
        nativeOps.call("cblas_dscal", (int) N, a, (DoublePointer) X.data().addressPointer(), incx);
    }
    ...
    protected void sscal(long N, double a, INDArray X, int incx) {
        nativeOps.call("cblas_sscal", (int) N, (float) a, (FloatPointer) X.data().addressPointer(), incx);
    }
