...
public class TestSessions extends BaseNd4jTest {
    ...
    public void testMergeSimple(){
        ...
        SDVariable merge = sd.linalg.merge(new SDVariable[]{ph1, ph2});
...
//        String outName = merge.name();
    ...
    public void testSwitchSimple(){
        ...
        SDVariable[] switchOut = sd.linalg().switchOp(x,b); //Order: false then true
        SDVariable falsePlusOne = switchOut[0].add("addFalseBranch", 1);
        SDVariable truePlusTen = switchOut[1].add("addTrueBranch", 10.0);

        SDVariable merge = sd.linalg().merge(new SDVariable[]{falsePlusOne, truePlusTen});
