...
public class StateActionExperienceHandlerTest {
    ...
    @Test
    public void when_addingExperience_expect_getExperienceReturnsIt() {
        // Arrange
        ...
        // Act
        List<StateActionPair<Integer>> result = sut.getExperience();
    ...
    @Test
    public void when_addingMultipleExperiences_expect_getExperienceReturnsItInSameOrder() {
        // Arrange
        StateActionExperienceHandler sut = new StateActionExperienceHandler();
        sut.reset();
